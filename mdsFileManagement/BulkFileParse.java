    ...
    public int commitFileToDB(String fileName){
        ...
        try {
            ...
            for(i=0;i<aList.size();i++) {
                ...
                sql ="insert into mdsMSH (sendingApp,dateTime,type,messageConID,processingID,versionID,acceptAckType,appAckType) VALUES (\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getSendingApp()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getDateTime()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getType()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getMessageConID()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getProcessingID()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getVersionID()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getAcceptAckType()+"\",\""+ ((MDSHL7Message)aList.get(i)).MSHTag.getAppAckType()+"\")";
                db.RunSQL(sql);
                ...
                sql ="insert into mdsPID (segmentID,intPatientID,altPatientID,patientName,dOB,sex,homePhone,healthNumber) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getIntPatientID()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getAltPatientID()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getPatientName()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getDOB()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getSex()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getHomePhone()+"\",\""+ ((MDSHL7Message)aList.get(i)).PIDTag.getHealthNumber()+"\")";
                db.RunSQL(sql);
                //Insert the PV1Tag info into the pV1Segment table
                sql ="insert into mdsPV1 (segmentID,patientClass,patientLocation,refDoctor,conDoctor,admDoctor,vNumber,accStatus,admDateTime) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getPatientClass()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getPatientLocation()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getRefDoctor()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getConDoctor()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getAdmDoctor()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getVNumber()+"\",\""+ ((MDSHL7Message)aList.get(i)).PV1Tag.getAccStatus()+"\",\""+  ((MDSHL7Message)aList.get(i)).PV1Tag.getAdmDateTime()+"\")";
                db.RunSQL(sql);
                //Insert the ZLBTag info into the zLBSegment table
                sql ="insert into mdsZLB (segmentID, labID,labIDVersion,labAddress,primaryLab,primaryLabVersion,MDSLU,MDSLV) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getLabID()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getLabIDVersion()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getLabAddress()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getPrimaryLab()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getPrimaryLabVersion()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getMDSLU()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZLBTag.getMDSLV()+"\")";
                db.RunSQL(sql);
                //Insert the ZMNTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getZMNArrayListSize();j++) {
                    sql ="insert into mdsZMN (segmentID, resultMnemonic,resultMnemonicVersion,reportName,units,cumulativeSequence,referenceRange,resultCode,reportForm,reportGroup,reportGroupVersion) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getResultMnemonic()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getResultMnemonicVersion()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getReportName()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getUnits()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getCumulativeSequence()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getReferenceRange()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getResultCode()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getReportForm()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getReportGroup()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMNNode(j).getReportGroupVersion()+"\")";
                    db.RunSQL(sql);
                }
                //Insert the ZRGTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getZRGArrayListSize();j++) {
                    sql ="insert into mdsZRG (segmentID,reportSequence,reportGroupID,reportGroupVersion,reportFlags,reportGroupDesc,mDSindex, reportGroupHeading) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportSequence()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportGroupID()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportGroupVersion()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportFlags()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportGroupDesc()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZRGNode(j).getMDSIndex()+"\",\"" + ((MDSHL7Message)aList.get(i)).getZRGNode(j).getReportGroupHeading()+"\")";
                    db.RunSQL(sql);
                }
                //Insert the ZFRTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getZFRArrayListSize();j++) {
                    sql ="insert into mdsZFR (segmentID, reportForm,reportFormStatus,testingLab,medicalDirector,editFlag,abnormalFlag) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getReportForm()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getReportFormStatus()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getTestingLab()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getMedicalDirector()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getEditFlag()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZFRNode(j).getAbnormalFlag()+"\")";
                    db.RunSQL(sql);
                }
                //Insert the ZMCTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getZMCArrayListSize();j++) {
                    sql ="insert into mdsZMC (segmentID, setID,messageCodeIdentifier,messageCodeVersion,noMessageCodeDescLines,sigFlag,messageCodeDesc) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getSetID()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getMessageCodeIdentifier()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getMessageCodeVersion()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getNoMessageCodeDescLines()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getSigFlag()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZMCNode(j).getMessageCodeDesc()+"\")";
                    db.RunSQL(sql);
                }
                //Insert the ZCL tag
                sql ="insert into mdsZCL (segmentID, setID,consultDoc,clientAddress,route,stop,area,reportSet,clientType,clientModemPool,clientFaxNumber,clientBakFax) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getSetID()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getConsultDoc()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getClientAddress()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getRoute()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getStop()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getArea()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getReportSet()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getClientType()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getClientModemPool()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getClientFaxNumber()+"\",\""+ ((MDSHL7Message)aList.get(i)).ZCLTag.getClientBakFax()+"\")";
                db.RunSQL(sql);
                //Insert the ZCTTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getZCTArrayListSize();j++) {
                    sql ="insert into mdsZCT (segmentID, barCodeIdentifier, placerGroupNo, observationDateTime) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getZCTNode(j).getBarCodeIdentifier()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZCTNode(j).getPlacerGroupNo()+"\",\""+ ((MDSHL7Message)aList.get(i)).getZCTNode(j).getObservationDateTime()+"\")";
                    db.RunSQL(sql);
                }
                
                //Insert the OBRTag info into the zMNSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getOBRArrayListSize();j++) {
                    sql ="insert into mdsOBR (segmentID, placerOrderNo, universalServiceID,observationDateTime, specimenRecDateTime,fillerFieldOne,quantityTiming,obrID) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getPlacerOrderNo()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getUniversalServiceID()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getObservationDateTime()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getSpecimenRecDateTime()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getFillerFieldOne()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBRNode(j).getQuantityTiming()+"\",\""+((MDSHL7Message)aList.get(i)).getOBRNode(j).getObrSegmentID()+"\")";
                    db.RunSQL(sql);
                }
                
                //Insert the OBXTag info into the oBXSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getOBXArrayListSize();j++) {
                    sql ="insert into mdsOBX (segmentID,valueType,observationIden,observationSubID,observationValue,abnormalFlags,observationResultStatus,producersID,associatedOBR,obxID) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getValueType()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getObservationIden()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getObservationSubID()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getObservationValue()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getAbnormalFlags()+"\",\""+ ((MDSHL7Message)aList.get(i)).getOBXNode(j).getObservationResultStatus()+"\",\""+((MDSHL7Message)aList.get(i)).getOBXNode(j).getProducersID()+"\",\""+((MDSHL7Message)aList.get(i)).getOBXNode(j).getAssociatedOBR()+"\",\""+((MDSHL7Message)aList.get(i)).getOBXNode(j).getObxSegmentID()+"\")";
                    db.RunSQL(sql);
                }
                
                //Insert the NTETag info into the oBRSegment table
                for(j=0;j<((MDSHL7Message)aList.get(i)).getNTEArrayListSize();j++) {
                    sql ="insert into mdsNTE (segmentID,sourceOfComment,comment,associatedOBX) VALUES ("+insertID +",\""+ ((MDSHL7Message)aList.get(i)).getNTENode(j).getSourceOfComment()+"\",\""+ ((MDSHL7Message)aList.get(i)).getNTENode(j).getComment()+"\",\""+ ((MDSHL7Message)aList.get(i)).getNTENode(j).getAssociatedOBX()+"\")";
                    db.RunSQL(sql);
                }
