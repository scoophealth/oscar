...
<table border="0" cellspacing="0" cellpadding="0" width="100%" >
  <tr bgcolor="#486ebd">
    <th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF">APPOINTMENT HISTORY </font></th>
  </tr>
</table>
...
<table width="95%" border="0">
  <tr><td align="left"><i>Results for Demographic</i> :<%=demolastname%>,<%=demofirstname%> (<%=request.getParameter("demographic_no")%>)</td></tr>
</table>
<hr>
...
<tr bgcolor="<%=bodd?"ivory":"white"%>">
      ...
      <td align="center" width="10%" height="25">&nbsp;<%=rs.getString("status")==null?"":(rs.getString("status").equals("N")?"No Show":(rs.getString("status").equals("C")?"Cancelled":"") ) %></td>
</tr>
<%
    }
  }
