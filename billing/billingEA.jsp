...
<p><font face="Arial, Helvetica, sans-serif" size="2"><b>EDT Billing Report Generator</b></font></p>
<form name="form1" method="post" action="../servlet/oscar.DocumentErrorReportUploadServlet" ENCTYPE="multipart/form-data">
