...
insert into billing_on_payment (billing_no) select distinct billing_no, value from billing_on_ext;
alter table billing_on_ext add payment_id int(10) not null;
