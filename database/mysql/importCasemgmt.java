		...
		try {
			...
			stmt = con.createStatement();	
                        ...
                        if( !rs1.next() ) {
                            ...
                            int result = stmt.executeUpdate("insert into program (facilityId, name,emergencyNumber,maxAllowed,holdingTank,type,programStatus,allowBatchAdmission,allowBatchDischarge,hic,exclusiveView,defaultServiceRestrictionDays,enableEncounterTime,enableEncounterTransportationTime) " +
                                "Values(1,'OSCAR','','99999',0,'Bed','active',0,0,0,'',0,0,0)", Statement.RETURN_GENERATED_KEYS);
