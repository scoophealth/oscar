		...
		try {
			...
			stmt = con.createStatement();	
                        ...
                        if( !rs1.next() ) {
                            ...
                            int result = stmt.executeUpdate("insert into program (facilityId, name,maxAllowed,type,programStatus,allowBatchAdmission,allowBatchDischarge,hic) " + 
                                "Values(1,'OSCAR','99999','Bed','active',0,0,0)", Statement.RETURN_GENERATED_KEYS);
