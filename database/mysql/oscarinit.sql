...
CREATE TABLE formSelfEfficacy(
  ...
  help3 int(2),
  help4 int(2),
  communicateWithPhy1 int(2),
  communicateWithPhy2 int(2),
  communicateWithPhy3 int(2),
  manageDisease1 int(2),
  manageDisease2 int(2),
  manageDisease3 int(2),
  manageDisease4 int(2),
  manageDisease5 int(2),
  doChore1 int(2),
  doChore2 int(2),
  doChore3 int(2),
  social1 int(2),
  social2 int(2),
  shortBreath1 int(2),
  manageSymptoms1 int(2),
  manageSymptoms2 int(2),
  manageSymptoms3 int(2),
  manageSymptoms4 int(2),
  manageSymptoms5 int(2),
  controlDepress1 int(2),
  controlDepress2 int(2),
  controlDepress3 int(2),
  controlDepress4 int(2),
  controlDepress5 int(2),
  controlDepress6 int(2),  
  PRIMARY KEY  (ID)
) TYPE=MyISAM;
