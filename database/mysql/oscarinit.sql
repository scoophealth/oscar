...
CREATE TABLE formSF36(
  ...
  1P tinyint(1),
  1Cmt varchar(255),
  2MuchBetter tinyint(1),
  2Better tinyint(1),
  2Same tinyint(1),
  2Worse tinyint(1),
  2MuchWorse tinyint(1),
  2Cmt varchar(255),
  3aYesLot tinyint(1),
  3aYesLittle tinyint(1),
  3aNo tinyint(1),
  3aCmt varchar(255),  
  3bYesLot tinyint(1),
  3bYesLittle tinyint(1),
  3bNo tinyint(1),
  3bCmt varchar(255),
  3cYesLot tinyint(1),
  3cYesLittle tinyint(1),
  3cNo tinyint(1),
  3cCmt varchar(255),
  3dYesLot tinyint(1),
  3dYesLittle tinyint(1),
  3dNo tinyint(1),
  3dCmt varchar(255),
  3eYesLot tinyint(1),
  3eYesLittle tinyint(1),
  3eNo tinyint(1),
  3eCmt varchar(255),
  3fYesLot tinyint(1),
  3fYesLittle tinyint(1),
  3fNo tinyint(1),
  3fCmt varchar(255),
  3gYesLot tinyint(1),
  3gYesLittle tinyint(1),
  3gNo tinyint(1),
  3gCmt varchar(255),
  3hYesLot tinyint(1),
  3hYesLittle tinyint(1),
  3hNo tinyint(1),
  3hCmt varchar(255),
  3iYesLot tinyint(1),
  3iYesLittle tinyint(1),
  3iNo tinyint(1),
  3iCmt varchar(255),
  3jYesLot tinyint(1),
  3jYesLittle tinyint(1),
  3jNo tinyint(1),
  3jCmt varchar(255),
  4aYes tinyint(1),
  4aNo tinyint(1),
  ...
  6NotAtAll tinyint(1),
  6Slightly tinyint(1),
  6Moderately tinyint(1),
  6QuiteABit tinyint(1),
  6Extremely tinyint(1),
  6Cmt varchar(255),
  7None tinyint(1),
  7VeryMild tinyint(1),  
  7Mild tinyint(1),
  7Moderate tinyint(1),
  7Severe tinyint(1),
  7VerySevere tinyint(1),
  7Cmt varchar(255),
  8NotAtAll tinyint(1),
  8Slightly tinyint(1),
  8Moderately tinyint(1),
  8QuiteABit tinyint(1),
  8Extremely tinyint(1),
  8Cmt varchar(255),
  9aAll tinyint(1),
  9aMost tinyint(1), 
  9aGood tinyint(1),
  ...
  9jNone tinyint(1),
  9jCmt varchar(255),
  10aDefTrue tinyint(1),
  10aMostTrue tinyint(1),
  10aNotSure tinyint(1),
  10aMostFalse tinyint(1),
  10aDefFalse tinyint(1),  
  10aCmt varchar(255),
  10bDefTrue tinyint(1),
  10bMostTrue tinyint(1),
  10bNotSure tinyint(1),
  10bMostFalse tinyint(1),
  10bDefFalse tinyint(1),  
  10bCmt varchar(255),
  10cDefTrue tinyint(1),
  10cMostTrue tinyint(1),
  10cNotSure tinyint(1),
  10cMostFalse tinyint(1),
  10cDefFalse tinyint(1),  
  10cCmt varchar(255),
  10dDefTrue tinyint(1),
  10dMostTrue tinyint(1),
  10dNotSure tinyint(1),
  10dMostFalse tinyint(1),
  10dDefFalse tinyint(1),  
  10dCmt varchar(255),  
  PRIMARY KEY  (ID)
) TYPE=MyISAM;
