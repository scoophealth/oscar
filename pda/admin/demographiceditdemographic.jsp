...
<table width="100%" border="1" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td><div align="center"><a href='admincontrol.jsp?demographic_no=<%=rs.getString("demographic_no")%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10'>Appt.History</a></div></td>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
    ...
    <tr valign="top"> 
      ...
      <td align="left">
        <input type="text" name="family_doctor" value="<%=rs.getString("family_doctor")%>">
      </td>
    ...
    <tr bgcolor="#486ebd"> 
      <td colspan="4"> 
        <div align="center"> 
          ...
          <a href='admincontrol.jsp?demographic_no=<%=rs.getString("demographic_no")%>&displaymode=Demographic_Delete&dboperation=demographic_delete'> 
	  ...
	  <%--
	     if (rs.getString("sex").compareTo("F") == 0) {
         out.println("<input type=\"button\" name=\"Button2\" value=\"Antenatal Care Planner\" onClick=\"window.location='../ob/risks.jsp?demographic_no="+rs.getString("demographic_no")+"'\">");
	     }
	  --%>
