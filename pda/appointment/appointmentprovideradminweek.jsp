...
%>
<%@ page import="java.lang.*, java.util.*, java.text.*,java.sql.*, oscar.MyDateFormat"  %>
...
<tr>
  ...
  <td align="right" valign="bottom">
   ...
   <INPUT TYPE="hidden" NAME="dboperation" VALUE="searchapptweek" >
    ...
    <table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
      <tr>
        <td BGCOLOR="ivory" width="33%">
         <a href="appointmentcontrol.jsp?year=<%=year%>&month=<%=month%>&day=<%=(day-7)%>&displaymode=week&dboperation=searchapptweek">
      ...
      <tr>
        ...
        %>
						<td NOWRAP BGCOLOR="#F0F0F0" VALIGN="TOP" ALIGN="MIDDLE" width=13%><img src="../images/clear.gif height="32" width="1" border="0">
							<br><b>
							<a HREF="appointmentcontrol.jsp?year=<%=strYear%>&month=<%=strMonth%>&day=<%=firstDayOfWeek+ih-preZero%>&displaymode=day&dboperation=searchappointmentday">
...
lf:								for(ih=startHour; ih<=endHour; ih++) { //from hour 7 - 9
        ...
        %>
						<td BGCOLOR="<%= apptWeek[ih-startHour][ii-preZero].equals("")?"#3EA4E1":"#FDFEC7"%>" ROWSPAN="1" width=13% >
						<%=apptWeek[ih-startHour][ii-preZero] %></td>
        <%
        			}
        		}//end the main content
        %>
          	<td align="RIGHT" bgcolor="#3EA4E1" NOWRAP WIDTH="5%"><font color="WHITE" face="verdana,arial,helvetica" size="2"><%=(hourCursor+am_pm)%></font></td></tr>
        <%
