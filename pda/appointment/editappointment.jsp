...
<table border=0 cellspacing=0 cellpadding=0 width="100%" >
  <tr bgcolor="#486ebd"><th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF">EDIT AN APPOINTMENT</font></th></tr>
</table>
  ...
  <tr><td width="100%">
        ...
        <table BORDER="0" CELLPADDING="0" CELLSPACING="1" WIDTH="100%" BGCOLOR="#C0C0C0">
          <tr valign="middle"> 
            ...
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
              <INPUT TYPE="TEXT" NAME="status" VALUE="<%=bFirstDisp?rs.getString("status"):request.getParameter("status")%>"  onBlur="upCaseCtrl(this)" WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
          </tr>
          <tr valign="middle"> 
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
            ...
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
              <INPUT TYPE="TEXT" NAME="start_time" VALUE="<%=bFirstDisp?MyDateFormat.getTimeXX_XXampm(rs.getString("start_time")):request.getParameter("start_time")%>" WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
            <td width="5%" BGCOLOR="#C4D9E7" ></td>
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
          ...
          <tr valign="middle"> 
            ...
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
              <INPUT TYPE="TEXT" NAME="end_time" VALUE="<%=bFirstDisp?MyDateFormat.getTimeXX_XXampm(rs.getString("end_time")):request.getParameter("end_time")%>" WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
            <td width="5%" BGCOLOR="#C4D9E7" ></td>
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
          ...
          <tr valign="middle"> 
            ...
            <td width="5%" BGCOLOR="#C4D9E7" ><font face="Times New Roman"> </font></td>
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
...
%>            
              <INPUT TYPE="TEXT" NAME="user_id" VALUE="<%=lastCreatorName%>" readonly WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
            <td width="5%" BGCOLOR="#C4D9E7" ></td>
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
...
<table width="100%" BGCOLOR="#486ebd">
  <tr>
      <TD align="center"> 
        <input type="submit" name="displaymode" value="Update Appointment" size="7">
        <INPUT TYPE = "submit" tabindex="6" name="displaymode" VALUE = "Delete Appointment">
        <INPUT TYPE = "button" name="labelprint" VALUE = "Label" onClick="window.open('../demographic/demographiclabelprintsetting.jsp?demographic_no='+document.EDITAPPT.demographic_no.value, 'labelprint','height=550,width=700,location=no,scrollbars=yes,menubars=no,toolbars=no' )">
