...
<%  
  ...
  String query = " select fid,form_name,file_name,subject,form_date,form_time  from eforms where status = 1" ;
...
<table cellspacing="0" cellpadding="2" width="100%" border="0" BGCOLOR="#C4D9E7">
    ...
    <tr> 
     ...
     <tr valign="top">
      <td rowspan="2" align="right" valign="middle" colspan="3"> <font face="Verdana" color="#0000FF"><b><i> 
          </i></b></font>  </td>
           <td nowrap> 
           </td>
           <td nowrap>
    ...
    <tr> 
        <td nowrap><font size="1" face="Verdana" color="#0000FF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font></td>
        <td nowrap><font size="1" face="Verdana" color="#0000FF"></td>
...
if(RS.next()){
  ...
  while (RS.next()){
        ...
        out.print(RS.getString("form_name")+"</td><td width=160><a href=\"JavaScript:");
        out.print("newWindow('ShowHtml.jsp?fid="+RS.getInt("fid")+"','_blank')\">");        
        out.print(RS.getString("subject")+"</td><td width=200><a href=\"JavaScript:");
        out.print("</a></td><td>");
        out.print("newWindow('ShowHtml.jsp?fid="+RS.getInt("fid")+"','_blank')\">");        
