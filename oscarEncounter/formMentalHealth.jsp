...
<%@ page language="java"%>
<%@ page import="oscar.oscarEncounter.data.EctMentalHealthRecord" %>
<html>
<head>
<title>
MentalHealth
...
//    alert("i'm in the function");
    ...
    {
        window.location="formMH<%=props.getProperty("c_lastVisited", "Referral")%>.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>";
    }
}
</script>
