    ...
    <tr>
        ...
        <td width="100%" style="border-left: 2px solid #A9A9A9; " height="100%" valign="top">
            ...
            <!----Start new rows here-->
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <html:link page="/oscarEncounter/immunization/config/AdministrateImmunizationSets.jsp">
                                        Administrate Immunization Sets
                                    </html:link>
                                </td>
                                <td>
                                    <html:link page="/oscarEncounter/immunization/config/CreateImmunizationSetInit.jsp">
                ...
                <tr>
                    <td>
                        Current Immunization Sets<br>
                        Please select which immunizations you would like to delete
                    </td>
                </tr>
                <tr>
                    <td>
                        <html:form action="/oscarEncounter/DeleteImmunizationSets">
                            <table border=1>
                                <tr>
                                        <th>
                                        &nbsp;
                                ...
                                <tr>
                                        <td>
                                        <input type="checkbox" name="immuSets" value="<%=id%>"/>
                                        </td>
                                        <td>
                                            <a href="javascript:popupImmunizationSet(768,1024,'./oscarEncounter/ImmunizationSetDisplay.do?setId=<%=id%>')">
                                                <%=name%>
                                            </a>
                                        </td>
                                        <td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <input type="submit" value="Delete Sets"/>
                                </td>
                            </tr>
                            </table>
                        </html:form>
