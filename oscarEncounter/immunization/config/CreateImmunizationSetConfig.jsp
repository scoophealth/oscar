    ...
    <tr>
        ...
        <td width="100%" style="border-left: 2px solid #A9A9A9; " height="100%" valign="top">
            ...
            <!----Start new rows here-->
                ...
                <tr>
                    <td>
                      <html:form action="/oscarEncounter/immunization/config/CreateImmunizationSetConfig">
                                            ...
                                            for (int j=0; j < cols; j++){
                                                ...
                                                <%}else{%>
                                                    <th class=head>
                                                        ...
                                                        <textarea name="heading<%=i+"D"+j%>" rows="2"></textarea>
                                                    </th>
                                                <%}%>
                                      <%    }
                                            ...
                                            for (int j=0; j < cols; j++){
                                                if (j==0){%>
                                                    <td class=head>
                                                       <textarea name="immunization<%=i+"D"+j%>" rows="2"></textarea>
                                                    </td>

                                                <%}else{%>
                                                    <td class=grey valign=middle align=center>
                                                        <input type="checkbox" name="yearAge<%=i+"D"+j%>" onclick="switchColor(this)">
                                                    </td>
                                                <%}%>
                                          <%}
                                        }
