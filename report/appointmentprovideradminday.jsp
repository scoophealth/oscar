...
//  DateTimeCodeBean.put("-", "silver");
//  DateTimeCodeBean.put("_", "black");
//  DateTimeCodeBean.put("1", "#3EA4E1");
//  DateTimeCodeBean.put("2", "#3EA4E1");
//  DateTimeCodeBean.put("3", "#3EA4E1");   
...
<!-- oscarMessenger code block -->
        <td></td><td rowspan="2" BGCOLOR="#C0C0C0" ALIGN="MIDDLE" nowrap><font FACE="VERDANA,ARIAL,HELVETICA" SIZE="2">
         ...
         <jaymessage:newMessages providerNo="<%=curUser_no%>"/></a></font>
         </td>
<!--/oscarMessenger code block -->
...
<!--/oscarMessenger code block -->
  ...
  <a href=# onClick ="popupPage(310,430,'../share/CalendarPopup.jsp?urlfrom=../provider/providercontrol.jsp&year=<%=strYear%>&month=<%=strMonth%>')">Calendar</a>
...
<% } %>          
    ...
    title="Master file">M</a><a href=# onClick="popupOscarRx(700,960,'../../oscarRx/choosePatient.do?providerNo=<%=curProvider_no[nProvider]%>&demographicNo=<%=demographic_no%>')">|Rx</a>
<% } %>
        		</font></td>
        <% 
        			}
