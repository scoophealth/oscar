...
./mvn_install.sh -DgroupId=org.indivo -DartifactId=indivo-model-phr-jackson -Dversion=3.1-SNAPSHOT -Dfile=../web/WEB-INF/lib/indivo-model-phr-3.1.jar
...
./mvn_install.sh -DgroupId=ocan -DartifactId=ocan-iar -Dversion=UNKNOWN -Dfile=../web/WEB-INF/lib/ocan-iar.jar
