...
import org.caisi.comp.FrameworkFactory;
import org.caisi.comp.advanced.ComponentHandler;
...
public class CaseManagementLinkTag extends TagSupport {
	...
	public int doStartTag() throws JspException 
	{
		...
		try 
		{
			...
			if((handler = FrameworkFactory.getFramework().getComponent("casemgmtComp")) != null) {
               ...
               if(contextPath.indexOf("/mod/") != -1) {
                ...
                .append("://").append(req.getServerName()).append(":").append(
                        ...
                        "/mod/").append("casemgmtComp").append("/").append("CaseManagementView.do?").append(
