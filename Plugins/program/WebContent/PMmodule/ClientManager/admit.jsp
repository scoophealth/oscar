...
<script>
	...
	<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="admission" name="admissions" export="false" pagesize="0" requestURI="/PMmodule/ClientManager.do">
