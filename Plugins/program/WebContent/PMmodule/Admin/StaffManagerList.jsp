...
<html:html>
	...
	<body marginwidth="0" marginheight="0">
		...
		<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="provider" name="providers" export="false" pagesize="0" requestURI="/PMmodule/StaffManager.do">
