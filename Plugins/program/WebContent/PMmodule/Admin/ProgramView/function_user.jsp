...
<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="functional" name="functional_users" export="false" pagesize="0" requestURI="/PMmodule/ProgramManagerView.do">
