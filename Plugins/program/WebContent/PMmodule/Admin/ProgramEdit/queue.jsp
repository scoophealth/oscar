...
<script>
	...
	<br/>
		...
		<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="queue_entry" name="queue" export="false" pagesize="0" requestURI="/PMmodule/ProgramManager.do">
		  <display:setProperty name="paging.banner.placement" value="bottom"/>
		  <display:setProperty name="basic.msg.empty_list" value="Queue is empty."/>
		  <display:column sortable="false" title="">  
			<a href="javascript:void(0);" onclick="removeFromQueue('<c:out value="${queue_entry.id}"/>')">
				Remove
			</a>
		  </display:column>
