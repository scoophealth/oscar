...
<html:hidden property="admission.teamId"/>
		...
		<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="admission" name="admissions" export="false" pagesize="0" requestURI="/PMmodule/ProgramManager.do">
		  <display:setProperty name="paging.banner.placement" value="bottom"/>
		  <display:setProperty name="basic.msg.empty_list" value="No clients currently admitted to this program."/>
		  <display:column sortable="false" title="">  
			<a href="javascript:void(0);return false;" onclick="alert('Please discharge clients from the client manager');" >
				Discharge
			</a>
		  </display:column>
