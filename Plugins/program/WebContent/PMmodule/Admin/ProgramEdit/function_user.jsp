...
function add_functional_user(form) {
	...
	form.submit();
		...
		<!--  show current staff -->
		<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="functional" name="functional_users" export="false" pagesize="0" requestURI="/PMmodule/ProgramManager.do">
		  <display:setProperty name="paging.banner.placement" value="bottom"/>
		  <display:setProperty name="basic.msg.empty_list" value="No functional users defined for this program"/>
		  <display:column sortable="false" title="">  
			<a onclick="deleteFunctionalUser('<c:out value="${functional.id}"/>');" href="javascript:void(0);">
				Delete
			</a>
		  </display:column>
