...
<script>
		...
		<!--  show current staff -->
		<display:table class="b" border="1" cellspacing="2" cellpadding="3" width="100%" id="program" name="programs" export="false" pagesize="0" requestURI="/PMmodule/StaffManager.do">
