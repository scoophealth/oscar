...
import org.caisi.casemgmt.web.PrescriptDrug;
import org.springframework.orm.hibernate3.support.HibernateDaoSupport;


public class PrescriptionDAOHibernate extends HibernateDaoSupport implements
		PrescriptionDAO
{

	public Prescription getPrescription(Long id)
	{
		return (Prescription) this.getHibernateTemplate().get(
	...
	public List getUniquePrescriptions(String demographic_no)
	{
		...
		List rs = this
				...
				.find(
						"select d.rx_date,d.special,d.end_date,d.BN,d.GCN_SEQNO,d.customName from Drug d where d.demographic_no = ? and d.archived = 0 ORDER BY d.rx_date DESC, d.id DESC",
						new Object[]
						{ demographic_no });
