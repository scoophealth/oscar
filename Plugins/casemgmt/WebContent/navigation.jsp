...
<%@ taglib uri="/WEB-INF/tld/oscar-tag.tld" prefix="oscar" %>
...
<!-- add tickler -->
<tr><td><a href="javascript:void(0)" onClick="popupPage('<%=bsurl%>/Tickler.do?method=edit&tickler.demographic_webName=<%out.print(bean.getPatientLastName() +"," + bean.getPatientFirstName());%>&tickler.demographic_no=<%=bean.demographicNo%>');return false;">Add Tickler</a></td></tr>
...
<nested:iterate id="cf" name="casemgmt_newFormBeans" type="org.caisi.casemgmt.model.Encounterform">
