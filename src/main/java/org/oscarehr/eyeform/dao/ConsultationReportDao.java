...
public class ConsultationReportDao extends AbstractDao<ConsultationReport> {
	...
	public List<ConsultationReport> getByDemographic(Integer demographicNo) {
	...
	public List<ConsultationReport> search(ConsultationReport queryBean,Date startDate, Date endDate) {
