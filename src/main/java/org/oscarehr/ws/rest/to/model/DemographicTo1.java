...
public class DemographicTo1 implements Serializable {
	...
	public void copyFields(DemographicTo1 dto, String[] fields) {
		for (String field : fields) {
			if ("demographicNo".equals(field)) setDemographicNo(dto.getDemographicNo());
			else if ("address".equals(field)) setAddress(dto.getAddress());
			else if ("phone".equals(field)) setPhone(dto.getPhone());
			else if ("alternativePhone".equals(field)) setAlternativePhone(dto.getAlternativePhone());
			else if ("patientStatus".equals(field)) setPatientStatus(dto.getPatientStatus());
			else if ("patientStatusDate".equals(field)) setPatientStatusDate(dto.getPatientStatusDate());
			else if ("rosterStatus".equals(field)) setRosterStatus(dto.getRosterStatus());
			else if ("rosterDate".equals(field)) setRosterDate(dto.getRosterDate());
			else if ("providerNo".equals(field)) setProviderNo(dto.getProviderNo());
			else if ("myOscarUserName".equals(field)) setMyOscarUserName(dto.getMyOscarUserName());
			else if ("hin".equals(field)) setHin(dto.getHin());
			else if ("ver".equals(field)) setVer(dto.getVer());
			else if ("dateOfBirth".equals(field)) setDateOfBirth(dto.getDateOfBirth());
			else if ("dobYear".equals(field)) setDobYear(dto.getDobYear());
			else if ("dobMonth".equals(field)) setDobMonth(dto.getDobMonth());
			else if ("dobDay".equals(field)) setDobDay(dto.getDobDay());
			else if ("sex".equals(field)) setSex(dto.getSex());
			else if ("sexDesc".equals(field)) setSexDesc(dto.getSexDesc());
			else if ("dateJoined".equals(field)) setDateJoined(dto.getDateJoined());
			else if ("familyDoctor".equals(field)) setFamilyDoctor(dto.getFamilyDoctor());
			else if ("firstName".equals(field)) setFirstName(dto.getFirstName());
			else if ("lastName".equals(field)) setLastName(dto.getLastName());
			else if ("hcRenewDate".equals(field)) setHcRenewDate(dto.getHcRenewDate());
			else if ("pcnIndicator".equals(field)) setPcnIndicator(dto.getPcnIndicator());
			else if ("endDate".equals(field)) setEndDate(dto.getEndDate());
			else if ("hcType".equals(field)) setHcType(dto.getHcType());
			else if ("chartNo".equals(field)) setChartNo(dto.getChartNo());
			else if ("email".equals(field)) setEmail(dto.getEmail());
			else if ("effDate".equals(field)) setEffDate(dto.getEffDate());
			else if ("rosterTerminationDate".equals(field)) setRosterTerminationDate(dto.getRosterTerminationDate());
			else if ("rosterTerminationReason".equals(field)) setRosterTerminationReason(dto.getRosterTerminationReason());
			else if ("links".equals(field)) setLinks(dto.getLinks());
			else if ("alias".equals(field)) setAlias(dto.getAlias());
			else if ("previousAddress".equals(field)) setPreviousAddress(dto.getPreviousAddress());
			else if ("children".equals(field)) setChildren(dto.getChildren());
			else if ("sourceOfIncome".equals(field)) setSourceOfIncome(dto.getSourceOfIncome());
			else if ("citizenship".equals(field)) setCitizenship(dto.getCitizenship());
			else if ("sin".equals(field)) setSin(dto.getSin());
			else if ("anonymous".equals(field)) setAnonymous(dto.getAnonymous());
			else if ("spokenLanguage".equals(field)) setSpokenLanguage(dto.getSpokenLanguage());
			else if ("activeCount".equals(field)) setActiveCount(dto.getActiveCount());
			else if ("hsAlertCount".equals(field)) setHsAlertCount(dto.getHsAlertCount());
			else if ("displayName".equals(field)) setDisplayName(dto.getDisplayName());
			else if ("provider".equals(field)) setProvider(dto.getProvider());
			else if ("lastUpdateUser".equals(field)) setLastUpdateUser(dto.getLastUpdateUser());
			else if ("lastUpdateDate".equals(field)) setLastUpdateDate(dto.getLastUpdateDate());
			else if ("title".equals(field)) setTitle(dto.getTitle());
			else if ("officialLanguage".equals(field)) setOfficialLanguage(dto.getOfficialLanguage());
			else if ("countryOfOrigin".equals(field)) setCountryOfOrigin(dto.getCountryOfOrigin());
			else if ("newsletter".equals(field)) setNewsletter(dto.getNewsletter());
			else if ("nurse".equals(field)) setNurse(dto.getNurse());
			else if ("resident".equals(field)) setResident(dto.getResident());
			else if ("alert".equals(field)) setAlert(dto.getAlert());
			else if ("midwife".equals(field)) setMidwife(dto.getMidwife());
			else if ("notes".equals(field)) setNotes(dto.getNotes());
			else if ("waitingListID".equals(field)) setWaitingListID(dto.getWaitingListID());
			else if ("waitingListNote".equals(field)) setWaitingListNote(dto.getWaitingListNote());
			else if ("onWaitingListSinceDate".equals(field)) setOnWaitingListSinceDate(dto.getOnWaitingListSinceDate());
			else if ("age".equals(field)) setAge(dto.getAge());
			else if ("admissionProgramId".equals(field)) setAdmissionProgramId(dto.getAdmissionProgramId());
		}
	}
