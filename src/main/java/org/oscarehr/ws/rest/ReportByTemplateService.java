	...
	public String getReportByTemplatesFromK2A(@Context HttpServletRequest request) {
		...
		try {
			...
			if(k2aApp != null) {
				...
				if(k2aUser != null) {
					return OAuth1Utils.getOAuthResponse(k2aApp, k2aUser, "/ws/api/reportByTemplate/getReports");
				} else {
					return null;
				}
			} else {
	...
	public String addK2AReport(@PathParam("id") String id, @Context HttpServletRequest request) {
		...
		try {
			...
			if(k2aApp != null) {
				...
				if(k2aUser != null) {
					String xml = OAuth1Utils.getOAuthResponse(k2aApp, k2aUser, "/ws/api/reportByTemplate/getReportById/" + id);
