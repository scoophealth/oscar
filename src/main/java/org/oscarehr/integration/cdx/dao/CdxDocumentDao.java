...
@Repository
public class CdxDocumentDao extends AbstractDao<CdxDocument> {


    public CdxDocumentDao() {
        super(CdxDocument.class);
    }


    public CdxDocument getCdxDocument(String documentNo) {
        Integer id = null;
        try {
