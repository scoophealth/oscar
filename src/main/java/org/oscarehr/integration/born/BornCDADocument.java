...
public class BornCDADocument extends Level1Document{
    ...
    public enum BORNCDADocumentType {
 	...
 	public BornCDADocument(CDAStandard cdaStandard, BORNCDADocumentType type, Demographic demographic, List<Provider> providers, BornHialProperties props, Calendar effectiveDate) {
		super(cdaStandard);
		this.type = type;
		 ...
		 */
		this.addId(props.getIdCodingSystem(), props.getIdValue());
