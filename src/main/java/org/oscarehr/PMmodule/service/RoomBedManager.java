...
public interface RoomBedManager {
	...
	/**
	 * Get RoomBed relationship object with given room identifier
	 * 
	 * @param roomId
	 *            room identifier
	 * @return RoomBed relationship object
	 */
	public RoomBed getRoomBedByRoom(Integer roomId);

	/**
	 * Get RoomBed relationship object with given demographic identifier
	 * 
	 * @param demographicNo
	 *            demographic identifier
	 * @return RoomBed relationship object
	 */
	public RoomBed getRoomBedByBed(Integer demographicNo);

	/**
	 * Save RoomBed relationship object
	 * 
	 * @param roomBed
	 *            RoomBed relationship object
	 */
