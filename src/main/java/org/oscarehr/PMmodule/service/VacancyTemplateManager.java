...
public class VacancyTemplateManager {
	...
	public void setVacancyTemplateDAO(VacancyTemplateDAO dao) {
		this.vacancyTemplateDAO = dao;
	}
	...
	public void save() {
		...
		vt.setName("test");
		vt.setActive(true);
		vt.setProgramId(new Long(120));
		vacancyTemplateDAO.saveVacancyTemplate(vt);
	}
}
