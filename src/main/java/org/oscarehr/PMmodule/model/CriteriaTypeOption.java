...
/**
 * CriteriaTypeOption entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "criteria_type_option")
public class CriteriaTypeOption extends AbstractModel<Long> implements java.io.Serializable  {
