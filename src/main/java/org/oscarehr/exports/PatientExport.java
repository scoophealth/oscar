...
public abstract class PatientExport {
	...
	protected static IssueDAO issueDao = (IssueDAO)SpringUtils.getBean("IssueDAO");
	...
	protected static CaseManagementNoteExtDAO caseManagementNoteExtDao = (CaseManagementNoteExtDAO)SpringUtils.getBean("CaseManagementNoteExtDAO");
