...
//	if (setName!=null) zipName = "export_"+setName.replace(" ","")+"_"+UtilDateUtilities.getToday("yyyyMMddHHmmss")+".pgp";
	...
	private void exportLabResult(LabMeasurements labMea, LaboratoryResults labResults, String demoNo) throws SQLException {
		HashMap<String,String> labMeaValues = new HashMap<String,String>();
	...
	private void exportLabResult(HashMap<String,String> labMea, LaboratoryResults labResults, String demoNo) throws SQLException {
