...
public final class RxReasonAction extends DispatchAction {
	 ...
	 */
    public ActionForward addDrugReason(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)	throws IOException, ServletException {	
    ...
    public ActionForward archiveReason(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)	throws IOException, ServletException {
