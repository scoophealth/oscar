...
public class Frm2MinWalkRecord extends FrmRecord {
	...
	public Properties getFormRecord(int demographicNo, int existingID) throws SQLException {
		...
		if (existingID <= 0) {
			sql = "SELECT demographic_no, sex, year_of_birth, month_of_birth, date_of_birth, phone FROM demographic WHERE demographic_no = " + demographicNo;
			...
			sql = "SELECT * FROM form2MinWalk WHERE demographic_no = " + demographicNo + " AND ID = " + existingID;
			rs = DBHandler.GetSQL(sql);
	...
	public int saveFormRecord(Properties props) throws SQLException {
		...
		String sql = "SELECT * FROM form2MinWalk WHERE demographic_no=" + demographic_no + " AND ID=0";
	...
	public Properties getPrintRecord(int demographicNo, int existingID) throws SQLException {
		String sql = "SELECT * FROM form2MinWalk WHERE demographic_no = " + demographicNo + " AND ID = " + existingID;
		FrmRecordHelp frh = new FrmRecordHelp();
		frh.setDateFormat(_dateFormat);
