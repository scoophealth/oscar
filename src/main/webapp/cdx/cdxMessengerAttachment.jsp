...
<html:html locale="true">
    <head>
        ...
        <script type="text/javascript">
            ...
            privatedocs = EDocUtil.listDocsForCdxMessenger(loggedInInfo, demoNo, requestId, EDocUtil.ATTACHED);
            String attachedDocs = "";
