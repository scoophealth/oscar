...
<table bgcolor='silver' width='100%'>
	<tr>
		...
		<%
            ...
            out.println(risks.doStuff(session.getServletContext().getRealPath("/decision/annualreview/desannualreviewplannerrisk.xml")));
%>
		</td>
		<td>
		<%
            out.println(checklist.doStuff(session.getServletContext().getRealPath("/decision/annualreview/desannualreviewplannerriskchecklist.xml"), riskDataBean));
%>
