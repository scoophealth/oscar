...
<table width="100%" height="100%" border="0">
	<tr class="MainTableTopRow">
		...
		<table width="100%">
			<tr>
				...
				<td align="right"><oscar:help keywords="lab forwarding" key="app.top1"/> | <a
	...
	<tr>
		...
		<table>
			<tr>
				<td colspan="2" valign="bottom" class="Header">Provider
				Selection</td>
			</tr>
			<tr>
				<td class="Cell">Select the provider to set the rules for:</td>
				<td class="Cell"><select name="providerNo"
			...
			<tr>
				...
				(Hold 'Ctrl' to select multiple providers)</td>
