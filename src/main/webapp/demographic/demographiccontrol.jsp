...
<%
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"archive_record", "insert into demographicArchive (demographic_no,title,last_name,first_name,address,city,province,postal,phone,phone2,email,pin,year_of_birth,month_of_birth,date_of_birth,hin,ver,roster_status,roster_date,roster_termination_date,patient_status,patient_status_date,date_joined,chart_no,official_lang,spoken_lang,provider_no,sex,end_date,eff_date,pcn_indicator,hc_type,hc_renew_date,family_doctor,alias,previousAddress,children,sourceOfIncome,citizenship,sin,country_of_origin,newsletter,anonymous,lastUpdateUser,lastUpdateDate)(select demographic_no,title,last_name,first_name,address,city,province,postal,phone,phone2,email,pin,year_of_birth,month_of_birth,date_of_birth,hin,ver,roster_status,roster_date,roster_termination_date,patient_status,patient_status_date,date_joined,chart_no,official_lang,spoken_lang,provider_no,sex,end_date,eff_date,pcn_indicator,hc_type,hc_renew_date,family_doctor,alias,previousAddress,children,sourceOfIncome,citizenship,sin,country_of_origin,newsletter,anonymous,lastUpdateUser,lastUpdateDate from demographic where demographic_no=?)" },
    {"update_status_date", "update demographic set patient_status_date=now() where demographic_no=?" },
    {"update_termination_date", "update demographic set roster_termination_date=now() where roster_date is not null and roster_termination_date is null and demographic_no=?" },
    {"reset_termination_date", "update demographic set roster_termination_date=null where roster_date is not null and demographic_no=?" },
    {"add_record", "insert into demographic (last_name, first_name, address, city, province, postal, phone, phone2, email, pin, year_of_birth, month_of_birth, date_of_birth, hin, ver, roster_status, patient_status, date_joined, chart_no, provider_no, sex, end_date, eff_date, pcn_indicator, hc_type, roster_date, family_doctor, country_of_origin, newsletter, sin, title, official_lang, spoken_lang, lastUpdateUser, lastUpdateDate, patient_status_date) values(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,now(),now())" },
