...
<html:html locale="true">
	<head>
		...
		<%
			...
			List<Notification> notifications = notificationDao.findNotifications();
			String war=null;
			String err=null;
			if(notifications!=null && notifications.size()!=0) {
				for (Notification a : notifications) {
					if (a.getType().equalsIgnoreCase("Warning")) {
						war = "Warning";
		...
		<style type="text/css">
			...
			.green {
				background-color: #08d123;
			}

			.yellow {
				background-color: #d7c40d;
			}
			.red {
	...
	<table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" id="firstTable" class="noprint">
		<tr>
			...
			<td>
				...
				<ul >
					<a href="../cdx/cdxMessenger.jsp" target="_blank" title="Click to see details"> CDX Composer</a>
