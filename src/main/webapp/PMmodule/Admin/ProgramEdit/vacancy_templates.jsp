	...
	<table cellpadding="3" cellspacing="0" border="0">
		<tr>
			<th title="Programs" class="nofocus"><a
				onclick="javascript:clickTab('General');return false;"
		...
		<tr class="b">
			<td colspan="2" style="padding-left: 10%;">
				<div class="horizonton">
					...
					<div>
						<select name="sourceOfGender" multiple="multiple" size="7"
							style="width: 200px;">
				...
				<div class="horizonton" style="padding-top: 40px;">
					<div>
						<input type="button" name="toright" value=">>">
					</div>
					<div>
						<input type="button" name="toleft" value="<<">
					</div>
				</div>
				<div class="horizonton">
					<div style="margin-bottom: 3px;">Gender List</div>
					<div>
						<select name="targetOfGender" multiple="multiple" size="7"
							style="width: 200px;">
							<option value="male">male</option>
							<option value="female">female</option>
						</select>
		...
		<tr class="b">
			<td colspan="2" style="padding-left: 10%;">
				<div class="horizonton">
					...
					<div>
						<select name="sourceOfDiagnosis" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
				...
				<div class="horizonton">
					...
					<div>
						<select name="targetOfDiagnosis" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
		...
		<tr class="b">
			<td colspan="2" style="padding-left: 10%;">
				<div class="horizonton">
					...
					<div>
						<select name="sourceOfReferralType" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
				...
				<div class="horizonton">
					...
					<div>
						<select name="targetOfReferralType" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
		...
		<tr class="b">
			<td colspan="2" style="padding-left: 10%;">
				<div class="horizonton">
					...
					<div>
						<select name="sourceOfSupportType" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
				...
				<div class="horizonton">
					...
					<div>
						<select name="targetOfSupportType" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
		...
		<tr class="b">
			<td colspan="2" style="padding-left: 10%;">
				<div class="horizonton">
					...
					<div>
						<select name="sourceOfLegalStatus" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
				...
				<div class="horizonton">
					...
					<div>
						<select name="targetOfLegalStatus" multiple="multiple" size="7"
							style="width: 200px;">
						</select>
					</div>
				</div>
