...
<script type="text/javascript">
	function save() {
		document.programManagerForm.method.value='add_vacancy_template';
...
<%	for(VacancyTemplate vt : templates) { %>
	<tr class="b">
		<td class="beright">
		<a onclick="javascript:clickLink('General','Vacancy Templates', '<%=vt.getId() %>');return false;" href="javascript:void(0)"><%=vt.getName() %></a>
		<td><%=vt.getActive()==true?"Yes":"No" %></td>
	</tr>
<% 	} %>
	<tr class="b">
		<td class="beright">		
			<a onclick="javascript:clickLink('General','Vacancy Templates', '');return false;" href="javascript:void(0)">Create New Vacancy Template</a>
		</td>		
		<td></td>
	</tr>
</table>
