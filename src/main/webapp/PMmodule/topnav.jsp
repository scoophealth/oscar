	...
	<tr>
		<td valign="bottom">
			<ul id="navlist">
				...
				<li>
					<a href="#" ONCLICK ="popupPage2('http://www.oscarcanada.org/manual/oscar-caisi-documentation/');return false;" title="<bean:message key="provider.appointmentProviderAdminDay.viewResources"/>">R<u>e</u>sources</a>
				</li>
				<li>
