   ...
   jQuery(document).ready(function(){
	   ...
	   issueNoteUrls = {};
	   jQuery("#cppBoxes").html(""); //clear the residual boxes
       ...
       jQuery.ajax({url:ctx+"/eyeform/exam.jsp?demographic_no="+demographicNo+"&appointment_no="+appointmentNo,dataType: "html",async:false,success: function(data) {
     ...
     //create comma separated list of the measurement types (from attribute)
		...
		jQuery.ajax({dataType: "script", url:ctx+"/oscarEncounter/MeasurementData.do?demographicNo="+demographicNo+"&types="+types+"&action=getLatestValues&appointmentNo="+appointmentNo+"&fresh=cpp_currentHis"});
