...
<center>
  <table cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr><th><bean:message key="cid.index.description"/></th></tr>
  </table>
    ...
    <tr class="body"> 
      <td> 
         ...
         <table cellpadding="3" cellspacing="3" width="100%">
           <tr>
			 <td><span class="formLabel"><bean:message key="cid.co_cid"/></span></td>
             <td><span class="formLabel"><bean:message key="cid.ds_cid"/></span></td>
           </tr>
           <tr>
  ...
  <table cellpadding="3" cellspacing="3" border="0" width="100%">
     <tr>
       <td align="center">
        <html:submit><bean:message key="cid.btnFindCid"/></html:submit>
       </td>
     </tr>
  </table>
  <br>
  <table cellspacing="0" cellpadding="2" width="90%" border="0">
    ...
    <logic:present name="cidForm" property="cid">
    	...
    	<logic:iterate id="cid" name="cidForm" property="cid" type="oscar.billing.cad.model.CadCid" offset="offset" length="length" indexId="idx">
    		<tr>
			   <td align="center">
					<a href="#" class="formLink" onclick="javascript:selecionar('<bean:write name="cid" property="coCid"/>','<bean:write name="cid" property="dsCid"/>');"><bean:message key="popups.popup_cid.btnSelect"/></a>
			   </td>
               <td>
					<bean:write name="cid" property="coCid"/>
               </td>
               <td>
               		<bean:write name="cid" property="dsCid"/>
               	</td>
    		</tr>
    	</logic:iterate>
    </logic:present>
