  ...
  <TR> 
    <TD VALIGN="TOP"HEIGHT=16 colspan="2"> 
      <table border="0" width="100%">
        <tr> 
          <td ALIGN="CENTER"> <FONT FACE="Arial, Helvetica"><B>ANTENATAL PSYCHOSOCIAL 
            HEALTH ASSESSMENT (ALPHA)</B></FONT></TD>
          <td align="right"><a href="formALPHAprint.jsp"> prev page </a> | <a href=# onClick="window.print();">PRINT</a> 
          </td>
        </tr>
      </table>
    </td>
