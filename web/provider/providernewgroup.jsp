...
<head><title> <bean:message key="provider.providernewgroup.title"/></title></head>
...
<FORM NAME = "UPDATEPRE" METHOD="post" ACTION="providercontrol.jsp" onSubmit="return checkForm();">
<table border=0 cellspacing=0 cellpadding=0 width="100%" >
  <tr bgcolor="#486ebd"> 
      <th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF"><bean:message key="provider.providernewgroup.msgTitle"/></font></th>
  </tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="80%">
  <tr><td width="100%">
          ...
          <table BORDER="0" CELLPADDING="0" CELLSPACING="1" WIDTH="100%" BGCOLOR="#C0C0C0">
            <tr BGCOLOR="#CCFFFF" > 
              <td ALIGN="center"> <font face="arial"> <bean:message key="provider.providernewgroup.msgGroupNo"/></font></td>
              <td ALIGN="center"> <font face="arial"> </font> 
                <input type="text" name="mygroup_no" size="10" maxlength="10">
                <font size="-2"><bean:message key="provider.providernewgroup.msgMaxChars"/></font></td>
          </tr>
<%
...
<table width="100%" BGCOLOR="#486ebd">
  <tr>
    <TD align="center">
        ...
        <input type="submit" value="<bean:message key="provider.providernewgroup.btnSave"/>">
        <INPUT TYPE = "RESET" VALUE = "<bean:message key="provider.providernewgroup.btnExit"/>" onClick="window.close();"></TD>
  </tr>
</TABLE>
