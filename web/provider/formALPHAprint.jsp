...
<TR><TD VALIGN="TOP"HEIGHT=16 colspan="2">
<table border="0" width="100%"><tr><td ALIGN="CENTER">
<FONT FACE="Arial, Helvetica"><B>ANTENATAL PSYCHOSOCIAL HEALTH ASSESSMENT (ALPHA)</B></FONT></TD>
<td align="right"><a href="formALPHAprint1.jsp"> next page </a> | <a href=# onClick="window.print();">PRINT</a>
</td></tr></table>
</td></TR>
<TR>
    <TD WIDTH="92%" VALIGN="TOP" ALIGN="JUSTIFY"> <font face="Arial, Helvetica" size="-2">Antenatal 
...
<TABLE BORDER BORDERCOLOR="#000000" CELLSPACING=1 CELLPADDING=4>
  <TR bgcolor="#eeeeee"> 
    <TD WIDTH="50%" VALIGN="TOP" ALIGN="CENTER" bgcolor="#eeeeee"> <font face="Arial, Helvetica" size="-1"><B>ANTENATAL 
      FACTORS</B></font></TD>
    <TD  WIDTH="50%" VALIGN="TOP" ALIGN="CENTER"> <font face="Arial, Helvetica" size="-1"><B>COMMENTS/PLAN</B></font></TD>
  </TR>
  <TR bgcolor="#f9f9f9"> 
    <TD colspan="2" VALIGN="TOP"> <FONT FACE="Arial, Helvetica" Size="-1">FAMILY 
      FACTORS</FONT></TD>
  </TR>
  <TR> 
  ...
  <TR bgcolor="#f9f9f9"> 
    <TD colspan="2" VALIGN="TOP"> <FONT FACE="Arial, Helvetica" Size="-1">MATERNAL 
      FACTORS</FONT></TD>
  </TR>
  <TR> 
