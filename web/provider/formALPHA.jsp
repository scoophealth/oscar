...
<table border="0" cellspacing="0" cellpadding="0" width="100%" >
    <tr bgcolor="#486ebd"><th width="15%" nowrap>
	<%=bNew?"<input type='submit' name='saveexit' value='Save to Enc.& Exit' onClick='onSaveExit()'> ":""%></th>
      ...
      <th width="25%" nowrap align='right'> 
          <%=bNew?"<input type='button' name='Button' value=' Exit ' onClick='onExit();'>":"<input type='button' name='Button' value=' Exit ' onClick='window.close();'>" %>
  ...
  <table width="100%" border="0" bgcolor="ivory" <%=bNew?"":"datasrc='#xml_list'"%>>
          <tr bgcolor="#99FF99"> 
    ...
    <td align="right"><%--=bNew?"<input type='submit' name='subbutton' value=' Save '>":""--%>
          ...
          <tr> 
            <td  width="50%"> <b>Social support (CA, WA, PD)
              </b> 
        ...
        <textarea name="xml_ff_socialsupport" style="width:100%" cols="40" rows="3" <%=bNew?"":"datafld='xml_ff_socialsupport'"%> ></textarea>
            </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">What changes are you planning during this pregnancy?</font></li>
            ...
            <td>
        <textarea name="xml_ff_recentstressfullifeevents" style="width:100%" cols="40" rows="3" <%=bNew?"":"datafld='xml_ff_recentstressfullifeevents'"%>></textarea>
      </td>
          </tr>
          <tr> 
            <td  > <b>Couple's relationship (CD, PD, WA, CA)</b> 
              
        <li><font size="-1">How would you describe your relationship with your 
          partner?</font></li>
        <li><font size="-1">What do you think your relationship will be like after 
          the birth?</font><br>
              </li>
            </td>
            <td>
        <textarea name="xml_ff_couplerelationship" style="width:100%" cols="40" rows="3" <%=bNew?"":"datafld='xml_ff_couplerelationship'"%>></textarea>
      </td>
          </tr>
          <tr bgcolor="#99FF99"> 
        ...
        <li><font size="-1">First prenatal visit in third trimester? (check records)</font></li>
            ...
            <td>
        <textarea name="xml_mf_prenatalcare" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_prenatalcare'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">What are your plans for prenatal classes? </font></li>
            ...
            <td>
        <textarea name="xml_mf_prenataleducation" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_prenataleducation'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">How did you feel when you just found out you were 
          pregnant?</font></li>
        <li><font size="-1">How do you feel about it now?</font></li>
            </td>
            <td>
        <textarea name="xml_mf_feelingstopregnancy20" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_feelingstopregnancy20'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">Did you feel loved by your parents?</font></li>
            ...
            <td>
        <textarea name="xml_mf_relationshipwithparents" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_relationshipwithparents'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">What concerns do you have about becoming/being a mother?</font></li>
            ...
            <td>
        <textarea name="xml_mf_selfesteem" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_selfesteem'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">Have you ever seen a psychiatrist or therapist?</font></li>
            ...
            <td>
        <textarea name="xml_mf_historypsychiatricemaotional" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_historypsychiatricemaotional'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">How has your mood been during this pregnancy? </font></li>
            ...
            <td>
        <textarea name="xml_mf_depression" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_mf_depression'"%>></textarea>
      </td>
          </tr>
          <tr bgcolor="#99FF99"> 
        ...
        <li><font size="-1">Do you or your partner have a problem with alcohol 
          or drugs?</font></li>
        <li><font size="-1">Consider CAGE (<b>C</b>ut down, <b>A</b>nnoyed, <b>G</b>uilty, 
          <b>E</b>ye opener)</font></li>
            </td>
            <td>
        <textarea name="xml_su_alcoholdrugabuse" style="width:100%" cols="40" rows="5" <%=bNew?"":"datafld='xml_su_alcoholdrugabuse'"%>></textarea>
      </td>
          </tr>
          <tr bgcolor="#99FF99"> 
        ...
        <li><font size="-1">Were you ever sexually abused as a child?</font></li>
            ...
            <td>
        <textarea name="xml_fv_experiencedwitnessedabuse" style="width:100%" cols="40" rows="5" <%=bNew?"":"datafld='xml_fv_experiencedwitnessedabuse'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">Do you ever feel frightened by what your partner says 
          or does? </font></li>
        <li><font size="-1">Have you ever been hit/pushed/slapped by a partner? 
          </font></li>
        <li><font size="-1">Has your partner ever humiliated you or psychologically 
          abused you in other ways? </font></li>
        <li><font size="-1">Have you ever been forced to have sex against your 
          will? </font></li>
            </td>
            <td>
        <textarea name="xml_fv_currentpastabuse" style="width:100%" cols="40" rows="5" <%=bNew?"":"datafld='xml_fv_currentpastabuse'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">Do you/your partner have children not living with 
          you? If so, why? </font></li>
        <li><font size="-1">Have you ever had involvement with a child protection 
          agency<br>
          (ie Children's Aid Society)? </font></li>
            </td>
            <td>
        <textarea name="xml_fv_previouschildabuse" style="width:100%" cols="40" rows="2" <%=bNew?"":"datafld='xml_fv_previouschildabuse'"%>></textarea>
      </td>
          </tr>
          <tr> 
        ...
        <li><font size="-1">How do you deal with your kids at home when they misbehave?</font></li>
            ...
            <td>
        <textarea name="xml_fv_childdiscipline" style="width:100%" cols="40" rows="3" <%=bNew?"":"datafld='xml_fv_childdiscipline'"%>></textarea>
      </td>
          </tr>
  </table>  
  <table width="100%" border="0" bgcolor="ivory" <%=bNew?"":"datasrc='#xml_list'"%>>
    ...
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_scbp" value="checked" <%=bNew?"":"datafld='xml_fu_scbp'"%> >
      </td>
      <td> Supportive counselling by provider</td>
      <td> 
        <input type="checkbox" name="xml_fu_homecare" value="checked" <%=bNew?"":"datafld='xml_fu_homecare'"%>>
      </td>
      <td>Homecare</td>
      <td> 
        <input type="checkbox" name="xml_fu_awhsc" value="checked" <%=bNew?"":"datafld='xml_fu_awhsc'"%>>
      </td>
      <td>Assaulted women's helpline / shelter / counseling</td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_apra" value="checked" <%=bNew?"":"datafld='xml_fu_apra'"%>>
      </td>
      <td>Additional prenatal appointments </td>
      <td> 
        <input type="checkbox" name="xml_fu_pcpsg" value="checked" <%=bNew?"":"datafld='xml_fu_pcpsg'"%>>
      </td>
      <td>Parenting classes / parents' support group</td>
      <td>
        <input type="checkbox" name="xml_fu_la" value="checked" <%=bNew?"":"datafld='xml_fu_la'"%>>
      </td>
      <td>Legal advice</td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_apoa" value="checked" <%=bNew?"":"datafld='xml_fu_apoa'"%>>
      </td>
      <td>Additional postpartum appointments</td>
      <td> 
        <input type="checkbox" name="xml_fu_atp" value="checked" <%=bNew?"":"datafld='xml_fu_atp'"%>>
      </td>
      <td>Addiction treatment programs</td>
      <td>
        <input type="checkbox" name="xml_fu_cas" value="checked" <%=bNew?"":"datafld='xml_fu_cas'"%>>
      </td>
      <td>Children's Aid Society</td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_awbv" value="checked" <%=bNew?"":"datafld='xml_fu_awbv'"%>>
      </td>
      <td>Additional well baby visits </td>
      <td> 
        <input type="checkbox" name="xml_fu_scr" value="checked" <%=bNew?"":"datafld='xml_fu_scr'"%>>
      </td>
      <td>Smoking cessation resources</td>
      <td>
        <input type="checkbox" name="xml_fu_other1" value="checked" <%=bNew?"":"datafld='xml_fu_other1'"%>>
      </td>
      <td>Other: 
        <input type="text" name="xml_fu_other11" <%=bNew?"":"datafld='xml_fu_other1'"%>>
      </td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_phr" value="checked" <%=bNew?"":"datafld='xml_fu_phr'"%>>
      </td>
      <td>Public Health referral </td>
      <td> 
        <input type="checkbox" name="xml_fu_sw" value="checked" <%=bNew?"":"datafld='xml_fu_sw'"%>>
      </td>
      <td>Social Worker</td>
      <td>
        <input type="checkbox" name="xml_fu_other2" value="checked" <%=bNew?"":"datafld='xml_fu_other2'"%>>
      </td>
      <td>Other: 
        <input type="text" name="xml_fu_other21" <%=bNew?"":"datafld='xml_fu_other21'"%>>
      </td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_pes" value="checked" <%=bNew?"":"datafld='xml_fu_pes'"%>>
      </td>
      <td>Prenatal education services </td>
      <td> 
        <input type="checkbox" name="xml_fu_pp" value="checked" <%=bNew?"":"datafld='xml_fu_pp'"%>>
      </td>
      <td>Psychologist / Psychiatrist</td>
      <td>
        <input type="checkbox" name="xml_fu_other3" value="checked" <%=bNew?"":"datafld='xml_fu_other3'"%>>
      </td>
      <td>Other: 
        <input type="text" name="xml_fu_other31" <%=bNew?"":"datafld='xml_fu_other31'"%>>
      </td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_nutritionist" value="checked" <%=bNew?"":"datafld='xml_fu_nutritionist'"%>>
      </td>
      <td>Nutritionist </td>
      <td> 
        <input type="checkbox" name="xml_fu_pmft" value="checked" <%=bNew?"":"datafld='xml_fu_pmft'"%>>
      </td>
      <td>Psychotherapist / marital / family therapist</td>
      <td>
        <input type="checkbox" name="xml_fu_other4" value="checked" <%=bNew?"":"datafld='xml_fu_other4'"%>>
      </td>
      <td>Other: 
        <input type="text" name="xml_fu_other41" <%=bNew?"":"datafld='xml_fu_other41'"%>>
      </td>
    </tr>
    <tr> 
      <td> 
        <input type="checkbox" name="xml_fu_crmg" value="checked" <%=bNew?"":"datafld='xml_fu_crmg'"%>>
      </td>
  ...
  <table width="100%" border="0" bgcolor="ivory" <%=bNew?"":"datasrc='#xml_list'"%>>
	<tr>
      <td><b>COMMENTS</b>:<br>
        <textarea name="xml_comments" style="width:100%" cols="80" <%=bNew?"":"datafld='xml_comments'"%> ></textarea>
      </td>
    </tr>
    <tr bgcolor="#486ebd"><td align="center" >
<%
  GregorianCalendar now=new GregorianCalendar();
%>	
          <input type="hidden" name="xml_subject" value="form:ALPHA">
