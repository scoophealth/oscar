...
<%  } %>
	...
	<!-- open CME in current window
        ...
        --> 
	<a href=# onClick="popupPage(755, 980,'../oscarSurveillance/CheckSurveillance.do?demographicNo=<%=demographic_no%>&proceed=<%=URLEncoder.encode(eURL)%>');return false;" title="<bean:message key="global.encounter"/>">
