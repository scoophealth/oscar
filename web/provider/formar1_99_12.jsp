      ...
      <td   valign="top">
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
          ...
          <tr align="center"> 
            <td>1</td>
            <td>
              <input type="text" name="xml_oh1ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh1ye'"%> >
            </td>
            <td>
          ...
          <tr align="center"> 
            <td>2</td>
            <td>
              <input type="text" name="xml_oh2ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh2ye'"%> >
            </td>
            <td>
          ...
          <tr align="center"> 
            <td>3</td>
            <td>
              <input type="text" name="xml_oh3ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh3ye'"%> >
            </td>
            <td>
          ...
          <tr align="center"> 
            <td>4</td>
            <td>
              <input type="text" name="xml_oh4ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh4ye'"%> >
            </td>
            <td>
          ...
          <tr align="center"> 
            <td>5</td>
            <td>
              <input type="text" name="xml_oh5ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh5ye'"%> >
            </td>
            <td>
          ...
          <tr align="center"> 
            <td>6</td>
            <td>
              <input type="text" name="xml_oh6ye" size="5" maxlength="8" style="width:90%" <%=bNew?"":"datafld='xml_oh6ye'"%> >
            </td>
            <td>
...
<hr>
      ...
      <td valign="top"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td colspan="3">
              <textarea name="xml_rfi" cols="20" rows="5" style="width:100%" <%=bNewList?"":"datafld='xml_rfi'"%>><%=bNewList?riskFactors:""%></textarea>
            </td>
          </tr>
        </table>
      </td>
      <td valign="top"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td colspan="2"> Ht. 
              <input type="text" name="xml_peh" size="5" maxlength="6" <%=bNew?"":"datafld='xml_peh'"%> onChange="checkTypeInUnit(this)">
              Wt. 
              <input type="text" name="xml_pew" size="5" maxlength="6" <%=bNew?"":"datafld='xml_pew'"%> onChange="checkTypeInUnit(this)">
            </td>
          </tr>
          <tr> 
            <td colspan="2"> Pre-preg. wt. 
              <input type="text" name="xml_ppw" size="6" maxlength="6" <%=bNewList?"value=\""+prepregwt+"\"":"datafld='xml_ppw'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2"> BP 
  ...
  <table width="100%" border="0" <%=bNew?"":"datasrc='#xml_list'"%>>
	...
	<tr>
      <td colspan="2">
        <textarea name="xml_comments" style="width:100%" cols="80" <%=bNew?"":"datafld='xml_comments'"%> rows="5" ></textarea>
      </td>
    </tr>
<%
