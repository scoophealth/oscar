...
%>
  ...
  <table width="60%" border="1"  cellspacing="0" cellpadding="0" <%=bNew?"":"datasrc='#xml_list'"%>>
    ...
    <tr>
      ...
      <td>Newborn care<br>
        <input type="text" name="xml_nc" size="15" style="width:100%" maxlength="25" <%=bNewList?("value=\""+newbornCare+"\""):"datafld='xml_nc'"%> >
        </td>
    </tr>
  </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" <%=bNew?"":"datasrc='#xml_list'"%>>
    ...
    <tr align="center"> 
      <td><textarea name="xml_rfi" cols="20" rows="3" style="width:100%" <%=bNewList?(""):"datafld='xml_rfi'"%> ><%=bNewList?(riskFactors):""%></textarea></td>
      <td><textarea name="xml_Alert_demographicaccessory" style="width:100%" cols="30" rows="3" <%=bNewList?"":"datafld='xml_Alert_demographicaccessory'"%> ><%=bNewList?allergies:""%></textarea></td>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" <%=bNew?"":"datasrc='#xml_list'"%>>
    <tr> 
      <td nowrap width="13%"><b>Final EDB</b> (yyyy/mm/dd)<br>
        <input type="text" name="xml_fedb" style="width:100%" size="10" maxlength="10" <%=bNewList?"value=\""+finalEDB+"\"":"datafld='xml_fedb'"%> >
      </td>
      <td align="center" bgcolor="#CCCCCC" width="3%">G</td>
      <td width="9%">
<input type="text" name="xml_gra" size="5" style="width:100%" maxlength="10" <%=bNewList?"value=\""+g+"\"":"datafld='xml_gra'"%> >
      </td>
      <td align="center" bgcolor="#CCCCCC" width="3%">T</td>
      <td width="10%"> 
        <input type="text" name="xml_term" size="5" style="width:100%" maxlength="10" <%=bNewList?"value=\""+t+"\"":"datafld='xml_term'"%>  >
      </td>
      <td align="center" bgcolor="#CCCCCC" width="3%">P</td>
      <td width="9%"> 
        <input type="text" name="xml_prem" size="5" style="width:100%" maxlength="10" <%=bNewList?"value=\""+p+"\"":"datafld='xml_prem'"%> >
      </td>
      <td align="center" bgcolor="#CCCCCC" width="3%">A</td>
      <td width="7%"> 
        <input type="text" name="xml_etss" size="5" style="width:100%" maxlength="10" <%=bNewList?"value=\""+a+"\"":"datafld='xml_etss'"%> readonly onClick="onAR1FieldsFocus(this)">
      </td>
      <td align="center" bgcolor="#CCCCCC" width="3%">L</td>
      <td width="7%"> 
        <input type="text" name="xml_liv" size="5" style="width:100%" maxlength="10" <%=bNewList?"value=\""+l+"\"":"datafld='xml_liv'"%>  >
      </td>
      <td width="8%">Hb<br>
        <input type="text" name="xml_hb" size="5" style="width:100%" maxlength="10" <%=bNew?"":"datafld='xml_hb'"%>>
      </td>
      <td width="8%">MCV<br>
        <input type="text" name="xml_mcv" size="5" style="width:100%" maxlength="10" <%=bNew?"":"datafld='xml_mcv'"%>>
      </td>
      <td>MSS<br>
        <input type="text" name="xml_mss" size="5" style="width:100%" maxlength="10" <%=bNew?"":"datafld='xml_mss'"%>>
      </td>
    </tr>
  </table>
  <table width="100%" border="1" cellspacing="0" cellpadding="0" <%=bNew?"":"datasrc='#xml_list'"%>>
    <tr> 
      <td nowrap width="13%">Pre-preg. wt.<br>
        <input type="text" name="xml_ppw" size="5" style="width:100%" maxlength="6" <%=bNewList?"value=\""+prepregwt+"\"":"datafld='xml_ppw'"%>>
      </td>
      <td align="center" bgcolor="#CCCCCC" width="6%">Rubella<br>
        immune </td>
      <td width="6%"> 
        <input type="text" name="xml_rub" size="5"  style="width:100%" maxlength="5" <%=bNew?"":"datafld='xml_rub'"%>>
      </td>
      <td align="center" bgcolor="#CCCCCC" width="6%" nowrap>HBs Ag</td>
      <td width="7%"> 
        <input type="text" name="xml_hbs" size="5" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_hbs'"%>>
      </td>
      <td align="center" bgcolor="#CCCCCC" width="5%">VDRL</td>
      <td width="6%"> 
        <input type="text" name="xml_vdr" size="5" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_vdr'"%>>
      </td>
      <td align="center" bgcolor="#CCCCCC" width="6%">Blood<br>
        group </td>
      <td width="5%"> 
        <input type="text" name="xml_blo" size="5" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_blo'"%>>
      </td>
      <td align="center" bgcolor="#CCCCCC" width="6%">Rh type<br>
        (+/-) </td>
      <td width="5%"> 
        <input type="text" name="xml_rhp" size="6" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_rhp'"%>>
      </td>
      <td width="7%" bgcolor="#CCCCCC">
        <div align="center">Antibodies</div>
      </td>
      <td width="12%">
        <input type="text" name="xml_anti" size="5" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_anti'"%>>
      </td>
      ...
      <td>
        <input type="text" name="xml_rhg" size="5" style="width:100%" maxlength="6" <%=bNew?"":"datafld='xml_rhg'"%>>
      </td>
    </tr>
  </table>
...
%>    
    <tr align="center"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv1wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv1wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv1pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv1pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv1fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv1fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv1upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv1upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv1ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv1ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv1bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv1bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv1co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv1co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv1ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv1ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv2wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv2wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv2pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv2pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv2fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv2fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv2upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv2upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv2ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv2ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv2bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv2bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv2co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv2co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv2ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv2ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv3wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv3wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv3pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv3pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv3fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv3fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv3upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv3upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv3ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv3ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv3bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv3bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv3co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv3co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv3ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv3ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv4wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv4wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv4pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv4pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv4fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv4fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv4upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv4upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv4ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv4ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv4bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv4bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv4co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv4co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv4ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv4ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv5wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv5wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv5pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv5pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv5fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv5fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv5upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv5upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv5ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv5ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv5bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv5bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv5co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv5co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv5ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv5ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv6wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv6wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv6pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv6pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv6fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv6fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv6upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv6upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv6ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv6ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv6bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv6bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv6co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv6co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv6ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv6ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv7wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv7wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv7pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv7pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv7fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv7fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv7upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv7upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv7ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv7ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv7bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv7bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv7co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv7co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv7ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv7ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv8wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv8wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv8pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv8pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv8fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv8fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv8upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv8upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv8ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv8ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv8bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv8bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv8co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv8co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv8ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv8ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv9wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv9wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv9pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv9pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv9fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv9fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv9upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv9upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv9ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv9ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv9bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv9bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv9co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv9co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv9ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv9ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv10wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv10wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv10pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv10pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv10fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv10fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv10upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv10upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv10ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv10ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv10bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv10bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv10co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv10co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv10ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv10ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv11wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv11wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv11pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv11pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv11fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv11fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv11upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv11upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv11ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv11ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv11bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv11bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv11co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv11co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv11ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv11ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv12wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv12wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv12pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv12pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv12fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv12fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv12upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv12upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv12ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv12ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv12bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv12bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv12co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv12co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv12ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv12ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv13wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv13wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv13pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv13pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv13fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv13fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv13upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv13upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv13ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv13ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv13bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv13bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv13co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv13co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv13ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv13ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv14wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv14wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv14pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv14pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv14fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv14fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv14upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv14upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv14ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv14ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv14bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv14bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv14co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv14co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv14ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv14ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv15wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv15wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv15pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv15pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv15fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv15fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv15upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv15upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv15ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv15ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv15bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv15bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv15co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv15co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv15ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv15ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv16wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv16wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv16pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv16pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv16fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv16fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv16upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv16upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv16ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv16ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv16bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv16bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv16co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv16co'"%>>
      </td>
      <td nowrap width="4%"> 
        <input type="text" name="xml_sv16ra" size="5" maxlength="5" style="width:90%" <%=bNew?"":"datafld='xml_sv16ra'"%>>
      </td>
    </tr>
    <tr align="center"> 
      <td width="11%"> 
      ...
      <td width="7%"> 
        <input type="text" name="xml_sv17wt" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv17wt'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv17pr" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv17pr'"%>>
      </td>
      <td width="7%"> 
        <input type="text" name="xml_sv17fh" size="6" maxlength="6" style="width:90%" <%=bNew?"":"datafld='xml_sv17fh'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv17upr" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv17upr'"%>>
      </td>
      <td width="4%"> 
        <input type="text" name="xml_sv17ugl" size="2" maxlength="3" style="width:90%" <%=bNew?"":"datafld='xml_sv17ugl'"%>>
      </td>
      <td width="11%"> 
        <input type="text" name="xml_sv17bp" size="7" maxlength="8" style="width:100%" <%=bNew?"":"datafld='xml_sv17bp'"%>>
      </td>
      <td nowrap width="33%"> 
        <input type="text" name="xml_sv17co" size="20" maxlength="70" style="width:100%" <%=bNew?"":"datafld='xml_sv17co'"%>>
      </td>
      <td nowrap width="4%"> 
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td rowspan="6" nowrap width="18%"><b> &nbsp; &nbsp; Referral Plan<br>
              ...
              <input type="checkbox" name="xml_rpob" value="checked" <%=bNew?"":"datafld='xml_rpob'"%>>
              Obstetrician<br>
              <input type="checkbox" name="xml_rppp" value="checked" <%=bNew?"":"datafld='xml_rppp'"%>>
              Pediatrician<br>
              <input type="checkbox" name="xml_rpan" value="checked" <%=bNew?"":"datafld='xml_rpan'"%>>
              Anesthesiologist<br>
              <input type="checkbox" name="xml_rpsw" value="checked" <%=bNew?"":"datafld='xml_rpsw'"%>>
              Social worker<br>
              <input type="checkbox" name="xml_rpdi" value="checked" <%=bNew?"":"datafld='xml_rpdi'"%>>
              Dietitian<br>
              <input type="checkbox" name="xml_rpotc" value="checked" <%=bNew?"":"datafld='xml_rpotc'"%>>
              Other<br>
              <input type="text" name="xml_rpott" size="20" maxlength="35" <%=bNew?"":"datafld='xml_rpott'"%>>
            </td>
            <td rowspan="18" nowrap valign="top">&nbsp; &nbsp; <b>Discussion Topics<br>
              </b> 
              <input type="checkbox" name="xml_dtdu" value="checked" <%=bNew?"":"datafld='xml_dtdu'"%>>
              Drug use<br>
              <input type="checkbox" name="xml_dtsm" value="checked" <%=bNew?"":"datafld='xml_dtsm'"%>>
              Smoking<br>
              <input type="checkbox" name="xml_dtal" value="checked" <%=bNew?"":"datafld='xml_dtal'"%>>
              Alcohol<br>
              <input type="checkbox" name="xml_dtex" value="checked" <%=bNew?"":"datafld='xml_dtex'"%>>
              Exercise<br>
              <input type="checkbox" name="xml_dtwp" value="checked" <%=bNew?"":"datafld='xml_dtwp'"%>>
              Work plan<br>
              <input type="checkbox" name="xml_dtin" value="checked" <%=bNew?"":"datafld='xml_dtin'"%>>
              Intercourse<br>
              <input type="checkbox" name="xml_dtdc" value="checked" <%=bNew?"":"datafld='xml_dtdc'"%>>
              Dental care<br>
              <input type="checkbox" name="xml_dttr" value="checked" <%=bNew?"":"datafld='xml_dttr'"%>>
              Travel<br>
              <input type="checkbox" name="xml_dtpc" value="checked" <%=bNew?"":"datafld='xml_dtpc'"%>>
              Prenatal classes<br>
              <input type="checkbox" name="xml_dtbf" value="checked" <%=bNew?"":"datafld='xml_dtbf'"%>>
              Breast feeding<br>
              <input type="checkbox" name="xml_dtbp" value="checked" <%=bNew?"":"datafld='xml_dtbp'"%>>
              Birth plan<br>
              <input type="checkbox" name="xml_dtpl" value="checked" <%=bNew?"":"datafld='xml_dtpl'"%>>
              Preterm labour<br>
              <input type="checkbox" name="xml_dtpr" value="checked" <%=bNew?"":"datafld='xml_dtpr'"%>>
              PROM<br>
              <input type="checkbox" name="xml_dtfm" value="checked" <%=bNew?"":"datafld='xml_dtfm'"%>>
              Fetal movement<br>
              <input type="checkbox" name="xml_dtat" value="checked" <%=bNew?"":"datafld='xml_dtat'"%>>
              Admission timing<br>
              <input type="checkbox" name="xml_dtls" value="checked" <%=bNew?"":"datafld='xml_dtls'"%>>
              Labour support<br>
              <input type="checkbox" name="xml_dtpm" value="checked" <%=bNew?"":"datafld='xml_dtpm'"%>>
              Pain management<br>
              <input type="checkbox" name="xml_dtde" value="checked" <%=bNew?"":"datafld='xml_dtde'"%>>
              Depression<br>
              <input type="checkbox" name="xml_dtci" value="checked" <%=bNew?"":"datafld='xml_dtci'"%>>
              Circumcision<br>
              <input type="checkbox" name="xml_dtcs" value="checked" <%=bNew?"":"datafld='xml_dtcs'"%>>
              Car safety<br>
              <input type="checkbox" name="xml_dtco" value="checked" <%=bNew?"":"datafld='xml_dtco'"%>>
              Contraception<br>
              <input type="checkbox" name="xml_dtoc" value="checked" <%=bNew?"":"datafld='xml_dtoc'"%>>
              On call</td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td> 
              <input type="text" name="xml_uda1" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uda1'"%>>
            </td>
            <td> 
              <input type="text" name="xml_uga1" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uga1'"%>>
            </td>
            <td colspan="2"> 
              <input type="text" name="xml_ure1" size="25" <%=bNew?"":"datafld='xml_ure1'"%>>
            </td>
          </tr>
          <tr> 
            <td width="34%"> 
              <input type="text" name="xml_uda2" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uda2'"%>>
            </td>
            <td> 
              <input type="text" name="xml_uga2" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uga2'"%>>
            </td>
            <td colspan="2"> 
              <input type="text" name="xml_ure2" size="25" <%=bNew?"":"datafld='xml_ure2'"%>>
            </td>
          </tr>
          <tr> 
            <td> 
              <input type="text" name="xml_uda3" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uda3'"%>>
            </td>
            <td> 
              <input type="text" name="xml_uga3" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uga3'"%>>
            </td>
            <td colspan="2"> 
              <input type="text" name="xml_ure3" size="25" <%=bNew?"":"datafld='xml_ure3'"%>>
            </td>
          </tr>
          <tr> 
            <td> 
              <input type="text" name="xml_uda4" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uda4'"%>>
            </td>
            <td> 
              <input type="text" name="xml_uga4" size="10" maxlength="10" <%=bNew?"":"datafld='xml_uga4'"%>>
            </td>
            <td colspan="2"> 
              <input type="text" name="xml_ure4" size="25" <%=bNew?"":"datafld='xml_ure4'"%>>
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td width="13%"> 
              <input type="text" name="xml_re1" size="10" maxlength="20" <%=bNew?"":"datafld='xml_re1'"%>>
            </td>
            <td colspan="2" rowspan="10" align="center"> 
              <textarea name="xml_com" style="width:98%" rows="14" cols="20" <%=bNew?"":"datafld='xml_com'"%>></textarea>
            </td>
          </tr>
          <tr> 
            <td colspan="2">2. GC/Chlamydia</td>
            <td> 
              <input type="text" name="xml_re2" size="10" <%=bNew?"":"datafld='xml_re2'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">3. HIV</td>
            <td> 
              <input type="text" name="xml_re3" size="10" <%=bNew?"":"datafld='xml_re3'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">4. B. vaginosis</td>
            <td> 
              <input type="text" name="xml_re4" size="10" <%=bNew?"":"datafld='xml_re4'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">5. Group B strep</td>
            <td> 
              <input type="text" name="xml_re5" size="10" <%=bNew?"":"datafld='xml_re5'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">6. Urine culture</td>
            <td> 
              <input type="text" name="xml_re6" size="10" <%=bNew?"":"datafld='xml_re6'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">7. Sickle dex</td>
            <td> 
              <input type="text" name="xml_re7" size="10" <%=bNew?"":"datafld='xml_re7'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">8. Hb electro</td>
            <td> 
              <input type="text" name="xml_re8" size="10" <%=bNew?"":"datafld='xml_re8'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">9. Amnio/CVS</td>
            <td> 
              <input type="text" name="xml_re9" size="10" <%=bNew?"":"datafld='xml_re9'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">10. Glucose screen</td>
            <td> 
              <input type="text" name="xml_re10" size="10" <%=bNew?"":"datafld='xml_re10'"%>>
            </td>
          </tr>
          <tr> 
            <td colspan="2">11. Other<br>
              <input type="text" name="xml_st11" size="20" <%=bNew?"":"datafld='xml_st11'"%>>
            </td>
            <td> 
              <input type="text" name="xml_re11" size="10" <%=bNew?"":"datafld='xml_re11'"%>>
            </td>
            <td colspan="2">Psychosocial issues<br>
              <input type="text" name="xml_cpi" style="width:100%"  size="25" <%=bNew?"":"datafld='xml_cpi'"%>>
            </td>
          </tr>
        </table>
</td></tr>
