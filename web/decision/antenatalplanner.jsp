...
<%
  ...
  if(request.getParameter("submit")!=null && (request.getParameter("submit").equals(" Save ") || request.getParameter("submit").equals("Save and Exit")) ) {
    ...
    risk_content=SxmlMisc.createXmlDataString(request, "aprisk_");
    checklist_content=SxmlMisc.createXmlDataString(request, "apchecklist_");
...
%>
<input type="hidden" name="<%="aprisk_"+riskdataname[i][0]%>" value="checked" >
<%      }
      }
    }
  }
...
<%
    out.println(risks.doStuff(new String("../webapps/"+oscarVariables.getProperty("project_home")+"/decision/desantenatalplannerrisks_99_12.xml")));
%>
    </td><td>
<%
