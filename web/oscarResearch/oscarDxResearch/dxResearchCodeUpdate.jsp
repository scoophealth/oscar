...
<!--
function CodeAttach(File0, File1, File2,File3, File4) {
      ...
      self.opener.document.serviceform.xml_research4.value = File3;
      self.opener.document.serviceform.xml_research5.value = File4;
}
-->
</script> 
 ...
 <%
    ...
    <script LANGUAGE="JavaScript">
    <!--
     CodeAttach('<%=param[0]%>','<%=param[1]%>', '<%=param[2]%>' , '<%=param[3]%>', '<%=param[4]%>'); 
    -->
