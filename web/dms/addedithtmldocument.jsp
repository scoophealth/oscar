...
<%@ page import="java.util.*, oscar.*, oscar.util.*, oscar.dms.*, oscar.dms.data.*" %>
       ...
       <div class="maindiv">
           <div class="maindivheading">
              &nbsp;&nbsp;&nbsp; Edit Document
               ...
               <% } %>
           <html:form action="/dms/addEditHtml" method="POST" enctype="multipart/form-data" styleClass="form" onsubmit="return submitUpload(this);">
               ...
               <table width="100%" height="100%" class="layouttable">
                   <tr>
                      ...
                      <td>
                       <select name="docType" id="docType" onchange="checkSel(this)"<% if (linkhtmlerrors.containsKey("typemissing")) {%> class="warning"<%}%>>
                   ...
                   <tr> 
                      <td>Description: </td>
                      <td><input<% if (linkhtmlerrors.containsKey("descmissing")) {%> class="warning"<%}%> type="text" name="docDesc" size="30" onfocus="checkDefaultValue(this)" value="<%=formdata.getDocDesc()%>"></td>
                   </tr>
                   <tr>
                      <td>Added By: </td>
                   ...
                   <tr>
                      ...
                      <td><input type="text" name="observationDate" id="observationDate" value="<%=formdata.getObservationDate()%>"><a id="obsdate"><img title="Calendar" src="../images/cal.gif" alt="Calendar" border="0" /></a></td>
                   </tr>
                  ...
                  <%}%>
                  <tr>
                      <td valign="top">Html:</td><td>&nbsp;</td>
                  </tr>
                  <tr style="height: 100%;">
                      <td colspan="2"><textarea name="html"<% if (linkhtmlerrors.containsKey("uploaderror")) {%> class="warning"<%}%> wrap="off" style="width: 98%; height: 200px;"><%=formdata.getHtml()%></textarea></td>
                  </tr>
               </table>
                  <center><div><input type="submit" name="Submit" value="Submit"><input type="button" value="Cancel" onclick="window.close();"></div></center>
           </html:form>
           <script type="text/javascript">
