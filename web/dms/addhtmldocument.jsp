...
<head>
<title><bean:message key="dms.addHTMLDocument.title"/></title>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr bgcolor="#486ebd">
    <th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF"><bean:message key="dms.addHTMLDocument.msgAddHtml"/></font></th>
  </tr>
</table>
      ...
      <td rowspan="2" ALIGN="right" valign="middle"> 
        <div align="center"> 
          ...
          <table width="80%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><bean:message key="dms.addHTMLDocument.msgFunction"/></font></td>
            ...
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"></font></td>
              <td width="84%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                <input type="text" name="functionid" value="<%=request.getParameter("functionid")%>" size="20">
                </font></td>
            </tr>
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><bean:message key="dms.addHTMLDocument.formDocumentType"/></font></td>
              <td width="84%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                <select name="doctype">
                  <option value=""><bean:message key="dms.addHTMLDocument.fomSelectType"/></option>
                  <%
            ...
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><bean:message key="dms.addHTMLDocument.formDocDescription"/></font></td>
              <td width="84%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                <input type="text" name="docdesc"  size="20">    <bean:message key="dms.addHTMLDocument.formURL"/>: <input type="text" name="hyperlink" value=""><a href=# onClick="addRedirect()"><bean:message key="dms.addHTMLDocument.btnRedirect"/></a>
                </font></td>
            </tr>
            <tr> 
              <td width="16%" valign="top"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="dms.addHTMLDocument.formHtmlSource"/></font></td>
              <td width="84%"> 
                <textarea name="docxml" cols="80" rows="20"></textarea>
              </td>
            </tr>
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><bean:message key="dms.addHTMLDocument.msgCreateDate"/></font></td>
              <td width="84%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                <input type="text" name="docdate" readonly value="<%=nowDate%>" size="20" >
                </font></td>
            </tr>
            <tr> 
              <td width="16%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="1"><bean:message key="dms.addHTMLDocument.msgCreator"/> </font></td>
              <td width="84%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
