<%-- 
    Document   : addProviderQueue
    Created on : Apr 19, 2010, 3:02:25 PM
    Author     : jackson
-add new queues
-link provider to queues
--%>
...
<html>
    ...
    <body class="mainbody">
        ...
        <table  cellspacing="0" id="queue_provider_table" style="margin: 0px;" align="middle">
            <tr>
                <td>
                    Group Name:
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="searchProviderName" value="Search for provider" onfocus="clearInput(this);" style="color:gray"/>
                    <div id="searchProviderName_choices" style="width:180px"></div>
                ...
                <td>
                    <select id="queueOptions" style="width:120px;height:96px" multiple>
                        <%
                        List<Hashtable> queues=QueueData.getQueues();
                        System.out.println(queues);
                        for(Hashtable qht:queues){
                        %>
                            <option value="<%=(String)qht.get("id")%>">
                                <%=(String)qht.get("queue")%>
                            </option>
                        <%}%>
                ...
                <td>
                     <input type="button" value="OK" onclick="saveProviderQueueLink('queueOptions','linkProviders')"/>
                </td>
            </tr>
            <tr>
                <td> </td>
