...
%>
      <table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
			  ...
			  <a href="oscarReportCalendarPopup.jsp?year=<%=year%>&month=<%=month%>&delta=-1&type=<%=type%>&form=<%=form%>"> &nbsp;&nbsp;<img src="../images/previous.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="View Last Month" vspace="2"> <bean:message key="billing.billingCalendarPopup.btnLast"/>&nbsp;&nbsp; 
              </a>  <b><span CLASS=title><%=year%>-<%=month%></span></b>
        <a href="oscarReportCalendarPopup.jsp?year=<%=year%>&month=<%=month%>&delta=1&type=<%=type%>&form=<%=form%>"> &nbsp;&nbsp;<bean:message key="billing.billingCalendarPopup.btnNext"/> <img src="../images/next.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="View Next Month" vspace="2">&nbsp;&nbsp;</a></td>
  			</TR>
		</table>
<p>
