...
<html:errors/>
<html:form action="oscarReport/InitializeFrequencyOfRelevantTestsCDMReport.do" >
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td width="120" class="fieldBox" bgcolor="#ddddff">
                                    ...
                                    <a href="#" onClick="window.open('../oscarReport/oscarReportCalendarPopup.jsp?type=startDateA&amp;year=<%=curYear%>&amp;month=<%=curMonth%>&amp;form=<%="RptInitializeFrequencyOfRelevantTestsCDMReportForm"%>','','width=300,height=300')"><img src="img/calendar.jpeg" border="0" /></a>                                                
                                </td>
                                <td width="120" class="fieldBox" bgcolor="#ddddff">
                                    <input type="text" name='endDateA' value='<bean:write name="today"/>'  size="10">
                                    <a href="#" onClick="window.open('../oscarReport/oscarReportCalendarPopup.jsp?type=endDateA&amp;year=<%=curYear%>&amp;month=<%=curMonth%>&amp;form=<%="RptInitializeFrequencyOfRelevantTestsCDMReportForm"%>','','width=300,height=300')"><img src="img/calendar.jpeg" border="0" /></a>                                                
                                </td>
                            ...
                            <tr>
                                <td>                              
                                    ...
                                    <tr>
                                        ...
                                        <th align="left" class="subTitles" width="80">
                                            <bean:message key="oscarReport.CDMReport.msgExactly"/>
                                        </th>
                                        <th align="left" class="subTitles" width="80">
                                            <bean:message key="oscarReport.CDMReport.msgMoreThan"/>
                                        </th>
                                        <th align="left" class="subTitles" width="80">
                                            <bean:message key="oscarReport.CDMReport.msgLessThan"/>
                                        </th>
                                        <th align="left" class="subTitles" width="120">
                                            <bean:message key="oscarReport.CDMReport.msgStartDate"/>
                                        </th>
                                    ...
                                    <tr>
                                        <td width="2"   class="fieldBox" bgcolor="#ddddff"><input type="checkbox" name="frequencyCheckbox" value="<%=ctr%>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200" class="fieldBox" bgcolor="#ddddff">
                                            <table>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox" name='<%="value(mInstrcsCheckboxD"+ctr+index+")"%>' checked="checked" value='<bean:write name="mInstrc" property="measuringInstrc" />'/><bean:write name="mInstrc" property="measuringInstrc" /></td>
                                                </tr>
                                                <%k++;%>
                                                </logic:iterate>                                                
                                            </table>
                                        </td>
                                        <input type="hidden" name='<%= "value(mNbInstrcsD" + ctr+ ")" %>' value='<%=k%>'/>
