...
<html:errors/>
<html:form action="oscarReport/oscarMeasurements/InitializeFrequencyOfRelevantTestsCDMReport.do" >
                            ...
                            <tr>
                                <td>                              
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" name='<%="value(measurementTypeD"+ctr+")"%>' value="<bean:write name="measurementType" property="type" />"/>
                                    </tr>
                                    <tr>
