...
<html:errors/>
<html:form action="oscarReport/InitializePatientsMetGuidelineCDMReport.do" >
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td width="120" class="fieldBox" bgcolor="#ddddff">
                                    ...
                                    <a href="#" onClick="window.open('../oscarReport/oscarReportCalendarPopup.jsp?type=startDateA&amp;year=<%=curYear%>&amp;month=<%=curMonth%>&amp;form=<%="RptInitializePatientsMetGuidelineCDMReportForm"%>','','width=300,height=300')"><img src="img/calendar.jpeg" border="0" /></a>                                                
                                </td>
                                <td width="120" class="fieldBox" bgcolor="#ddddff">
                                    <input type="text" name='endDateA' value='<bean:write name="today"/>'  size="10">
                                    <a href="#" onClick="window.open('../oscarReport/oscarReportCalendarPopup.jsp?type=endDateA&amp;year=<%=curYear%>&amp;month=<%=curMonth%>&amp;form=<%="RptInitializePatientsMetGuidelineCDMReportForm"%>','','width=300,height=300')"><img src="img/calendar.jpeg" border="0" /></a>                                                
                                </td>
