...
<%-- This JSP is the page that allows users to edit the global templates XML file --%>
<!--  
/*
 * 
...
<%@ page import="oscar.oscarReport.reportByTemplate.*, java.sql.*" %>
...
<table class="MainTable" id="scrollNumber1" name="encounterTable">
        ...
        <tr>
          ...
          <%String xml = (new ReportManager()).getTemplateXml("globalxml");
            String message = (String) request.getAttribute("message");
            if (message == null) message = "";
          %>
            <td class="MainTableRightColumn" valign="top">
               <div class="reportTitle">Edit Templates</div>
              <%if (message.toLowerCase().indexOf("success") != -1) {%>
               <div class="green"><%=message%></div>
              <%} else {%>
               <div class="warning"><%=message%></div>
              <%}%>
               <html:form action="/oscarReport/reportByTemplate/editTemplatesAction">
                  <textarea name="xmltext" style="width:100%; height:450px;"><%=xml%></textarea><br/>
