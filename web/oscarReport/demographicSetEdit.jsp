    ...
    <table  class="MainTable" id="scrollNumber1" name="encounterTable" >
        ...
        <tr>
            ...
            <td valign="top" class="MainTableRightColumn">
               <html:form action="/report/DemographicSetEdit" >
               <div>
                  Patient Set:
                  ...
                  <input type="submit" value="Display Set" />
               </div>               
               ...
               <div>
                   <html:form action="/report/SetEligibility">
                   ...
                   <%for (int i=0; i < list.size(); i++){ 
                    ...
                    <tr>               
                        <td><input type="checkbox" name="demoNo" value="<%=h.get("demographic_no")%>"/>
