...
%>
<security:oscarSec roleName="<%=roleName$%>" objectName="_admin.reporting" rights="r" reverse="<%=true%>" >
...
%>
        ...
        <td width="20%">
          <input type="text" name="date_from" id="date_from" value="" size="10" readonly />
		  <img src="../images/cal.gif" id="date_from"/>
        </td>
        <td width="20%">
         To:
          </td>
        <td width="20%">
          <input type="text" name="date_to" id="date_to" value="" size="10" readonly />
		  <img src="../images/cal.gif" id="date_to"/>
        </td>
        </tr>
        <tr><td>
