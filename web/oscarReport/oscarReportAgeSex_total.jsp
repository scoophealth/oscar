...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  param1[0] = "M%";
  param1[1] = providerview;
  param1[2] = AgeMatrix[i][0];
  param1[3] = AgeMatrix[i][1];
  param1[4] = dateBegin;
param1[5] = dateEnd ;
  rs = null;
  ...
  param2[0] = "F%";
  param2[1] = providerview;
  param2[2] = AgeMatrix[i][0];
  param2[3] = AgeMatrix[i][1];
  param2[4] = dateBegin;
param2[5] = dateEnd ;
  rs2 = null;
  rs2 = apptMainBean.queryResults(param2, "count_reportagesex");
  while(rs2.next()){
