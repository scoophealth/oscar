...
param[6] = dateEnd ;
rs = null;
rs = apptMainBean.queryResults(param, "count_reportagesex_noroster");
while(rs.next()){
...
param1[6] = dateEnd ;
  rs = null;
  rs = apptMainBean.queryResults(param1, "count_reportagesex_noroster");
  while(rs.next()){
...
param2[6] = dateEnd ;
  rs2 = null;
  rs2 = apptMainBean.queryResults(param2, "count_reportagesex_noroster");
  while(rs2.next()){
