 <%   
  ...
  String [][] dbQueries=new String[][] {
	...
	{"save_reportagesex", "insert into reportagesex values(?,?,?,?,?,?,?,?)"},
        ...
        {"count_reportagesex", "select count(*) as n from reportagesex where (status<>'OP' and status<>'IN' and status<>'DE') and sex like ? and provider_no=? and age >= ? and age <=? and date_joined >=? and date_joined <=?"},
