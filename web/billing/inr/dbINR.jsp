...
-->
 ...
 <%   
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"save_bill", "insert into billing (clinic_no, demographic_no, provider_no, appointment_no, organization_spec_code, demographic_name, hin, update_date, update_time, billing_date, billing_time, clinic_ref_code, content, total, status, dob, visitdate, visittype, provider_ohip_no, provider_rma_no, apptprovider_no)  values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"},
    ...
    {"save_bill_record", "insert into billingdetail (illing_no, service_code, service_desc, billing_amount, diagnostic_code, appointment_date, status, billingunit) values(?,?,?,?,?,?,?,?)"},
    ...
    {"search_encounter", "select * from encounter where demographic_no = ? order by encounter_date desc, encounter_time desc"},
      ...
      {"save_inrbilling", "insert into billinginr (demographic_no, demographic_name, hin, dob, provider_no, provider_ohip_no, provider_rma_no, creator, diagnostic_code, service_code, service_desc, billing_amount, billing_unit, createdatetime, status) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"},
      {"search_inrbilling_dt", "select *  from billinginr where provider_no like ? and status<>'D'"},
      {"search_inrbilling_dt_billno", "select *  from billinginr where billinginr_no=? and status<>'D'"},
