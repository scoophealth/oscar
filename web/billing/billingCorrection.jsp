...
<tr bgcolor="#000000"> 
	...
	<font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF" size="4"><bean:message key="billing.billingCorrection.msgCorrection"/></font>
	</th>
</tr>
</table>
...
<tr> 
	...
	<font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formInvoiceNo"/>
	</font>
	</th><th width="20%">
	<input type="text" name="billing_no" value="<%=billNo%>" maxsize="10"> 
	</th>
	<th width="50%" align="left">
	<font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.msgLastUpdate"/>: <%=UpdateDate%></font>
	</th><th>
...
<tr bgcolor="#CCCCFF"> 
	<th align="left" colspan="2"><font size="2" face="Arial, Helvetica, sans-serif" size="3"><bean:message key="billing.billingCorrection.msgPatientInformation"/></font></th>
</tr><tr> 
	<td width="54%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.msgPatientName"/>: <%=DemoName%> 
	<input type="hidden" name="demo_name" value="<%=DemoName%>">
	</font></b>
	</td><td width="46%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formHealth"/>: 
...
<tr bgcolor="#CCCCFF"> 
	<td width="320">
	<font face="Arial, Helvetica, sans-serif"><strong><bean:message key="billing.billingCorrection.msgAditInfo"/></strong></font>
	</td><td width="270">
	<font face="Arial, Helvetica, sans-serif"><strong><bean:message key="billing.billingCorrection.formSpecialty"/> 
	</strong></font>
	<select name="specialty"  style="font-size:80%;">
		...
		<bean:message key="billing.billingCorrection.formFlu"/></option>
	</td>
</tr><tr> 
	<td width="320">
	<strong><font size="2" face="Arial, Helvetica, sans-serif"><bean:message key="billing.billingCorrection.formHCType"/>:</font></strong>
	...
	<strong><font size="2" face="Arial, Helvetica, sans-serif"><bean:message key="billing.billingCorrection.formManualReview"/>: 
...
<tr bgcolor="#CCCCFF"> 
	...
	<td width="54%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formBillingType"/>: </font></b>
	...
	<b><font face="Arial, Helvetica, sans-serif" size="2"><a href="#" onClick='rs("billingcalendar","billingCalendarPopup.jsp?year=<%=curYear%>&month=<%=curMonth%>&type=service","380","300","0")'>
	<bean:message key="billing.billingCorrection.btnBillingDate"/>: </a><input type="text" style="font-size:80%;"  name="xml_appointment_date" value="<%=BillDate%>">
	</font></b></td>
</tr><tr bgcolor="#EEEEFF"> 
	<td width="54%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formVisit"/>:</font></b>  
...
<% } %>
	...
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formBillingPhysician"/>: </font></b> 
...
%>
	...
	<td width="54%"><b><font face="Arial, Helvetica, sans-serif" size="2">
	<bean:message key="billing.billingCorrection.formVisitType"/>: </font></b>
	...
	<a href="#" onClick='rs("billingcalendar","billingCalendarPopup.jsp?year=<%=curYear%>&month=<%=curMonth%>&type=admission","380","300","0")'> <bean:message key="billing.billingCorrection.btnAdmissionDate"/>:</a> 
...
<tr bgcolor="#CCCCFF"> 
	<td width="25%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formServiceCode"/></font></b>
	</td><td width="50%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formDescription"/></font></b>
	</td><td width="12%">
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formUnit"/></font></b>
	</td><td width="13%" align="right"> 
	<b><font face="Arial, Helvetica, sans-serif" size="2"><bean:message key="billing.billingCorrection.formFee"/></font></b>
	</td>
</tr>
<%
String serviceCode = "";
...
<tr> 
	...
	<input type="text" style="font-size:80%;" name="servicecode<%=rowCount-1%>" value="<%=serviceCode%>"></font>
	</th><th>
	<font face="Arial, Helvetica, sans-serif" size="1"><%=serviceDesc%></font>
	</th><th>
	<font face="Arial, Helvetica, sans-serif" size="2">
	<input type="hidden" name="xml_billing_unit<%=rowCount%>" value="<%=billingunit%>">
	<input type="text" style="font-size:80%;" name="billingunit<%=rowCount-1%>" value="<%=billingunit%>" size="5" maxlength="5"></font>
	</th><th align="right"> 
	...
	<input type="text" style="font-size:80%;" size="5" maxlength="5" name="billingamount<%=rowCount-1%>" value="<%=billAmount.substring(0,billAmount.length()-2) + "." + billAmount.substring(billAmount.length()-2)%>">
	</th>
</tr>
<%
	}
...
<tr> 
	<td>
	<input type="text" style="font-size:80%;" name="servicecode<%=i%>" value=""></td>
	<td>&nbsp;</td>
	<td><input type="text" style="font-size:80%;" name="billingunit<%=i%>" value="" size="5" maxlength="5"></td>
	<td align="right"> 
	<input type="text" style="font-size:80%;" name="billingamount<%=i%>" value="" size="5" maxlength="5">
	</td>
</tr>
...
<tr bgcolor="#CCCCFF"> 
	<td colspan="4"><font face="Arial, Helvetica, sans-serif" size="2"><b>
	<bean:message key="billing.billingCorrection.formDiagnosticCode"/></b></font></td>
</tr><tr> 
	<td colspan="4"><font face="Arial, Helvetica, sans-serif" size="2">
	<input type="hidden" name="xml_diagnostic_code" value="<%=diagCode%>">
	<input type="text" style="font-size:80%;" name="xml_diagnostic_detail" value="<%=diagCode%>"size="50">
	<input type="hidden" name="xml_dig_search1" >
	<a href="javascript:ScriptAttach()"><bean:message key="billing.billingCorrection.btnDXSearch"/></a></font>
	</td>
</tr><tr> 
	<td colspan="4">
