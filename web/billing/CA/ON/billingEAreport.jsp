...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr > 
    ...
    <td width="90%" align="left" class="Header"> 
      oscar<font size="3">Billing</font>
    </td>
  </tr>
</table>
...
<table width="100%">
    <tr>    
        <td>
            ...
            <logic:iterate id="claimsError" name="claimsErrors" property="claimsErrorReportBeanVector">
                <logic:present name="claimsError" property="techSpec">
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" bgcolor="#CCCCFF">
                    <tr> 
                        <td width="15%"><b>MOH Office: <bean:write name="claimsError" property="MOHoffice" /></b></td>
                        <td width="15%"><b>Provider #:       <bean:write name="claimsError" property="providerNumber" />  </b></td>
                        <td width="11%"><b>Group #:  <bean:write name="claimsError" property="groupNumber" />  </b></td>
                        <td width="11%"><b>Opr.#: <bean:write name="claimsError" property="operatorNumber" /></b></td>
                        <td width="11%"><b>Sp. Code: <bean:write name="claimsError" property="specialtyCode" /></b></td>
                        <td width="11%"><b>Spec.#: <bean:write name="claimsError" property="techSpec" />    </b></td>
                        <td width="11%"><b>Station #:    <bean:write name="claimsError" property="stationNumber" />     </b></td>
                        <td width="15%"><b>Clm Date: <bean:write name="claimsError" property="claimProcessDate" /></b></td>
                ...
                <tr bgcolor="#F9F1FE"> 
                    ...
                    <td width="7%"><bean:write name="claimsError" property="account" /> </td>
                    <td width="3%"><bean:write name="claimsError" property="payee" />     </td>
                    ...
                    <td width="7%"><bean:write name="claimsError" property="servicedate" /></td>
                    <td width="4%"><bean:write name="claimsError" property="dxcode" />  </td>
                    <td width="2%"></td>
                ...
                <tr> 
                    ...
                    <td width="60%"><bean:write name="claimsError" property="error" /></td>
                </tr>
                </logic:present>
                ...
                <tr> 
                    ...
                    <td width="20% "><b>Header 1:   <bean:write name="claimsError" property="header1Count" />     </b></td>
                    <td width="20%"><b>Header 2:   <bean:write name="claimsError" property="header2Count" /></b></td>
                    <td width="20%"><b>Item: <bean:write name="claimsError" property="itemCount" />  </b></td>
                    <td width="20%"><b>Message: <bean:write name="claimsError" property="messageCount" /> ]</b></td>
                </tr>
                </table>
                </logic:present>
            </logic:iterate>
            ...
            <logic:iterate id="batchAck" name="batchAcks" property="batchAckReportBeanVector">
            <tr>
                <td class="dataTable" width="5%"><bean:write name="batchAck" property="batchNumber" /></td>
                <td class="dataTable" width="5%"><bean:write name="batchAck" property="operatorNumber" /></td>                            
                <td class="dataTable" width="7%"><bean:write name="batchAck" property="providerNumber" /></td>
                <td class="dataTable" width="4%"><bean:write name="batchAck" property="groupNumber" /></td>
                <td class="dataTable" width="7%"><bean:write name="batchAck" property="batchCreateDate" /></td>                                        
                <td class="dataTable" width="5%"><bean:write name="batchAck" property="batchSequenceNumber" /></td>
                <td class="dataTable" width="7%"><bean:write name="batchAck" property="microStart" /></td>                                        
                <td class="dataTable" width="4%"><bean:write name="batchAck" property="microEnd" /></td>
                <td class="dataTable" width="7%"><bean:write name="batchAck" property="microType" /></td>
                <td class="dataTable" width="5%"><bean:write name="batchAck" property="claimNumber" /></td>
                <td class="dataTable" width="5%"><bean:write name="batchAck" property="recordNumber" /></td>
                <td class="dataTable" width="12%"><bean:write name="batchAck" property="batchProcessDate" /></td>
                <td class="dataTable" width="15%"><bean:write name="batchAck" property="explain" /></td>
            </tr>                        
            </logic:iterate>
            </logic:present>
            ...
            <logic:iterate id="outputSpec" name="outputSpecs" property="EDTOBECOutputSecifiationBeanVector">
            <tr>       
                <td class="dataTable" width="8%"><bean:write name="outputSpec" property="healthNo" /></td>
                <td class="dataTable" width="3%"><bean:write name="outputSpec" property="version" /></td>                            
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="responseCode" /></td>
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="identifier" /></td>
                <td class="dataTable" width="3%"><bean:write name="outputSpec" property="sex" /></td>                                        
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="DOB" /></td>
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="expiry" /></td>                                        
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="lastName" /></td>
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="firstName" /></td>
                <td class="dataTable" width="10%"><bean:write name="outputSpec" property="secondName" /></td>
                <td class="dataTable" width="16%"><bean:write name="outputSpec" property="MOH" /></td>
            </tr>                        
            </logic:iterate>
            </logic:present>
            <tr>
