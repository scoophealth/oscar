...
<tr BGCOLOR="#FFD7C4">
	<td  width="5%" nowrap>
	<a href="billingCalendarPopup.jsp?year=<%=year-1%>&month=<%=month%>&delta=0&type=<%=type%>">
	<img src="images/previous.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="Last Year" vspace="2">
	<img src="images/previous.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="Last Year" vspace="2"></a>
	</td>
	<td  align="center" >
	<a href="billingCalendarPopup.jsp?year=<%=year%>&month=<%=month%>&delta=-1&type=<%=type%>">
	<img src="images/previous.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="View Last Month" vspace="2"> 
	<bean:message key="billing.billingCalendarPopup.btnLast"/></a>
	...
	<img src="images/next.gif" WIDTH="10" HEIGHT="9" BORDER="0" ALT="Next Year" vspace="2"></a>
	</td>
</tr>
</table>
...
for(int i=0; i<12; i++) {
%>
	<a href="billingCalendarPopup.jsp?year=<%=year%>&month=<%=i+1%>&delta=0&type=<%=type%>">
...
<tr> 
	<td bgcolor="#FFD7C4" align="center"> 
