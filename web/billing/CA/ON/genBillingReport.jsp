...
<table border="0" cellspacing="0" cellpadding="0" width="100%" >
  <tr bgcolor="#486ebd">
    <th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF">Billing Report by Appointment</font></th>
  </tr>
</table>
<% String apptProvider="";
...
<form><input type="button" value="Print Report" onClick="window.print()"></form>
...
<tr bgcolor="<%=bodd?"ivory":"white"%>">
      ...
      <% } %>
      <td align="center" width="20%" height="25"><a href=# onClick="popupPage(600,800, '../billing/billingOB2.jsp?billing_no=<%=rs.getString("billing_no")%>&dboperation=search_bill&hotclick=0')">View</a><!--|<a href=# onclick="onUnbilled('../billing/billingDelete.jsp?appointment_no=<%=rs.getString("appointment_no")%>&billing_no=<%=rs.getString("billing_no")%>&billCode=<%=billCode%>&dboperation=delete_bill&hotclick=0')">-$</a>--></td>
...
<form>
<input type="button" value="Close this window" onClick="window.close()"><input type="button" value="Print Report" onClick="window.print()">
</form>
