...
%>
	...
	<td width="254"><b><font face="Arial, Helvetica, sans-serif" size="2">
	Bill Center: </font></b>
	<input type="hidden" name="billcenter" value="<%=billCenter%>">
	<font face="Arial, Helvetica, sans-serif" size="2"><%=healthOffice%> </font>
	</td>
...
<tr> 
	...
	<a href="#" onClick="openBrWindow('../../../share/CalendarPopup.jsp?urlfrom=../billing/CA/ON/billingOHIPsimulation.jsp&year=<%=curYear%>&month=<%=curMonth%>&param=<%=URLEncoder.encode("&formdatebox=document.forms[0].xml_vdate.value")%>','','top=0,left=0,width=430,height=310')">
	From:</a></font> 
	<input type="text" name="xml_vdate" maxlength="10" value="<%=xml_vdate%>" readonly>
	</td>
	<td><font size="1" face="Arial, Helvetica, sans-serif">
	<a href="#" onClick="openBrWindow('../../../share/CalendarPopup.jsp?urlfrom=../billing/CA/ON/billingOHIPsimulation.jsp&year=<%=curYear%>&month=<%=curMonth%>&param=<%=URLEncoder.encode("&formdatebox=document.forms[0].xml_appointment_date.value")%>','','top=0,left=0,width=430,height=310')">
	To:</a></font> 
