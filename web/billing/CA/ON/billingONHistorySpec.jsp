...
<table width="95%" border="0">
  <tr><td align="left"><%=request.getParameter("demo_name")%> 
  (<%=request.getParameter("demographic_no")%>) <%=strToday + " - " + strStartDay %>
  </td>
  <td align="right">Service Code
  <input type="text" name="serviceCode" value="<%=serviceCode %>" size="4"  onBlur="upCaseCtrl(this)"/>
  <input type="hidden" name="day" value="<%=strDay %>"  />
  <input type="hidden" name="demo_name" value="<%=request.getParameter("demo_name") %>"  />
...
%>
<tr class="myYellow"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
<td align="center"><%=nItems %></td><td>&nbsp;</td><td>&nbsp;</td></tr>
</table>
<br>
<p>
  <hr width="100%">
