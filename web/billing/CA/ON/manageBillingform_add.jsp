...
<tr>
	...
	<tr> 
		<td width="50%" class="white"><bean:message key="billing.manageBillingform_add.formServiceID"/> :</td>
	...
	<tr> 
		<td class="white"><bean:message key="billing.manageBillingform_add.formDefaultBillType"/> :</td>
		<td class="white">
	...
	<table width="100%" border="0">
	<tr> 
		<th colspan="2" valign="top" bgcolor="white"><bean:message key="billing.manageBillingform_add.msgExistType"/></th>
	</tr>
...
%>
	...
	<tr> 
		...
		<a href=# onClick='manageType("<%=rs.getString("servicetype")%>","<%=rs.getString("servicetype_name")%>");return false;' title="Manage Billing Form"><%=rs.getString("servicetype")%></a>
<!--		<a href=# onClick='onUnbilled("dbManageBillingform_delete.jsp?servicetype=<%=rs.getString("servicetype")%>");return false;' title="Delete Billing Form"><%=rs.getString("servicetype")%></a> -->
		</td>
		<td class="black">
		<a href=# onClick='manageType("<%=rs.getString("servicetype")%>","<%=rs.getString("servicetype_name")%>");return false;' title="Manage Billing Form"><%=rs.getString("servicetype_name")%></a>
