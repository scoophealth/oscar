...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr bgcolor="#486ebd">
    <th align=CENTER NOWRAP><font face="Helvetica" color="#FFFFFF">ADD INR BILLING</font></th>
  </tr>
</table>
      ...
      <td rowspan="2" ALIGN="right" valign="middle"> 
        <div align="center"> 
          ...
          <table width="90%" border="1" cellspacing="0" cellpadding="0">
            ...
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Demographic id</font></td>
            ...
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Demographic Name 
                </font></td>
              <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
              ...
              <tr> 
	                  <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Demographic DOB
	                    </font></td>
	                  <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
              ...
              <tr> 
	                  <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Health Number 
	                    </font></td>
	                  <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
            ...
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Billing Provider</font></td>
              <td width="50%">
                <select name="provider">
                  <option value=""<%=request.getParameter("creator").equals("")?"selected":""%>>Select Provider</option>
...
%>
<option value="<%=proOHIP%>|<%=specialty_code%>" <%=request.getParameter("creator").equals(specialty_code)?"selected":""%>><%=proLast%>, <%=proFirst%></option>
<% 
}
...
%>
            ...
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Service 
                Code </font></td>
              <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                <input type="text" name="xml_other1"  size="20" value="G271A">
                              <a href="javascript:OtherScriptAttach()"><img src="../../../../images/search_code.jpg" border="0"></a> 
                        </font></td>
            </tr>
            <tr> 
              <td width="29%"><font size="1">Diagnostic Code</font></td>
              <td width="50%"> 
                <input type="text" name="xml_diagnostic_detail" size="20" value="451"><input type="hidden" name="xml_dig_search1" >
                 <a href="javascript:ScriptAttach()"><img src="../../../../images/search_dx_code.jpg" border="0"></a> 
                           </td>
            </tr>
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Create 
                Date</font></td>
              <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
            ...
            <tr> 
              <td width="29%"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="1">Creator 
                </font></td>
              <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
