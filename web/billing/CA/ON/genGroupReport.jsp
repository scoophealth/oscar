...
if (provider.compareTo("all") == 0 ){  
	...
	while(rslocal.next()){
		...
		param[1]=batchCount;
		param[2] = htmlFilename; //"H" + request.getParameter("monthCode") + proOHIP + "_" + zero +  batchCount + ".htm";
		param[3] = ohipFilename; //"H" + request.getParameter("monthCode") + billinggroup_no + "." + zero + batchCount;
		param[4]=proOHIP;
