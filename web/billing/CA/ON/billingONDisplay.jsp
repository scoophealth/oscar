...
<table width="100%" border="0" class="myYellow">
	...
	<tr>
		<th width="30%" align="left"><bean:message key="billing.billingCorrection.formInvoiceNo" /> </th>
		...
		<th><input type="button" name="submit" value="Exit" onClick="window.close();" /></th>
	</tr>
	</form>
</table>
...
%>
	...
	<tr>
		<td colspan="4"><input type="button" name="submit" value="Exit" onClick="window.close();" /></td>
	</tr>
	<tr>
