...
<%   
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"search_allbill_history", "select distinct provider.last_name, provider.first_name, billing.apptProvider_no,  billing.billing_no, billing.billing_date, billing.billing_time, billing.status, billing.appointment_no, billing.billingtype from billing, provider where provider.provider_no = billing.provider_no and billing.status <> 'D' and billing.demographic_no =? order by billing.billing_date desc, billing.billing_time desc " + limit},
    ...
    {"update_wcb_billing", "UPDATE billing SET status='O' WHERE billing_no=?" },
