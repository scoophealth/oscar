...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#D3D3D3">
  <tr> 
    ...
    <td width="90%" align="left"> 
      <p><font face="Verdana" color="#4D4D4D"><b><font size="4">oscar<font size="3">Diagnostic Codes (ICD9)</font></font></b></font> 
      </p>
    </td>
  </tr>
</table>
...
<%
	...
	java.sql.ResultSet rs = db.GetSQL("SELECT diagnostic_code, description FROM diagnosticcode ORDER BY diagnostic_code");
	while (rs.next()){
%>
	<tr <%=((color) ? "bgcolor=\"#F6F6F6\"" : "")%> align="left" valign="top">
		<td class="SmallerText">
			<a href=# onClick="posttoText('<%=rs.getString("diagnostic_code")%>');"><%=rs.getString("diagnostic_code")%></a>
		</td>
		<td class="SmallerText">
