...
<table width="100%" border="2"  valign="top">
 ...
 param[1] = dateBegin;
  ...
  <tr bgcolor="#CCCCFF"> 
    ...
    <TH align="center" width="10%"><b><font size="2" face="Arial, Helvetica, sans-serif">ACCOUNT</font></b></TH>
  </tr>
  <%
    while (rs.next()) {
...
%>
  <tr bgcolor="<%=bodd?"#EEEEFF":"white"%>"> 
    ...
    <TD align="center" width="10%"><b> <font size="2" face="Arial, Helvetica, sans-serif"><a href="javascript: function myFunction() {return false; }" onClick='popupPage(700,720, "../../../billing/CA/BC/billingView.do?billing_no=<%=apptMainBean.getString(rs,"billing_no")%>&dboperation=search_bill&hotclick=0")' title="<%=reason%>">
