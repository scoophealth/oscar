...
<table class="MainTable" id="scrollNumber1" name="encounterTable">
	<tr class="MainTableTopRow">
		...
		<table class="TopStatusBar">
			<tr>
				<td>Add Private Billing Code</td>
				<td>&nbsp;</td>
	...
	<tr>
		...
		<td class="MainTableRightColumn" valign="top"><html:form
			...
			<table width="50%">
				...
				<tr>
					<td colspan="2"><strong>Private Codes will be
					prefixed with 'A' by default</strong><</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><html:submit value="Add" /><html:button
						onclick="javascript: document.location = 'billingPrivateCodeAdjust.jsp'"
