...
<% System.out.println("go 2" ); %>
	<tr>
		<td align="right" width="50%"><select name="company_name" id="company_name">
...
<form method="post" name="baseurl" action="onAddEdit3rdAddr.jsp" >
	<tr class="myGreen">
		...
		<td><input type="text" name="company_name" value="<%=prop.getProperty("company_name", "")%>" size='40' maxlength='50' /> 
		<input type="submit" name="submit" value="Search" onclick="javascript:return onSearch();"></td>
	</tr>
	<tr class="myIvory">
		<td align="right"><b>Attention</b></td>
		<td><input type="text" name="attention" value="<%=prop.getProperty("attention", "")%>" size='40' maxlength='50' /> 
		</td>
	</tr>
	<tr class="myGreen">
		<td align="right"><b>Address</b></td>
		<td><input type="text" name="address" value="<%=prop.getProperty("address", "")%>" size='40' maxlength='50' /> 
		</td>
	</tr>
	<tr class="myIvory">
		<td align="right"><b>City</b></td>
		<td><input type="text" name="city" value="<%=prop.getProperty("city", "")%>" size='40' maxlength='50' /> 
		</td>
	</tr>
	<tr class="myGreen">
		<td align="right"><b>Province</b></td>
		<td><input type="text" name="province" value="<%=prop.getProperty("province", "")%>" size='20' maxlength='20' /> 
		</td>
	</tr>
	<tr class="myIvory">
		<td align="right"><b>postcode</b></td>
		<td><input type="text" name="postcode" value="<%=prop.getProperty("postcode", "")%>" size='10' maxlength='10' /> 
		</td>
	</tr>
	<tr class="myGreen">
		<td align="right"><b>Tel.</b></td>
		<td><input type="text" name="telephone" value="<%=prop.getProperty("telephone", "")%>" size='40' maxlength='50' /> 
		</td>
	</tr>
	<tr class="myIvory">
		<td align="right"><b>Fax</b></td>
		<td><input type="text" name="fax" value="<%=prop.getProperty("fax", "")%>" size='40' maxlength='50' /> 
		</td>
	</tr>
	<tr>
		<td align="center" class="myGreen" colspan="2"><input type="hidden" name="action" value='<%=action%>'> <input
			...
			value="<bean:message key="admin.resourcebaseurl.btnExit"/>" onClick="window.close()">
			<input type="hidden" name="id" value="<%=prop.getProperty("id", "")%>" />
		</td>
	</tr>
</form>
</table>
