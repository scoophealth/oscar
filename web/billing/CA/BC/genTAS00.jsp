	 ...
	 <td width="5%" height="16">AJA7</td>
      ...
      %>
        <tr> 
               ...
               <td width="5%" height="16"><%=rsdemo.getString("t_officeno")%>&nbsp; </td>
               <td width="5%" height="16"><%=rsdemo.getString("t_practitionerno")%>&nbsp; </td>
               <td width="5%" height="16"><%=rsdemo.getString("t_billfeeschedule")%>&nbsp; </td>
	       <td width="5%" height="16" alight="right"><%=rsdemo.getString("t_billamt")%>&nbsp; </td>
	       <td width="5%" height="16" align=right><%=rsdemo.getString("t_paidamt")%></td>
