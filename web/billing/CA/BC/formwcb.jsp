...
<input type="hidden" name="appointment_no" value="0"/>
<input type="hidden" name="providerview" value="Get The Param"/>
<input type="hidden" name="user_no" value="Get The Param"/>
        ...
        <td width="90%" align="left">
          <p>
            <font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">
              <b>
                <font face="Arial, Helvetica, sans-serif" size="4">                  oscar Billing - Workers Compensation Board - Physician Report<font size="3"></font>                </font>              </b>            </font>          </p>
        </td>
      </tr>
    </table>

<br>
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="SmallerText">
	<tr>
	   <td>
	      Form Needed <html:checkbox value="1" property="formNeeded" onclick="isformNeeded();"/>
	   </td>
		<td colspan="1" valign="top" height="25" class="SmallerText" id="reportTypeSection">
			Physician's First Report <html:radio value="F" property="w_reporttype" /> or The worker's
				condition or treatment has changed: <html:radio value="C" property="w_reporttype" />
	      </span>
		</td>
	</tr>
	...
	<tr class="SectionHead">
		<td colspan="2">
		   <%if(!haveClaims){%>
			...
			<%}%>
         <b>WCB Claim Number:</B> <html:text maxlength="25" property="w_wcbno" />
         <%if(!haveClaims){%>
         </a>
         <%}%>
		</td>
	...
	<tr id="employerSection">
		<td width="100%" align="left" valign="top" colspan=2>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
               ...
               <td><html:text maxlength="3" property="w_emparea" size="3" />-<html:text maxlength="7" property="w_empphone" size="10" /></td>
					</td>
				</tr>
	  ...
	  <tr>
		<td width="100%" align="left" valign="top" colspan=2>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<tr>
					<td colspan="1" class="SmallerText"><b>Last Name:</b> <html:text maxlength="18" property="w_lname" size="20" />
					</td>
					<td class="SmallerText"><b>First Name:</b> <html:text maxlength="12" property="w_fname" size="20" />
					</td>
					<td class="SmallerText" colspan="2">Initial: <html:text maxlength="1" property="w_mname" size="1" />
					</td>

				</tr>
				<tr >

					<td class="SmallerText"><b>Date of Birth:</b> <html:text readonly="readonly" maxlength="10" property="w_dob" size="10" />
					</td>
					<td class="SmallerText"><b>Gender:</b> <html:text readonly="readonly" maxlength="1" property="w_gender" size="1" />
					</td>
					<td  class="SmallerText"><b>PHN:</b> <html:text maxlength="12" property="w_phn" size="12" />
					</td>
					<td >&nbsp;
					</td>
				</tr>
				<tr id="workersAddressSection">
					<td  class="SmallerText">
					Worker's Telephone No: <html:text maxlength="3" property="w_area" size="3" />
            		<html:text maxlength="7" property="w_phone" size="7" />
					</td>
					<td class="SmallerText">
					Address: <html:text maxlength="25" property="w_address" size="20" />
					</td>
					<td class="SmallerText">
					City: <html:text maxlength="20" property="w_city" size="20" />
					</td>
					<td class="SmallerText">
					Postal Code: <html:text maxlength="6" property="w_postal" size="6" />
					</td>
	...
	<tr id="secondSection1">
		<td>Are you the worker's regular physician? </td><td>
              <html:radio value="Y" property="w_rphysician" onclick="ShowElementById('secondSection2')"/>
              Yes <html:radio value="N" property="w_rphysician" onclick="HideElementById('secondSection2')"/> No
		</td>
	</tr>
	<tr id="secondSection2">
		<td>If yes, how long has the worker been your patient?</td><td><html:radio value="1" property="w_duration"/>
              0-6 months <html:radio value="2" property="w_duration"/>
              7-12 months <html:radio value="9" property="w_duration"/>&gt; 12 months
		</td>
	</tr>
	<tr id="secondSection3">
		<td>Who rendered the first treatment?</td><td><html:text maxlength="25" property="w_ftreatment" size="25" />
		</td>
	</tr>
	<tr id="secondSection4">
		<td>
		Prior/Other Problems Affecting Injury, Recovery and Disability</td><td>
              <html:textarea cols="50" onkeyup="checkTextLimit(this.form.w_problem,160);" property="w_problem" style="height:50px;width:100%;" ></html:textarea>
		</td>
	</tr>
	...
	<tr>
      ...
      <td> <b>Date of Service</b>
            <html:text property="w_servicedate" styleId="w_servicedate" size="10" readonly="true"/>
	...
	<tr>
		...
		<td>
			<html:text maxlength="5" property="w_feeitem" size="5" />
	...
	<tr>
		...
		<td>
			<html:text maxlength="5" property="w_extrafeeitem" size="5" />
                	<a onClick="popFeeItemList('WCBForm','w_extrafeeitem');">Search</a>
		</td>
	</tr>
	<tr>
		<td><b>ICD9:</b></td>
      <td><html:text maxlength="5" property="w_icd9" size="5" />
	...
	<tr>
		<td>
			<b>Body Part:</b></td>
          <td><html:text maxlength="5" property="w_bp" size="5" />
	...
	<tr id="thirdSection8">
		<td>
			From injury or since last report, has the worker been disabled from work? </td><td>
              <html:radio value="Y" property="w_work" onclick="ShowElementById('thirdSection9')"/>Yes
              <html:radio value="N" property="w_work" onclick="HideElementById('thirdSection9')"/>No</p>
		</td>
	</tr>
	<tr id="thirdSection9">
		<td>
		If Yes, as of what date? (if known) </td><td align="left" valign="top">
              <html:text readonly="true" styleId="w_workdate" property="w_workdate" onclick="window.WCBForm.w_workdate.value = '';" />
	...
	<tr id="thirdSection10">
		...
		<html:textarea styleClass="mhAssTextarea" onkeyup="checkTextLimit(this.form.w_clinicinfo,800);" property="w_clinicinfo" style="height:80px;width:100%;" ></html:textarea>
		</td>
	</tr>
	...
	<tr id="forthSection1">
		...
		<td>
		<html:radio value="Y" property="w_capability" onclick="HideElementById('forthSection2')"/> Yes
                  <html:radio value="N" property="w_capability" onclick="ShowElementById('forthSection2')"/> No
		</td>
	</tr>
	<tr id="forthSection2">
		<td valign="top">
		...
		<td>
		   <html:textarea styleClass="mhAssTextarea" onkeyup="checkTextLimit(this.form.w_capreason,240);" property="w_capreason" style="height:80px;width:100%;" ></html:textarea>
		</td>
	</tr>
	<tr id="forthSection3">
		<td valign="top">
		Estimated time before the worker will be able to return to the workplace. </td>
                <td>
					<html:radio value="0" property="w_estimate"/>At Work<br>
					<html:radio value="1" property="w_estimate"/>1-6 days
					<html:radio value="2" property="w_estimate"/>7-13 days<br>
					<html:radio value="3" property="w_estimate"/>14-20 days
					<html:radio value="9" property="w_estimate"/>20 days
				</td>
	</tr>
	<tr id="forthSection4">
		<td>
		If appropriate, is the worker now ready for a rehabilitation program?</td>
                <td><html:radio value="Y" property="w_rehab" onclick="ShowElementById('forthSection5')"/> Yes
                  <html:radio value="N" property="w_rehab" onclick="HideElementById('forthSection5')"/> No
		</td>
	</tr>
	<tr id="forthSection5">
		<td>
		If Yes, Select &quot;WCP&quot; or Other</td><td><html:radio value="C" property="w_rehabtype"/>WCP
                  <html:radio value="O" property="w_rehabtype"/>Other
		</td>
	</tr>
	<tr id="forthSection6">
		<td>
		Do you wish to consult with WCB physician or nurse advisor?</td>
                <td><html:radio value="Y" property="w_wcbadvisor"/> Yes <html:radio value="N" property="w_wcbadvisor"/> No
		</td>
	</tr>
	<tr id="forthSection7">
		<td>
		If possible, please estimate date of Maximal Medical Recovery</td>
                <td><html:text readonly="readonly" styleId="w_estimatedate" property="w_estimatedate" onclick="window.WCBForm.w_estimatedate.value = '';" /><a id="hlEDate">
	...
	<tr id="forthSection8">
		...
		Further Correspondence to Follow: (2nd electronic form or paper) </td>
                <td><html:radio value="Y" property="w_tofollow"/> Yes <html:radio value="N" property="w_tofollow"/>  No
		</td>
	</tr>
    <tr >
      <td>Payee Number: <html:text readonly="readonly" property="w_payeeno" size="5" />
      </td>
      <td>Provider No: <html:text readonly="readonly" property="w_pracno" size="5" />(<%=form.getW_pracname()%>)</td>
    </tr>
    <tr>
