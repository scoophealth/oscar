    ...
    <html:form action="/billing/CA/BC/saveBillingPreferencesAction.do" method="POST">
      ...
      <tr>
        ...
        <td class="MainTableRightColumn">
          <br>
          <label for="referral">            Select Default Referral Type:
      ...
      <tr>
        <td class="MainTableLeftColumn">&nbsp;</td>
        <td class="MainTableRightColumn">
          <label for="payeeProviderNo">Select Default Payee:
            <html:select property="payeeProviderNo">
      ...
      <tr>
        ...
        <td class="MainTableBottomRowRightColumn"> <html:submit property="submit" value="Save"/>       </td>
      </tr>
    </html:form>
  </table>
  </body>
