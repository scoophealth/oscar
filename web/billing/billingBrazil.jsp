...
<html:form method="post" action="/oscar/billing/procedimentoRealizado/add.do">
  <table cellspacing="0" cellpadding="2" width="100%" border="0" align="center">
    <tr><th>Faturamento</th></tr>
  </table>
  <p>&nbsp;</p>
    ...
    <tr class="body">
      ...
      <td width="20%"> 
		<span class="formLabel">
			<bean:write name="procedimentoRealizadoForm" property="appointment.appointmentDate"/>
		</span>
      </td>
      <td width="10%"><span class="formLabel">Paciente</span></td>
      <td width="20%"> 
		<span class="formLabel">
			<bean:write name="procedimentoRealizadoForm" property="appointment.demographic.name"/>
		</span>
      </td>
    </tr>
    <tr class="body">
      ...
      <td width="20%"> 
		<span class="formLabel">
			<bean:write name="procedimentoRealizadoForm" property="appointment.provider.name"/>
		</span>
      </td>
      <td width="10%"><span class="formLabel">Motivo da consulta</span></td>
      <td width="20%"> 
		<span class="formLabel">
			<bean:write name="procedimentoRealizadoForm" property="appointment.reason"/>
		</span>
      </td>
    </tr>
  </table>
  ...
  <table cellspacing="0" cellpadding="2" width="95%" border="1" align="center">
    <tr class="body">
      ...
      <td width="90%"> 
       ...
       <html:submit onclick="set('formulario');"> Pesquisar </html:submit>
      </td>
    </tr>
  </table>
  <p>&nbsp;</p>
  ...
  <table cellspacing="2" cellpadding="2" width="95%" border="1" align="center">
    ...
    <logic:present name="procedimentoRealizadoForm" property="procedimentosForm">
    <logic:iterate id="procedimento" name="procedimentoRealizadoForm" property="procedimentosForm">
      <tr class="body"> 
		<td>
			<div align="center">
				<html:multibox name="procedimentoRealizadoForm" property="procedimentosChecked">
					<bean:write name="procedimento" property="cadProcedimentos.coProcedimento"/>
				</html:multibox>
			</div>
		</td>
        <td>
        	<span class="formLabel"><bean:write name="procedimento" property="cadProcedimentos.coProcedimento"/>&nbsp;
        	<bean:write name="procedimento" property="cadProcedimentos.dsProcedimento"/></span></td>
      </tr>
    </logic:iterate>
    </logic:present>
  </table>
  ...
  <table cellspacing="0" cellpadding="2" width="95%" border="1" align="center">
    ...
    <logic:iterate id="procedimentoRealizado" name="procedimentoRealizadoForm" property="appointment.procedimentoRealizado">
       <tr  class="body">
          <td>
			<span class="formLabel"><bean:write name="procedimentoRealizado" property="cadProcedimentos.coProcedimento"/>&nbsp;
          	<bean:write name="procedimentoRealizado" property="cadProcedimentos.dsProcedimento"/></span>
           </td>
          <td>
	         <html:link page="/oscar/billing/procedimentoRealizado/deleteProc.do" paramName="procedimentoRealizado" paramId="coProc" paramProperty="cadProcedimentos.coProcedimento" styleClass="formLink">
	            Remover
	          </html:link>
		  </td>
       </tr>
  ...
  <br>
  <table cellspacing="0" cellpadding="2" width="95%" border="1" align="center">
   <tr><th>Diagn&oacute;stico</th></tr>
  </table>
  <br>
  <table cellspacing="0" cellpadding="2" width="95%" border="1" align="center">
    <tr class="body">
  ...
  <table cellspacing="0" cellpadding="2" width="95%" border="1" align="center">
    ...
    <logic:iterate id="diagnostico" name="procedimentoRealizadoForm" property="appointment.diagnostico">
       <tr class="body">
          <td>
			<span class="formLabel">
			  <bean:write name="diagnostico" property="cadCid.coCid"/>&nbsp;
          	  <bean:write name="diagnostico" property="cadCid.dsCid"/>
            </span>
          </td>
		  <td>
	         <html:link page="/oscar/billing/procedimentoRealizado/deleteDiag.do" paramName="diagnostico" paramId="coCid" paramProperty="cadCid.coCid" styleClass="formLink">
	            Remover
	          </html:link>
		  </td>
       </tr>
...
<SCRIPT>function set(target) {document.forms[0].dispatch.value=target;}</SCRIPT>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tr>
      <td><a href="#" onclick="window.close();"> <img src="../../../images/leftarrow.gif" border="0" width="25" height="20" align="absmiddle"><bean:message key="global.btnBack"/></a></td>
      <td align="right"><a href="#" onclick="window.close();"><bean:message key="global.btnLogout"/><img src="../../../images/rightarrow.gif"  border="0" width="25" height="20" align="absmiddle"></a></td>
    </tr>
  </table>
