 ...
 <%   
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"search_encounter", "select * from encounter where demographic_no = ? order by encounter_date desc, encounter_time desc"},
      ...
      {"save_inrbilling", "insert into billinginr (billinginr_no, demographic_no, demographic_name, hin, dob, provider_no, provider_ohip_no, provider_rma_no, creator, diagnostic_code, service_code, service_desc, billing_amount, billing_unit, createdatetime, status) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"},
