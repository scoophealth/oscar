...
<table width="600" border="1">
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Patient : <%=request.getParameter("demographic_name")%></font></b></td>
    <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Health# :<%=demoHIN%></font></b></td>
  </tr>
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Billing Type: 
      <%=billtype%></font></b></td>
    <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Service</font><font face="Arial, Helvetica, sans-serif"> 
      Date: <%=request.getParameter("xml_appointment_date")%></font></b></td>
  </tr>
  <%  
    	String local_desc="";
 ...
 rslocation = null;
 rslocation = apptMainBean.queryResults(location1, "search_visit_location");
 ...
 local_desc = rslocation.getString("clinic_location_name");
     ...
     //  apptMainBean.closePstmtConn();
       %>
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Visit Type Code: 
      <%=request.getParameter("xml_visittype")%></font></b></td>
    <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Billing Physician: 
       <%=proFirst%> <%=proLast%></font></b></td>
  </tr>
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Visit Location: 
      <%=local_desc%></font></b></td>
    <td width="46%"><font face="Arial, Helvetica, sans-serif"><b>Admission Date: 
      <%=visitdate%></b></font></td>
  </tr>
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Appointment Physician:  <%=apptFirst%> <%=apptLast%>  </font></b></td>
    <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Secordary Physician: <%=asstFirst%>  <%=asstLast%> </font></b></td>
  </tr>
         <tr> 
            <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Referral Physician:  <%=r_doctor%> </font></b></td>
            <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Referral Physician Number: <%=r_doctor_ohip%> </font></b></td>
   </tr>
  <tr> 
    <td width="54%"><b><font face="Arial, Helvetica, sans-serif">Creator: <%=crFirst%> <%=crLast%>  </font></b></td>
    <td width="46%"><b><font face="Arial, Helvetica, sans-serif">Creation Date: <%=now.get(Calendar.YEAR)+"-"+(now.get(Calendar.MONTH)+1)+"-"+now.get(Calendar.DAY_OF_MONTH)%></font></b></td>
  </tr>
</table>
  <%
...
str = sBuffer.toString();
        ...
        %>
    <tr> 
      <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=scode%></font></td>
      ...
      <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=desc%></font></td>
      <td width="6%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2">1</font></div>
      </td>
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=fee%></font></font></font></div>
      </td>
    </tr>
    <% counter = counter + 1; 
...
%>
    ...
    <% if (otherflag1 == 1) { %>
      <tr> 
      <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdbcode1%></font></td>
      ...
      <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdesc1%></font></td>
      <td width="6%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=othercode1unit%></font></div>
      </td>
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=otherfee%></font></font></font></div>
      </td>
    </tr>
    <% counter = counter + 1;
    } %>
     <% if (otherflag2 == 1) { %>
      <tr> 
      <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdbcode2%></font></td>
      ...
      <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdesc2%></font></td>
      <td width="6%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=othercode2unit%></font></div>
      </td>
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=otherfee02%></font></font></font></div>
      </td>
    </tr>
    <% counter = counter + 1;
    } %>
     <% if (otherflag3 == 1) { %>
      <tr> 
      <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdbcode3%></font></td>
      ...
      <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=otherdesc3%></font></td>
      <td width="6%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=othercode3unit%></font></div>
      </td>
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=otherfee03%></font></font></font></div>
      </td>
    </tr>
    <% counter = counter + 1;
    } %>
...
str = sBuffer.toString();
      %>
           <tr> 
	       <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=eCode%></font></td>
	       ...
	       <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=eDesc%></font></td>
	       <td width="6%"> 
	         <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=eUnit%></font></div>
	       </td>
	       <td width="14%"> 
	         <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=percentPremium%></font></font></font></div>
	       </td>
    </tr>
         <% counter = counter + 1;
    } %>
    ...
    str = sBuffer.toString();
          %>
               <tr> 
    	       <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><%=xCode%></font></td>
    	       ...
    	       <td width="58%"><font face="Arial, Helvetica, sans-serif" size="2"><%=xDesc%></font></td>
    	       <td width="6%"> 
    	         <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=xUnit%></font></div>
    	       </td>
    	       <td width="14%"> 
    	         <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"><%=xPercentPremium%></font></font></font></div>
    	       </td>
        </tr>
             <% counter = counter + 1;
    } %>
...
<% } else { %>
    ...
    <% if (request.getParameter("xml_research1") == null || request.getParameter("xml_research1").compareTo("") == 0) { %>
      ...
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=BigTotal%></font></div>
      </td>
    </tr>
  </table>
  <% } else { %>
    ...
    <tr> 
      <td width="22%"><font face="Arial, Helvetica, sans-serif" size="2"><b>Research 
        Code</b></font></td>
      <td colspan="2"><font face="Arial, Helvetica, sans-serif" size="2"><%=request.getParameter("xml_research1")%> <%=request.getParameter("xml_research2").compareTo("")==0?"":", "+request.getParameter("xml_research2")%> <%=request.getParameter("xml_research3").compareTo("")==0?"":", "+request.getParameter("xml_research3")%></font></td>
      <td width="14%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><font face="Arial, Helvetica, sans-serif"><font size="2"></font></font></font></div>
      </td>
    </tr>
