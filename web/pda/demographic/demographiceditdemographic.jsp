...
<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#0066CC" bordercolor="#0066CC">
  <tr>
    ...
    <td bgcolor="#CCCCCC"> 
      <div align="center"><a href="" >Lab Reports</a></div></td>
    <td bgcolor="#CCCCCC">
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
    ...
    <tr valign="top"> 
      ...
      <td align="left"> 
        <input type="text" name="sex" value="<%=rs.getString("sex")%>" onBlur="upCaseCtrl(this)">
      </td>
    ...
    <tr bgcolor="#486ebd"> 
      <td colspan="4">
       <table border=0  width="100%" cellpadding="0" cellspacing="0"><tr><td width="20%"> 
          ...
          <input type="button" name="Button" value="Swipe Card" onclick="window.open('zdemographicswipe.htm','', 'scrollbars=yes,resizable=yes,width=600,height=300')";>
