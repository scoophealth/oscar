...
<table BORDER="0" CELLPADDING="1" CELLSPACING="0" WIDTH="100%" BGCOLOR="#C4D9E7">
	<form method="post" name="swipecard" action="demographicswipe.jsp">
		<tr valign="top"><td rowspan="2" ALIGN="right" valign="middle"> <font face="Verdana" color="#0000FF"><b><i>Swipe Card 
        </i></b></font></td>
			
    
      <td valign="middle" rowspan="2" ALIGN="left"><input type="text" NAME="card_no" SIZE="60"  MAXLENGTH="120">
