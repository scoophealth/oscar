  ...
  <tr><td width="100%">
        ...
        <table BORDER="0" CELLPADDING="0" CELLSPACING="1" WIDTH="100%" BGCOLOR="#C0C0C0">
          <tr valign="middle"> 
            ...
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
              <INPUT TYPE="TEXT" NAME="appointment_date" VALUE="<%=bFirstDisp?(request.getParameter("year")+"-"+request.getParameter("month")+"-"+request.getParameter("day") ):request.getParameter("appointment_date")%>" WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
            ...
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
              <INPUT TYPE="TEXT" NAME="status" VALUE="<%=bFirstDisp?"T":request.getParameter("status").equals("")?"":request.getParameter("status")%>"  onBlur="upCaseCtrl(this)" WIDTH="25" HEIGHT="20" border="0" hspace="2">
            </td>
          </tr>
          <tr valign="middle"> 
            <td width="20%" BGCOLOR="#C4D9E7" ALIGN="LEFT"> 
