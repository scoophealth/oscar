...
function popupPage(varpage) { //open a new popup window
  var page = "" + varpage;
  windowprops = "height=560,width=680,location=no,scrollbars=yes,menubars=no,toolbars=no,resizable=yes";
  var popup=window.open(page, "Popupnav", windowprops);
  if (popup != null) {
...
function refresh() {
  var a=self.location.href.substring(0,self.location.href.lastIndexOf("#"));//self.location.href;
  //alert(a);
  self.location.href=a;//.substring(0,a.length()-1); //"../index.html"; //
}
...
<tr>
 <td width="25%" bgcolor="#3EA4E1" align="center"><font face="sans-serif" size="2">
   ...
   <a href="appointmentcontrol.jsp?year=<%=curYear%>&month=<%=curMonth%>&day=<%=curDay%>&displaymode=month&dboperation=searchappointmentmonth" TITLE='View your template' onmouseover="window.status='View your template';return true">Monthly Template</a></font>
      ...
      <td width="25%" bgcolor="#3EA4E1" align="center"><font face="sans-serif" size="2"> 
        <a HREF="#" ONCLICK ="popupPage2('../demographic/search.htm')" TITLE='Search for patient records' onmouseover="window.status='Search for patient records';return true">Search/Add 
        Patients</a></font> </td>
      <td width="25%" bgcolor="#3EA4E1" align="center"><font face="sans-serif" size="2"> 
    ...
    <table BORDER="0" CELLPADDING="0" CELLSPACING="0" height="20">
      <tr>
        ...
        <td></td><td rowspan="2" BGCOLOR="#C0C0C0" ALIGN="MIDDLE" nowrap><font FACE="VERDANA,ARIAL,HELVETICA" SIZE="2">
         <a href="appointmentcontrol.jsp?year=<%=year%>&month=<%=month%>&day=<%=day%>&displaymode=week&dboperation=searchapptweek" TITLE='View your daily schedule' OnMouseOver="window.status='View your weekly schedule' ; return true">Week</a></font></td>
        <td></td><td rowspan="2" BGCOLOR="#C0C0C0" ALIGN="MIDDLE" nowrap><font FACE="VERDANA,ARIAL,HELVETICA" SIZE="2">
    ...
    <table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
      ...
      <tr>
            ...
            <td align="RIGHT" bgcolor="#3EA4E1" width="10%" NOWRAP><b><font face="verdana,arial,helvetica" size="2"> 
             ...
             <%=(hourCursor+" "+am_pm)%> &nbsp;</a></font></b></td>
              ...
              //System.out.println("efore resulbtSet: " + param[0]+param[1]);
          	  ...
          	  bFirstTimeRs=true;
        %>	    
            <td bgcolor="#FDFEC7" rowspan="<%=iRows%>"  nowrap>
        ...
        <%
				...
				%>
        		 <a href=# onClick = "popupPage('../demographic/demographiccontrol.jsp?demographic_no=<%=demographic_no%>&displaymode=edit&dboperation=search_detail')" title="edit patient record"><%=name%></a></font></td>
        <% 
        			}
          	}
...
<!-- End sub page table -->
  <p></p>
<%@ include file="../receptionist/footer.htm"%>
</body>
</html>