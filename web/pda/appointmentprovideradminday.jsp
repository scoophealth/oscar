...
<table width="100%" border="0" cellspacing="2" cellpadding="0"
	...
	<tr>
		...
		<td width="25%" bgcolor="#3EA4E1" align="center"><font
			...
			ONCLICK="popupPage2('../demographic/search.htm')"
...
<table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
	<tr>
		...
		<td align="right" valign="bottom"><a href="#"
			...
			VALUE="day"> <INPUT TYPE="hidden" NAME="dboperation"
			VALUE="searchappointmentday"> <INPUT TYPE="SUBMIT" NAME="Go"
			VALUE="GO" SIZE="5"></td>
		</form>
	</tr>
</table>
	...
	<tr>
        ...
        %>
              ...
              //System.out.println("efore resulbtSet: " + param[0]+param[1]);
          	  ...
          	  bFirstTimeRs=true;
        %>
						<td bgcolor="#FDFEC7" rowspan="<%=iRows%>" nowrap><a href=#
