...
//  String back_to = request.getParameter("back_to").trim();
//*****************************************************************  
...
<!--
<table border="1">
<tr><td><a href="AddDemographicForm.jsp?">New Patient ?</a> </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="">Return </a></td></tr>
</table>
-->
<table border="0">
...
//  out.print("<tr><td><a href=\"AppointmentForm2.jsp?appointment_no="+appointment_no+"&demographic_no="+rs.getInt("demographic_no")+"&appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+rs.getString("last_name")+","+rs.getString("first_name")+"\">Get</a></td>" );
  out.print("<tr><td><a href=\"AppointmentForm2.jsp?appointment_no="+appointment_no+"&demographic_no="+rs.getInt("demographic_no")+"&appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+rs.getString("last_name")+","+rs.getString("first_name")+"\">" );
...
// response.sendRedirect("AppointmentForm2.jsp?appointment_no="+appointment_no+"&appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+name);
 
    String gotoJsp = "AppointmentForm2.jsp?appointment_no="+appointment_no+"&appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+name;
