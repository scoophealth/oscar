...
<title>AddAppointmentMonthSearch</title>
...
if( rs.next()){
  ...
  while (rs.next()){
  out.print("<tr><td><a href=\"AddAppointmentMonthForm2.jsp?demographic_no="+rs.getInt("demographic_no")+"&appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+rs.getString("last_name")+","+rs.getString("first_name")+"\">Get</a></td>" );
...
//response.sendRedirect("AddAppointmentMonthForm2.jsp?appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+name);

    String gotoJsp = "AddAppointmentMonthForm2.jsp?appointment_date="+appointment_date+"&start_time="+start_time+"&end_time="+end_time+"&name="+name;
