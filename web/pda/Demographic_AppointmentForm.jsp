...
<title>Demographic_AppointmentForm</title>
...
if( rs.next()){
  out.print("<table border=\"1\" width=\"32%\">");
  out.print("<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"ProblimList_AppointmentForm.jsp?demographic_no="+demographic_no+"&appointment_no="+appointment_no+"\">CPP</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"AppointmentForm.jsp?appointment_no="+appointment_no+"\">Return</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"logout.jsp\">LogOut</a></td></tr>");
  out.print("</table>");
...
// if has NO  result
   ...
   out.print("<tr><td><a href=\"AppointmentForm.jsp?appointment_no="+appointment_no+"\">Return</a>&nbsp;<a href=\"logout.jsp\">LogOut</a></td></tr>");
