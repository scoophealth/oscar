...
String content,xml_Problem_List,xml_Medication,xml_Alert,xml_Family_Social_History ="";
...
//if action is good, then give me the result
    ...
    if (beanDBConnect.executeUpdate(queryString)) {
       response.sendRedirect("ProblimList_AppointmentForm.jsp?appointment_no="+appointment_no+"&demographic_no="+demographic_no);
