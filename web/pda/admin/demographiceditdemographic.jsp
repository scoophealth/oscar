...
<table width="100%" border="1" cellspacing="1" cellpadding="1">
	<tr>
		...
		<td>
		<div align="center"><a
			href='admincontrol.jsp?demographic_no=<%=rs.getString("demographic_no")%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10'>Appt.History</a></div>
		</td>
		<td>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
	...
	<tr bgcolor="#486ebd">
		...
		<div align="center"><input type="hidden" name="dboperation"
			...
			href='admincontrol.jsp?demographic_no=<%=rs.getString("demographic_no")%>&displaymode=Demographic_Delete&dboperation=demographic_delete'>
