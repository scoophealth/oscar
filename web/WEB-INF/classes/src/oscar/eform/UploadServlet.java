...
/**
 * Class UploadServlet is a servlet to upload the text/html file to the database 2002-12-30
 */
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (contentType != null && contentType.indexOf("multipart/form-data") != -1) {
                ...
                saveFile = saveFile.substring(saveFile.lastIndexOf("\\") + 1, saveFile.indexOf("\"")); //only
                // for
                // windows
                // path

                /*
                 * remove boundary markers and other multipart/form-data tags from beginning of
                 * upload file section
                 */
                ...
                pos = file.indexOf("\n", pos) + 1;
                /*
                 * find the location of the next boundary marker (marking the end of the upload file
                 * data)
                 */
