...
public class JdbcBillingCreateBillingFile {
	...
	private String buildHeader1() {
		...
		header1 = ch1Obj.getTransc_id() + ch1Obj.getRec_id() + str1Hin + ver + ch1Obj.getDob().replaceAll("-", "")
	...
	public void writeFile(String value1) {
		try {
			 ...
			 * "user.dir"); //System.out.println(userHomePath); File pFile = new
			 * File(userHomePath, oscar_home); FileInputStream pStream = new
			 * FileInputStream(pFile.getPath()); Properties ap = new
	...
	public void writeHtml(String htmlvalue1) {
		try {
			String home_dir1;
			/*
			 * String userHomePath1 = System.getProperty("user.home",
			 * "user.dir"); // System.out.println(userHomePath); File pFile1 =
			 * new File(userHomePath1, oscar_home); FileInputStream pStream1 =
			 * new FileInputStream(pFile1.getPath()); Properties ap1 = new
