...
*/
  ...
  public void Set(oscar.oscarBilling.ca.bc.pageUtil.BillingSessionBean bean) {
    ...
    this.injuryLocations = billform.getInjuryLocationList();
    ...
    try {
      ...
      String fee = ( (BillingBillingManager.BillingItem) bean.getBillItem().get(
          0)).getServiceCode();
