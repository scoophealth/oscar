  ...
  ;
   ...
   public String[] getDemographic() {
      ...
      return new String[] {
         ...
         oscar.Misc.mysqlEscape(this.w_area)

         + oscar.Misc.mysqlEscape(this.w_phone),
   ...
   private String DateOfBirth() {
      ...
      return oscar.Misc.mysqlEscape(this.getYearOfBirth())

      + "-"

      + oscar.Misc.mysqlEscape(this.getMonthOfBirth())

      + "-"

      + oscar.Misc.mysqlEscape(this.getDayOfBirth());
