...
public class RxPatientData {
  ...
  public Patient getPatient(int demographicNo)
  ...
  public class Patient {
    ...
    public Patient(int demographicNo, String surname, String firstName,
                   String sex, java.util.Date DOB,
    ...
    public Allergy[] getAllergies() {
      ...
      try {
        ...
        rs = db.GetSQL("SELECT * FROM allergies WHERE demographic_no = " +
                       getDemographicNo() + " ORDER BY DESCRIPTION");
    ...
    public Allergy addAllergy(java.util.Date entryDate,
                              RxAllergyData.Allergy allergyCode) {

      try {

        Allergy allergy = new Allergy(0, entryDate, allergyCode);
    ...
    public boolean deleteAllergy(int allergyId) {
      ...
      try {
        ...
        sql = "DELETE FROM allergies WHERE allergyid = " + allergyId;
    ...
    public Disease[] getDiseases() {
      ...
      try {
        ...
        rs = db.GetSQL("SELECT * FROM diseases WHERE demographic_no = " +
                       getDemographicNo());

        while (rs.next()) {

          d = new Disease(rs.getInt("diseaseid"), rs.getString("ICD9_E"),
    ...
    public Disease addDisease(String ICD9, java.util.Date entryDate) throws
        SQLException {
    ...
    public boolean deleteDisease(int diseaseId) throws SQLException {
      ...
      sql = "DELETE FROM diseases WHERE diseaseid = " + diseaseId;
    ...
    public RxPrescriptionData.Prescription[] getPrescribedDrugsUnique() {
      ...
      return new RxPrescriptionData().getUniquePrescriptionsByPatient(this.
          getDemographicNo());
    ...
    public RxPrescriptionData.Prescription[] getPrescribedDrugs() {
      ...
      return new RxPrescriptionData().getPrescriptionsByPatient(this.
          getDemographicNo());
    ...
    public class Allergy {
      ...
      public Allergy(int allergyId, java.util.Date entryDate,
                     RxAllergyData.Allergy allergy) {
      ...
      public Allergy(int allergyId, java.util.Date entryDate,
                     ...
                     int HICL_SEQNO, int HIC_SEQNO, int AGCSP, int AGCCS,
                     int TYPECODE) {
        ...
        this.allergy = new RxAllergyData().getAllergy(DESCRIPTION, HICL_SEQNO,

            HIC_SEQNO, AGCSP, AGCCS, TYPECODE);
      ...
      public boolean Save(DBHandler db) throws SQLException {
        ...
        if (this.getAllergyId() == 0) {
          ...
          sql = "UPDATE allergies SET entry_date = '"
