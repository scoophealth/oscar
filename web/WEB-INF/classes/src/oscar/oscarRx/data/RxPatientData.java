...
public class RxPatientData {
    ...
    public Patient[] PatientSearch(String surname, String firstName) {
        ...
        try {
            ...
            rs = db.GetSQL("SELECT demographic_no, last_name, first_name, sex, year_of_birth, "
            ...
            while(rs.next()) {
                ...
                calcDate(rs.getString("year_of_birth"), rs.getString("month_of_birth"),
                rs.getString("date_of_birth")),
                rs.getString("address"), rs.getString("city"), rs.getString("postal"),
                rs.getString("phone"));
    ...
    public class Patient {
        ...
        public Allergy[] getAllergies() {
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    rs.getString("DESCRIPTION"), rs.getInt("HICL_SEQNO"), rs.getInt("HIC_SEQNO"),
        ...
        public class Allergy {
            ...
            public Allergy(int allergyId, java.util.Date entryDate, String DESCRIPTION,
            int HICL_SEQNO, int HIC_SEQNO, int AGCSP, int AGCCS, int TYPECODE) {
                this.allergyId = allergyId;
                this.entryDate = entryDate;
