...
public class EctVTFormAction extends Action {
        ...
        throws ServletException, IOException
    {
        ...
        request.getSession().setAttribute("EctVTFormForm", frm);
        ...
        try
            {
                ...
                String inputValueName, inputTypeName, inputTypeDisplayName, mInstrcName;
                String commentsName, dateName, validationName, inputValue, inputType;
                String inputTypeDisplay, mInstrc, comments, dateObserved, validation;
                String msg = null;
                String regExp = null;
                double dMax = 0;
                double dMin = 0;
                ...
                //Write to database and set attribute if all the input values are valid
                if(valid){
                    for(int i=0; i<iType; i++){
                        ...
                        if(!gValidator.isBlankOrNull(inputValue)){
                            ...
                            String sql = "INSERT INTO measurements"
                                    ...
                                    + str.q(mInstrc)+"','"+str.q(comments)+"','"+str.q(dateObserved)+"', now())";                           
                            db.RunSQL(sql);                            
                            
                        }                        
                        request.setAttribute(inputType, convert2OSDSF(inputValue));                                            
                    }       
                    ...
                    request.setAttribute("SBP", sbp);
                    request.setAttribute("DBP", dbp);
                    request.setAttribute("DateBP", dateEntered);
                }
                else{                                                            
    ...
    private String convert2OSDSF(String inputValue){        
        if(inputValue.equalsIgnoreCase("yes") || inputValue.equalsIgnoreCase("y"))
            return "false";
        else if(inputValue.equalsIgnoreCase("no") || inputValue.equalsIgnoreCase("n"))
            return "true";
        else
            return inputValue;    
    }
