...
import oscar.oscarEncounter.data.EctPeriMenopausalRecord;
...
public final class EctPeriMenopausalAction extends Action {
	...
	throws IOException, ServletException {
        ...
        try {
            ...
            newID = rec.savePeriMenopausalRecord(props);
        ...
        else if(request.getParameter("submit").equalsIgnoreCase("save"))
        {
            ...
            System.out.println("provNo: "+request.getParameter("provNo"));
        }
