...
public class OBChecklistHandler_99_12 extends DefaultHandler {
	...
	public void startElement(String namespaceURI, String localName, String rawName, Attributes atts) throws SAXException {
            // System.out.print("in startElement, localName: " + localName + "  rawName: " + rawName + "  namespaceURI: " + namespaceURI + "  attributes: " + atts);
            localName = rawName; // Quick hack to make this work with the xerces parser.  Still works with other parsers also.
	...
	public void endElement(String namespaceURI, String localName, String rawName) throws SAXException {
            localName = rawName; // Quick hack to make this work with the xerces parser.
            if (localName.equals("recommendations")) {
                results += "</td></tr></table></center>\n";
            }
            if (localName.equals("week")) {
