...
public class IntegerAnswerTypeHtmlAdapter extends BaseAnswerTypeHtmlAdapter {

	public IntegerAnswerTypeHtmlAdapter(IntakeInstance instance, IntakeNode node, int index) {
