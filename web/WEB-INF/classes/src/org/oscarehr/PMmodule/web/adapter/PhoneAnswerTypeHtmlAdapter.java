...
public class PhoneAnswerTypeHtmlAdapter extends BaseAnswerTypeHtmlAdapter {

	public PhoneAnswerTypeHtmlAdapter(IntakeInstance instance, IntakeNode node, int index) {
