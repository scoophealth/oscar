...
public class DateAnswerTypeHtmlAdapter extends BaseAnswerTypeHtmlAdapter {

	public DateAnswerTypeHtmlAdapter(IntakeInstance instance, IntakeNode node, int index) {
