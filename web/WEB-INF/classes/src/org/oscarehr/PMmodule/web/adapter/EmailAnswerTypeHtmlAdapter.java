...
public class EmailAnswerTypeHtmlAdapter extends BaseAnswerTypeHtmlAdapter {

	public EmailAnswerTypeHtmlAdapter(IntakeInstance instance, IntakeNode node, int index) {
