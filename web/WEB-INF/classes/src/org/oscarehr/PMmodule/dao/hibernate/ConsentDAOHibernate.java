...
public class ConsentDAOHibernate extends HibernateDaoSupport implements
		ConsentDAO {

	private Log log = LogFactory.getLog(ConsentDAOHibernate.class);
