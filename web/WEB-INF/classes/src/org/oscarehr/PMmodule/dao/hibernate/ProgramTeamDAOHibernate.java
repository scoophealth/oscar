...
public class ProgramTeamDAOHibernate extends HibernateDaoSupport implements ProgramTeamDAO {

	private Log log = LogFactory.getLog(ProgramTeamDAOHibernate.class);
