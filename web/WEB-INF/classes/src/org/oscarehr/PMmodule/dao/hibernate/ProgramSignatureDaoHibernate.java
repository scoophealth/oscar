...
public class ProgramSignatureDaoHibernate extends HibernateDaoSupport implements ProgramSignatureDao {

	private static final Log log = LogFactory.getLog(ProgramSignatureDaoHibernate.class);	
