...
<%
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"search_encounter_no", "select * from encounter where demographic_no = ? and encounter_date=? and encounter_time=? and provider_no=? order by encounter_no desc limit 1 offset 0"},
    {"search_encountersingle", "select * from encounter where encounter_no = ?"},
    {"search_previousenc", "select * from encounter where demographic_no = ? and provider_no=? order by encounter_date desc, encounter_time desc limit 1 offset 0"},
    ...
    {"search_prescribe_no", "select prescribe_no from prescribe where demographic_no=?  order by prescribe_date desc, prescribe_time desc limit 1 offset 0"},
    ...
    //{"searchallprovider", "select * from provider order by last_name"}, ^M
...
//    {"billingobstetric" , "billingobstetric.jsp"},
  ...
  if(true) {
    out.clear();
    //System.out.println("providercontrol.jsp "+apptMainBean.whereTo());
