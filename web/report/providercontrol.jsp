...
<%
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"search_encounter_no", "select * from encounter where demographic_no = ? and encounter_date=? and encounter_time=? and provider_no=? order by encounter_no desc limit 0, 1"},
    {"search_encountersingle", "select * from encounter where encounter_no = ?"},
    {"search_previousenc", "select * from encounter where demographic_no = ? and provider_no=? order by encounter_date desc, encounter_time desc limit 0, 1"},
