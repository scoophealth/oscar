    ...
    <body bgcolor="ivory" onLoad="setfocus()" topmargin="0" leftmargin="0" rightmargin="0">
      ...
      <table BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
        <tr BGCOLOR="#CCCCFF">
          ...
          <a href="reportFormRecord.jsp">Back to Report List</a> | <a href="reportFormConfig.jsp?id=<%=reportId%>">Configuration</a>
          </td>
        </tr>
      </table>
...
%>
          <tr bgcolor="<%=color%>">
            <td align="right" width="20%">
              <b><input type="checkbox" name="<%="filter_" + itemId%>" <%="1".equals(itemId)?"checked":""%>></b>
            </td>
            <td>
              <%=strElt[0]%>
            </td>
            <td width="5%" align="right">
              <input type="hidden" name="<%="value_" + itemId%>" value="<%=strElt[1]%>">
              <input type="hidden" name="<%="position_" + itemId%>" value="<%=strElt[2]%>">
              <input type="hidden" name="<%="dateFormat_" + itemId%>" value="<%=strElt[5]%>">
            </td>
          </tr>
<% } %>
