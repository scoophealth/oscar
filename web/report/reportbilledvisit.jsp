...
while (rs.next()) { 
	props.setProperty("patTotal", DBHandler.getString(rs,1));
}
...
while (rs.next()) { 
	props.setProperty("patRosterNR", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("patRosterRO", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("patSexF", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("patSexM", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat0_1", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat2_11", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat12_20", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat21_34", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat35_50", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat51_64", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat65_70", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("pat71_", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("visTotal", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("visRosterNR", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("visRosterRO", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("visSexF", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("visSexM", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis0_1", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis2_11", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis12_20", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis21_34", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis35_50", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis51_64", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis65_70", DBHandler.getString(rs,1));
}
...
rs = db.queryResults(sql,params); 
while (rs.next()) { 
	props.setProperty("vis71_", DBHandler.getString(rs,1));
}
