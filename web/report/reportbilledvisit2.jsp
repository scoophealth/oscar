...
sql = "select distinct(service_code), service_desc from billingdetail bd where bd.status!='D' and bd.appointment_date>='" + sdate + "' and bd.appointment_date<='" + edate + "' order by service_code";
rs = db.GetSQL(sql); 
while (rs.next()) { 
