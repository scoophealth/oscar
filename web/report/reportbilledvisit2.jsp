...
while (rs.next()) { 
	vServiceCode.add(DBHandler.getString(rs,"service_code"));
	vServiceDesc.add(DBHandler.getString(rs,"service_desc"));
}
...
*/
		...
		rs = db.queryResults(sql,params); 
		while (rs.next()) { 
			props.setProperty(vServiceCode.get(i) + "visNurse" + j + vServiceDesc.get(i), DBHandler.getString(rs,1));
		}
/*
		out.println("<hr>");
