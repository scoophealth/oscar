...
<form name="reassignForm" method="post" action="Forward.do">
    ...
    <input type="hidden" name="labType<%= request.getParameter("segmentID") %>BCP" value="imNotNull" />
                    ...
                    <td bgcolor="white" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="FieldData" nowrap="nowrap">
                                        <%= ( (String) ( lab.status.equals("F") ? "Final" : lab.status.equals("C") ? "Corrected" : "Partial") )%>                                        
                                    </div>
                                </td>
                            </tr>
                            <tr>
