       ...
       if (a){  //Find the title and shorten the string
          ...
          if (b) {                        
             ...
             if(d){
                ...
                var findUnitRegExp = /(Tabs|mL|Squirts|gm|mg|�g|Drops|Patch|Puffs|Units|Inhalations)/;
                ...
                betweenFirstAndSecondDigit = betweenFirstAndSecondDigit.replace(/(Tabs|mL|Squirts|gm|mg|�g|Drops|Patch|Puffs|Units|Inhalations)/,frm.unit.options[frm.unit.selectedIndex].text);
                    ...
                    <td>
						...
						<tr>
							...
							<td colspan=2><select name="take" style="width: 72px"
								...
								<html:option value="micg">�g</html:option>
