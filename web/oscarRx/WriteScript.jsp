       ...
       if (a){  //Find the title and shorten the string
          ...
          if (b) {                        
             ...
             if(d){
                ...
                var findUnitRegExp = /(Tabs|mL|Squirts|gm|mg|�g|Drops|Patch|Puffs|Units)/;
                ...
                betweenFirstAndSecondDigit = betweenFirstAndSecondDigit.replace(/(Tabs|mL|Squirts|gm|mg|�g|Drops|Patch|Puffs|Units)/,frm.unit.options[frm.unit.selectedIndex].text);
