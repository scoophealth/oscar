...
<img src=images/caisi_logo.gif border="0" width="624" height="83"></td>
     ...
     <tr>
                <td align="center" colspan="2">ER Receptionist Report
                <br/><br/>
                </td>
     </tr>
			...
			<table width="100%">
				...
				<c:forEach var="admission" items="${admissions}">
					<tr>
						...
						<td valign="top"><fmt:formatDate pattern="yyyy-MM-dd" value="${admission.admissionDate}"/></td>
						<td valign="top">
							<c:out value="${admission.program.address}"/>
							<br/>
							Phone:<c:out value="${admission.program.phone}"/>
							<br/>
							Fax:<c:out value="${admission.program.fax}"/>
							<br/>
						</td>
					</tr>
				</c:forEach>
	...
	<tr>
		...
		<td bgcolor="white" >
			<span style="<%=styleColor%>"><c:out value="${prescription.drug_special}"/></span>
		</td>
	</tr>
</c:forEach>
			</table>
