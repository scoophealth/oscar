...
%>
<html>
    <head><title>Demographic Search</title></head>
    <body onload="<% if ( firstSearch) { %> document.forms[0].submit() <% } %>">
        ...
        <td>
             ...
             <tr>
              ...
              <td valign="middle" rowspan="2" ALIGN="left">
                            <input type="text" NAME="keyword" VALUE="<%=keyword%>" SIZE="17"  MAXLENGTH="100">
