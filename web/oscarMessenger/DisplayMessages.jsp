		...
		<table class="TopStatusBar">
			<tr>
				...
				<%      sentStyle = "messengerButtonsD";
                            ...
                            case 2: %>
				<div class="DivContentTitle"><bean:message
					key="oscarMessenger.DisplayMessages.msgDeleted" /></div>
				...
				<td><!-- edit 2006-0811-01 by wreby --> <html:form
					action="/oscarMessenger/DisplayMessages">
				...
				</html:form> <!-- end edit 2006-0811-01 by wreby --></td>
				...
				<table cellspacing=3>
					<tr>
						...
						<table class=messButtonsA cellspacing=0 cellpadding=3>
							<tr>
								<td class="messengerButtonsA"><html:link
									page="/oscarMessenger/DisplayMessages.jsp?boxType=2"
									styleClass="messengerButtons">
									<bean:message
										key="oscarMessenger.DisplayMessages.btnDeletedMessage" />
									<!--deletedMessage--link-->
								</html:link></td>
							</tr>
						</table>
			...
			<tr>
				...
				<%String strutsAction = "/oscarMessenger/DisplayMessages";
					...
					<table border="0" width="80%" cellspacing="1">
						<tr>
							<th align="left" bgcolor="#DDDDFF" width="75"><input
								type="checkbox" name="checkAll2" onclick="checkAll('msgList')"
								id="checkA" /></th>
							<th align="left" bgcolor="#DDDDFF">
							<% if (moreMessages.equals("true")){%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=status&moreMessages=true"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgStatus" />
							</html:link> <%}else{%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=status&moreMessages=false"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgStatus" />
							</html:link> <%}%>
							</th>
							...
							<html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=sentto&moreMessages=true"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgTo" />
							</html:link> <%}else{%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=sentto&moreMessages=false"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgTo" />
							</html:link> <%   
                                            }
                                            ...
                                            if (moreMessages.equals("true")){%>
							<html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=from&moreMessages=true"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgFrom" />
							</html:link> <%}else{%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=from&moreMessages=false"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgFrom" />
							</html:link> <%   
                                            }
							...
							<th align="left" bgcolor="#DDDDFF">
							<% if (moreMessages.equals("true")){%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=subject&moreMessages=true"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgSubject" />
							</html:link> <%}else{%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=subject&moreMessages=false"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgSubject" />
							</html:link> <%}%>
							</th>
							<th align="left" bgcolor="#DDDDFF">
							<% if (moreMessages.equals("true")){%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=date&moreMessages=true"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgDate" />
							</html:link> <%}else{%> <html:link
								page="/oscarMessenger/DisplayMessages.jsp?orderby=date&moreMessages=false"
								paramId="boxType" paramName="pageType">
								<bean:message key="oscarMessenger.DisplayMessages.msgDate" />
							</html:link> <%}%>
							</th>
  ...
  //                                      theMessages  = DisplayMessagesBeanId.getSentMessageid();
    ...
    ///                                    theMessages  = DisplayMessagesBeanId.getDelMessageid();
						...
						<tr>
							...
							<%if (pageType != 1){%> <html:checkbox property="messageNo"
								value="<%=dm.messageId %>" /> <% } %> &nbsp; <% 
							...
							<td bgcolor="#EEEEFF"><bean:message key="<%= key %>" /></td>
							<td bgcolor="#EEEEFF">
							<%
                                            if( pageType == 1 ) {
							...
							<td bgcolor="#EEEEFF"><a
								href="<%=request.getContextPath()%>/oscarMessenger/ViewMessage.do?messageID=<%=dm.messageId%>&boxType=<%=pageType%>">
							<%=dm.thesubject%> </a></td>
					...
					<table width="80%">
						<tr>
							<td>
							<%if (pageType == 0){%> <input name="btnDelete" type="submit"
								value="<bean:message key="oscarMessenger.DisplayMessages.formDelete"/>">
							<%}else if (pageType == 2){%> <input type="submit"
								value="<bean:message key="oscarMessenger.DisplayMessages.formUndelete"/>">
							<%}%>
							</td>
							<%
