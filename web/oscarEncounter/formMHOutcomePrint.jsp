...
<script type="text/javascript" language="Javascript">
    ...
    function onCancel() {
        window.location = "formMHOutcome.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>";
        return true;
    }
</script>
</head>
...
<input type="hidden" name="c_lastVisited" value=<%=props.getProperty("c_lastVisited", "Outcome")%> />
