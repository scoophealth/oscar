...
<script type="text/javascript" language="Javascript">
    function onPrint() {
        document.forms[0].submit.value="printReferral";
...
<table cellpadding="1" cellspacing="0" class="mainTable" bgcolor="#E0EEE0">
    <tr>
        <th align="center">
            ...
            <table border="1" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="mhList" valign="top">
                        ...
                        %>
                        &nbsp;<input type="text" name="r_rmpiOther" value="<%= props.getProperty("r_rmpiOther", "") %>" />
                    </td>
                </tr>
                <tr>
                    <td class="mhSelect">
                ...
                <tr>
                    ...
                    <td class="mhList" valign="top">
                        ...
                        %>
                        &nbsp;<input type="text" name="r_armOther" value="<%= props.getProperty("r_armOther", "") %>" />
                    </td>
                    <td class="mhList" rowspan="2" valign="top">
                        Comments:<br>
...
<table class="Head" class="hidePrint">
    <tr>
        <td align="left">
            <input type="submit" value="Save" onclick="javascript:return onSave();" />
            <input type="submit" value="Save and Exit" onclick="javascript:return confirm('Are you sure you wish to save and close this window?');"/>
            <input type="submit" value="Exit" onclick="javascript:return onExit();"/>
            <input type="submit" value="Print" onclick="javascript:return onPrint();"/>
        </td>
        <td align="right">
