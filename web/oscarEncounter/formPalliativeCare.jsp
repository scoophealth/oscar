...
<%@ page import="oscar.oscarEncounter.data.EctPalliativeCareRecord" %>
...
<%
    ...
    java.util.Properties props = rec.getPalliativeCareRecord(demoNo, formId);
...
<html:form action="/oscarEncounter/PalliativeCare">
...
<table width="100%">
    ...
    <tr>
        <td width="50%" align="center">
            Patient Name: <input type="hidden" name="pName" value="<%=props.getProperty("pName", "")%>" />
            <%=props.getProperty("pName", "")%>
        </td>
        <td width="50%" align="center">
            Diagnosis: <input type="text" name="diagnosis" size="40" value="<%=props.getProperty("diagnosis", "")%>" /><br><br>
        </td>
    </tr>
    <tr>
            ...
            <table border="1" cellspacing="0" width="100%">
                <tr class="date">
                    ...
                    <td width="22%" align="right">
                        (yyyy/mm/dd) <input type="text" name="date1" value="<%=props.getProperty("date1", "")%>" /></td>
                    <td width="22%" align="right">
                        (yyyy/mm/dd) <input type="text" name="date2" value="<%=props.getProperty("date2", "")%>" /></td>
                    <td width="22%" align="right">
                        (yyyy/mm/dd) <input type="text" name="date3" value="<%=props.getProperty("date3", "")%>" /></td>
                    <td width="22%" align="right">
                        (yyyy/mm/dd) <input type="text" name="date4" value="<%=props.getProperty("date4", "")%>" /></td>
                </tr>
                <tr class="pain">
                    <td><b><a href="javascript: popupPage('<%=resource%>pain');">PAIN</a></b></td>
                ...
                <tr class="skinUlcers">
                    <td><b><a href="javascript: popupPage('<%=resource%>skin');">SKIN:</a></b><br>
                        Ulcers
                    </td>
                ...
                <tr class="psychAgitation">
                    <td><b><a href="javascript: popupPage('<%=resource%>psych');">PSYCH:</a></b><br>
                        Agitation<br>
                        Myoclonus
                    </td>
                ...
                <tr class="respCough">
                    <td><b><a href="javascript: popupPage('<%=resource%>resp');">RESP:</a></b><br>
                        Cough
                    </td>
                ...
                <tr class="other">
                    <td><b><a href="javascript: popupPage('<%=resource%>other');">Other Issues / FU Plan</a></b></td>
                ...
                <tr class="signature">
                    <td>Signature</td>
                    <td><input type="text" name="signature1" value="<%=props.getProperty("signature1", "")%>" /></td>
                    <td><input type="text" name="signature2" value="<%=props.getProperty("signature2", "")%>" /></td>
                    <td><input type="text" name="signature3" value="<%=props.getProperty("signature3", "")%>" /></td>
                    <td><input type="text" name="signature4" value="<%=props.getProperty("signature4", "")%>" /></td>
                </tr>
            </table>
        </td>
    </tr>
