...
<%@page import="oscar.oscarEncounter.data.*,oscar.oscarEncounter.pageUtil.EctSessionBean, java.net.*"%>
                ...
                <tr>
                    <td>
                        <table width="100%">
                            ...
                            <tr>
                                <td valign="top" align="left" class="TableWithBorder">
                                    <pre name='shTextarea' style="font-size:8pt;"><%=bean.socialHistory%>&nbsp;</pre>
                                </td>
                                <td valign="top" class="TableWithBorder">
                                    <pre name='fhTextarea' style="font-size:8pt;"><%=bean.familyHistory%>&nbsp;</pre>
                                </td>
                                <td valign="top" class="TableWithBorder">
                                    <pre name='mhTextarea' style="font-size:8pt;"><%=bean.medicalHistory%>&nbsp;</pre>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <table width="100%">
                            ...
                            <tr width="100%">
                                <td valign="top" class="TableWithBorder">
                                    <pre name='ocTextarea' style="font-size:8pt;"><%=bean.ongoingConcerns%>&nbsp;</pre>
                                </td>
                                <td valign="top" class="TableWithBorder">
                                    <pre name='reTextarea' style="font-size:8pt;"><%=bean.reminders%>&nbsp;</pre>
                                </td>
                            </tr>
                        </table>
                    </td>
