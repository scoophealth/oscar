...
<table width="60%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top" colspan='4'>Name
            <input type="text" name="c_pName" style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("c_pName", "") %>"/>
        </td>
    </tr>
    <tr>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td nowrap>Newborn care<br>
            ...
            <input type="checkbox" name="pg1_ncMidwife" <%= props.getProperty("pg1_ncMidwife", "") %>/>Midwife<br>
            <input type="text" name="c_nc" size="15" style="width:100%" maxlength="25" value="<%= props.getProperty("c_nc", "") %>"/>
	    </td>
        <td nowrap valign="top">Ethnic background of mother/father<br>
            <div align="center"><textarea name="pg1_ethnicBg" style="width:100%" cols="30" rows="2"><%= props.getProperty("pg1_ethnicBg", "") %></textarea></div>
	    </td>
    </tr>
</table>
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td width="12%">
            <input type="checkbox" name="pg1_vbac" <%= props.getProperty("pg1_vbac", "") %>/>VBAC<br>
            <input type="checkbox" name="pg1_repeatCS" <%= props.getProperty("pg1_repeatCS", "") %>/>Repeat CS<br>
        </td>
        ...
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
                    ...
                    <td width="15%"><input type="checkbox" name="pg1_cp1" <%= props.getProperty("pg1_cp1", "") %> /></td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c2p1");return false;'>Vomiting</a></td>
                    <td width="15%"><input type="checkbox" name="pg1_cp2" <%= props.getProperty("pg1_cp2", "") %>/></td>
                </tr>
                <tr>
                    <td valign="top">3.</td>
                ...
                <tr>
                    ...
                    <td width="15%"><input type="checkbox" name="pg1_cp4" <%= props.getProperty("pg1_cp4", "") %>/></td>
                </tr>
                <tr>
                    <td valign="top">5.</td>
                ...
                <tr>
                    ...
                    <td width="15%"><input type="checkbox" name="pg1_cp6" <%= props.getProperty("pg1_cp6", "") %>></td>
                </tr>
                <tr>
                    <td>7.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c7p1");return false;'>Radiation</a></td>
                    <td width="15%"><input type="checkbox" name="pg1_cp7" <%= props.getProperty("pg1_cp7", "") %>/></td>
                </tr>
                <tr>
                    <td valign="top">8.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c8p1");return false;'>Occup./Env.<br>hazards</a></td>
                    <td width="15%"><input type="checkbox" name="pg1_cp8" <%= props.getProperty("pg1_cp8", "") %>/></td>
                </tr>
                <tr>
                    <td colspan="3" nowrap>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_naRef" <%= props.getProperty("pg1_naRef", "") %>></td>
                </tr>
            </table>
        </td>
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_yes16" <%= props.getProperty("pg1_yes16", "") %>></td>
                    <td><input type="checkbox" name="pg1_no16" <%= props.getProperty("pg1_no16", "") %>></td>
                </tr>
                <tr>
                    <td>17.</td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_yes18" <%= props.getProperty("pg1_yes18", "") %>></td>
                    <td><input type="checkbox" name="pg1_no18" <%= props.getProperty("pg1_no18", "") %>></td>
                </tr>
                <tr>
                    <td>19.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c19p1");return false;'>Hospitalizations</a></td>
                    <td><input type="checkbox" name="pg1_yes19" <%= props.getProperty("pg1_yes19", "") %>></td>
                    <td><input type="checkbox" name="pg1_no19" <%= props.getProperty("pg1_no19", "") %>></td>
                </tr>
                <tr>
                    <td>20.</td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_yes23" <%= props.getProperty("pg1_yes23", "") %>></td>
                    <td><input type="checkbox" name="pg1_no23" <%= props.getProperty("pg1_no23", "") %>></td>
                </tr>
                <tr>
                    <td>24.</td>
        ...
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="15%" align="center"><input type="checkbox" name="pg1_yes26" <%= props.getProperty("pg1_yes26", "") %>></td>
                    <td width="15%" align="center"><input type="checkbox" name="pg1_no26" <%= props.getProperty("pg1_no26", "") %>></td>
                </tr>
                <tr>
                    <td valign="top">27.</td>
                ...
                <tr>
                    ...
                    <td align="center"><input type="checkbox" name="pg1_yes28" <%= props.getProperty("pg1_yes28", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no28" <%= props.getProperty("pg1_no28", "") %>></td>
                </tr>
                <tr>
                    <td>29.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c29p1");return false;'>Previous birth defect</a></td>
                    <td align="center"><input type="checkbox" name="pg1_yes29" <%= props.getProperty("pg1_yes29", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no29" <%= props.getProperty("pg1_no29", "") %>></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="center"><input type="checkbox" name="pg1_yes30" <%= props.getProperty("pg1_yes30", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no30" <%= props.getProperty("pg1_no30", "") %>></td>
                </tr>
                <tr>
                    <td>31.</td>
                ...
                <tr>
                    ...
                    <td align="center"><input type="checkbox" name="pg1_yes36" <%= props.getProperty("pg1_yes36", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no36" <%= props.getProperty("pg1_no36", "") %>></td>
                </tr>
                <tr>
                    <td>37.</td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>Offered</td>
                    <td align="center"><input type="checkbox" name="pg1_yes37off" <%= props.getProperty("pg1_yes37off", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no37off" <%= props.getProperty("pg1_no37off", "") %>></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>Accepted </td>
                    <td align="center"><input type="checkbox" name="pg1_yes37acc" <%= props.getProperty("pg1_yes37acc", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no37acc" <%= props.getProperty("pg1_no37acc", "") %>></td>
                </tr>
            </table>
        </td>
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_idt39" <%= props.getProperty("pg1_idt39", "") %>></td>
                </tr>
                <tr>
                    <td>40.</td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_idt41" <%= props.getProperty("pg1_idt41", "") %>></td>
                </tr>
                <tr>
                    <td>42.</td>
                ...
                <tr>
                    <td colspan="3"><textarea name="c_riskFactors" cols="20" rows="5" style="width:100%"><%= props.getProperty("c_riskFactors", "") %></textarea></td>
                </tr>
            </table>
        </td>
        <td valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td align="right"><input type="checkbox" name="pg1_head" <%= props.getProperty("pg1_head", "") %>></td>
                </tr>
                <tr>
                    <td>Thyroid</td>
                    <td align="right"><input type="checkbox" name="pg1_thyroid" <%= props.getProperty("pg1_thyroid", "") %>></td>
                </tr>
                <tr>
                    <td>Chest</td>
                    <td align="right"><input type="checkbox" name="pg1_chest" <%= props.getProperty("pg1_chest", "") %>></td>
                </tr>
                <tr>
                    <td>Breasts</td>
                    <td align="right"><input type="checkbox" name="pg1_breasts" <%= props.getProperty("pg1_breasts", "") %>></td>
                </tr>
                <tr>
                    <td>Cardiovascular</td>
                    <td align="right"><input type="checkbox" name="pg1_cardio" <%= props.getProperty("pg1_cardio", "") %>></td>
                </tr>
                <tr>
                    <td>Abdomen</td>
                    <td align="right"><input type="checkbox" name="pg1_abdomen" <%= props.getProperty("pg1_abdomen", "") %>></td>
                </tr>
                <tr>
                    <td>Varicosities, extremities</td>
                    <td align="right"><input type="checkbox" name="pg1_vari" <%= props.getProperty("pg1_vari", "") %>></td>
                </tr>
                <tr>
                    <td>Neurological</td>
                    <td align="right"><input type="checkbox" name="pg1_neuro" <%= props.getProperty("pg1_neuro", "") %>></td>
                </tr>
                <tr>
                    <td>Pelvic architecture</td>
                    <td align="right"><input type="checkbox" name="pg1_pelvic" <%= props.getProperty("pg1_pelvic", "") %>></td>
                </tr>
                <tr>
                    <td>Ext. genitalia</td>
                    <td align="right"><input type="checkbox" name="pg1_extGen" <%= props.getProperty("pg1_extGen", "") %>></td>
                </tr>
                <tr>
                    <td>Cervix, vagina</td>
                    <td align="right"><input type="checkbox" name="pg1_cervix" <%= props.getProperty("pg1_cervix", "") %>></td>
                </tr>
                <tr>
                    <td nowrap>Uterus
                ...
                <tr>
                    <td>Adnexa</td>
                    <td align="right"><input type="checkbox" name="pg1_adnexa" <%= props.getProperty("pg1_adnexa", "") %>></td>
                </tr>
            </table>
        </td>
    </tr>
