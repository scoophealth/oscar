                            ...
                            <table width="80%">
                                <tr>
                                    <td colspan="2" valign="bottom" class="Header">
                                        Map Unmapped Identifier Codes
                                    </td>
                                </tr>
                                <tr>
                                    <td class="Cell" width="20%" >
                                        Select unmapped code: 
                                    </td>
                                    <td class="Cell" width="80%">
                                        <select name="identifier" >        
                                                ...
                                                <option value="<%= value %>" <%= value.equals(identifier) ? "selected" : "" %>><%= "("+(String) ht.get("type")+") "+(String) ht.get("identifier")+" - "+((String) ht.get("name")).trim() %></option>
                                                <% }%>
                                        </select>
                                    </td>
                                </tr>  
                                ...
                                <tr>
                                    <td colspan="2" class="Cell" align="center">
                                        <input type="submit" value=" Update Measurement Mapping " > <input type="button" value=" Add New Loinc Code " onclick="javascript:popupStart('300','600','newMeasurementMap.jsp','Add New Loinc Code')">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="Cell" align="center">
