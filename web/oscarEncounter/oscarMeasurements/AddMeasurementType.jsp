...
<head>
<title>
<bean:message key="oscarEncounter.Measurements.msgAddMeasurementType"/>
</title>
<style type="text/css">
   td.nameBox {
...
<!--  -->  
    <html:errors/>
    <html:form action="/oscarEncounter/oscarMeasurements/AddMeasurementType.do" onsubmit="return validateLogonForm(this);">
        ...
        <tr class="MainTableTopRow">
            ...
            <td class="MainTableTopRowRightColumn" width="400">
                <table class="TopStatusBar" >                 
                    <tr>
                        <td ><bean:message key="oscarEncounter.Measurements.msgAddMeasurementType"/></td>                                                
                    </tr>                  
                </table>
            </td>
        </tr>
                                ...
                                <td> 
                                    ...
                                    <tr>
                                        <th align="left" class="td.tite" width="5">
                                            ...
                                            (<bean:message key="oscarEncounter.oscarMeasurements.Measurements.headingMax4Characters"/>)
                                        </th>
