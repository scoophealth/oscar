...
<!--  -->
    <html:errors/>
    <html:form action="/oscarEncounter/oscarMeasurements/DeleteMeasurementTypes">
                            ...
                            <tr>
                                <td>               
                                    ...
                                    <tr class="data">
                                        ...
                                        <td width="300"><bean:write name="measurementType" property="validation" /></td>
                                        <td width="10"><input type="checkbox" name="deleteCheckbox" value="<bean:write name="measurementType" property="id" />"</td>                            
                                    </tr>                        
                                    </logic:iterate>
                                    <tr>
