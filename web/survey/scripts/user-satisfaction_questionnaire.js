...
function validateForm(form,tab) {
	...
	if(tab == 'Page 4') {
		...
		var i4 = parseInt(form.elements['data.value(4_3_4)'].value);
		var i5 = parseInt(form.elements['data.value(4_3_5)'].value);
		var i6 = parseInt(form.elements['data.value(4_3_6)'].value);	
		
		if(isNaN(i1) || isNaN(i2) || isNaN(i3) || isNaN(i4) || isNaN(i5) || isNaN(i6)) {
			alert('Please Enter integer values for question 1');
			return false;
		}
		
		var itotal = i1+i2+i3+i4+i5+i6;
		if(itotal != 100) {
		...
		var q4 = parseInt(form.elements['data.value(4_5_4)'].value);
		var q5 = parseInt(form.elements['data.value(4_5_5)'].value);
		var q6 = parseInt(form.elements['data.value(4_5_6)'].value);	
		
		if(isNaN(q1) || isNaN(q2) || isNaN(q3) || isNaN(q4) || isNaN(q5) || isNaN(q6)) {
			alert('Please Enter integer values for question 3');
			return false;
		}
		
		var qtotal = q1+q2+q3+q4+q5+q6;
		if(qtotal != 100) {
		...
		var o4 = parseInt(form.elements['data.value(4_7_4)'].value);
		var o5 = parseInt(form.elements['data.value(4_7_5)'].value);
		var o6 = parseInt(form.elements['data.value(4_7_6)'].value);	
		var o7 = parseInt(form.elements['data.value(4_7_7)'].value);	
		var o8 = parseInt(form.elements['data.value(4_7_8)'].value);	
		var o9 = parseInt(form.elements['data.value(4_7_9)'].value);	
		
		if(isNaN(o1) || isNaN(o2) || isNaN(o3) || isNaN(o4) || isNaN(o5) || isNaN(o6) || isNaN(o7) || isNaN(o8) || isNaN(o9)) {
			alert('Please Enter integer values for question 5');
			return false;
		}
		
		var ototal = o1+o2+o3+o4+o5+o6+o7+o8+o9;
		if(ototal != 100) {
	...
	if(tab == 'Page 5') {
		...
		var o4 = parseInt(form.elements['data.value(5_1_4)'].value);
		var o5 = parseInt(form.elements['data.value(5_1_5)'].value);
		var o6 = parseInt(form.elements['data.value(5_1_6)'].value);	
		var o7 = parseInt(form.elements['data.value(5_1_7)'].value);	
		var o8 = parseInt(form.elements['data.value(5_1_8)'].value);	
		var o9 = parseInt(form.elements['data.value(5_1_9)'].value);	
		
		if(isNaN(o1) || isNaN(o2) || isNaN(o3) || isNaN(o4) || isNaN(o5) || isNaN(o6) || isNaN(o7) || isNaN(o8) || isNaN(o9)) {
			alert('Please Enter integer values for question 6');
			return false;
		}
		...
		var i4 = parseInt(form.elements['data.value(5_2_4)'].value);
		var i5 = parseInt(form.elements['data.value(5_2_5)'].value);
		var i6 = parseInt(form.elements['data.value(5_2_6)'].value);	
		
		if(isNaN(i1) || isNaN(i2) || isNaN(i3) || isNaN(i4) || isNaN(i5) || isNaN(i6)) {
			alert('Please Enter integer values for question 7');
			return false;
		}
		...
		var q4 = parseInt(form.elements['data.value(5_4_4)'].value);
		var q5 = parseInt(form.elements['data.value(5_4_5)'].value);
		var q6 = parseInt(form.elements['data.value(5_4_6)'].value);	
		
		if(isNaN(q1) || isNaN(q2) || isNaN(q3) || isNaN(q4) || isNaN(q5) || isNaN(q6)) {
			alert('Please Enter integer values for question 9');
			return false;
		}
