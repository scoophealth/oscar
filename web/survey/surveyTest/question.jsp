	...
	<c:choose>
		...
		<c:when test="${question.type.date != null}">
			...
			<td>
				...
				&nbsp;
				<img src="images/calendar.jpg" id="<c:out value="${pageNumber}"/>_<c:out value="${sectionId}"/>_<c:out value="${question.id}"/>_trigger" style="cursor: pointer;" title="Date selector"/>
				<%
