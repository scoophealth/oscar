...
<jsp:useBean id="formHandler" class="org.caisi.tickler.prepared.seaton.consultation.ProcessConsultationBean" scope="request">
...
function generate_tickler() {
	...
	<tr>
		<td class="searchTitle" colspan="4">Prepared Tickler - Process Consultation</td>
	</tr>
</table>
