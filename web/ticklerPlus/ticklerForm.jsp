        ...
        <html:hidden property="tickler.tickler_no"/>
              ...
              <tr>
                      ...
                      <td class="fieldValue">
                      	...
                      	<span onClick="openBrWindow('calendar/oscarCalendarPopup.jsp?type=caisi&openerForm=ticklerForm&amp;openerElement=tickler.serviceDate&amp;year=<%=year %>&amp;month=<%=month %>','','width=300,height=300')"><img border="0" src="images/calendar.jpg"/></span>
                      </td>
              </tr>
              <tr>
                      ...
                      <td class="fieldValue">
                      		...
                      		:
                      		<select name="tickler.service_minute">
                      			<%
                      				for(int x=0;x<60;x+=15) {
	                      				...
	                      				if(val.equals("0")) {val="00";}%>
                      			<option value="<%=val %>" <%=selected %>><%=val%></option>
                      			<%} %>
                      		</select>
                      		&nbsp;
                      		<select name="tickler.service_ampm">
             ...
             <tr>
              ...
              <tr>
              	<td class="fieldValue" colspan="3" align="left">
				        ...
				        <input type="button" class="button" value="Cancel" onclick="location.href='../Tickler.do';"/>
				</td>
