    ...
    <tr> 
        ...
        <td align="left" colspan="3">
            ...
            <select  name="given_consent">
                ...
                <option value="1" <%=getSel(given_consent,"1")%> >Has Given Consent</option>
                <option value="2" <%=getSel(given_consent,"2")%> >Has Refused Consent</option>
            </select>  
            <input type="hidden" name="ethnicityOrig" value="<%=apptMainBean.getString(demoExt.get("given_consent"))%>">
         </td>
