...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
	...
	<tr>
		...
		<td align="left"><input type="text" name="last_name"
			value="<%=apptMainBean.getString(rs,"last_name")%>"></td>
		<td align="right"><b>First Name: </b></td>
		<td align="left"><input type="text" name="first_name"
			value="<%=apptMainBean.getString(rs,"first_name")%>"></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td align="left"><input type="text" name="ext"
			value="<%=apptMainBean.getString(rs,"ext")%>"></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td align="left"><input type="text" name="roster_status"
			value="<%=apptMainBean.getString(rs,"roster_status")%>"></td>
		<td align="right"><b>Patient Status:</b> <b> </b></td>
		<td align="left"><input type="text" name="patient_status"
			value="<%=apptMainBean.getString(rs,"patient_status")%>"></td>
	</tr>
	<tr valign="top">
  ...
  //String temp=null; store appt data
	...
	<tr bgcolor="#486ebd">
		...
		<div align="center"><input type="hidden" name="name"
			value="<%=apptMainBean.getString(rs,"last_name")+","+apptMainBean.getString(rs,"first_name")%>">
		<input type="hidden" name="dboperation" value="update_record">
		<input type="submit" name="displaymode"
			value="Update Record & Back to Appointment"> <!--a href='cppcontrol.jsp?demographic_no=<%=apptMainBean.getString(rs,"demographic_no")%>&displaymode=delete&dboperation=delete'> 
