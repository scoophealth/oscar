...
%>
    <tr> 
        ...
        <td align="left" colspan="3" >
          <input type="text" name="status_number" value="<%=apptMainBean.getString(demoExt.get("status_num"))%>"> 
          <input type="hidden" name="status_numberOrig" value="<%=apptMainBean.getString(demoExt.get("status_num"))%>"> 
         </td>
    </tr>
    ...
    <tr> 
        ...
        <td align="left" >
            ...
            <select  name="ethnicity">
                ...
                <option value="1" <%=getSel(ethnicity,"1")%> >Status On-reserve</option>
                <option value="2" <%=getSel(ethnicity,"2")%> >Status Off-reserve</option>	
                <option value="3" <%=getSel(ethnicity,"3")%>>Non-status on-reserve</option>	
                <option value="4" <%=getSel(ethnicity,"4")%> >Non-status off-reserve</option>	
            ...
            <input type="hidden" name="ethnicityOrig" value="<%=apptMainBean.getString(demoExt.get("ethnicity"))%>">
         </td>
         <td align="right"><b>Area:</b> </td>
      <td align="left">
        <% String area =   apptMainBean.getString(demoExt.get("area")); %>
        <select name="area">
            ...
            <option value="8" <%=getSel(area,"8")%> >North or West Vancouver</option>
            ...
            <option value="12" <%=getSel(area,"12")%> >Out of Country Residents</option>
            <option value="13" <%=getSel(area,"13")%> >Other</option>
        </select>
        <input type="hidden" name="areaOrig" value="<%=apptMainBean.getString(demoExt.get("area"))%>">
      </td>
