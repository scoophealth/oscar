...
<title><%--bean:message key="indivoMessenger.CreateIndivoMessage.title"/--%>
...
<table class="MainTable" id="scrollNumber1" name="encounterTable">
	<tr class="MainTableTopRow">
		<td class="MainTableTopRowLeftColumn"><%-- bean:message key="indivoMessenger.CreateMessage.msgMessenger"/ --%>Create
		Message</td>
	...
	<tr>
						...
						<table class=messButtonsA cellspacing=0 cellpadding=3>
							<tr>
								<td class="messengerButtonsA"><html:link
									action="/phr/PhrMessage.do?method=viewMessages"
						...
						<table class=messButtonsA cellspacing=0 cellpadding=3>
							<tr>
								<td class="messengerButtonsA"><a
									href="javascript:document.forms[0].body.value=''; return false;"
									class="messengerButtons"><bean:message
									key="oscarMessenger.CreateMessage.btnClear" /></a></td>
							</tr>
						</table>
						</td>
						<td>
        ...
        request.setAttribute("fromType",fromType);
					...
					<html:form action="/phr/PhrMessage">
						...
						<tr>
							<td bgcolor="#EEEEFF" valign=top><!--Message and Subject Cell--><c:out
								value="" />
							<table>
								<tr>
									<td align="right">To :</td>
									<td><html-el:text name="to" property="to" size="30"
										value="${toName}" /> <html-el:hidden
										property="recipientOscarId" value="${toId}" /> <html-el:hidden
										property="recipientType" value="${toType}" /></td>
								</tr>
								<tr>
									<td align="right"><bean:message
										key="oscarMessenger.CreateMessage.formSubject" /> :</td>
									<td><html-el:text name="subject" property="subject"
										size="67" value="${subject}" /></td>
								</tr>
								<c:if test="${!empty message}">
									<tr>
										...
										<td><pre
											style="border: 1px solid black; background-color: white;"><c:out
											value="${message.body}" />
                                                            </pre> <html-el:hidden
											property="priorMessageId" value="${message.id}" /></td>
									</tr>

								</c:if>
								<tr>
									<td>&nbsp;</td>
									<td><html:textarea value="" name="body" styleId="message"
										property="body" cols="60" rows="18" /></td>

								</tr>
							</table>

							<html-el:hidden property="demographic" value="${demographicNo}" />
							<html-el:hidden property="method" value="send" /> <input
								type="submit" class="ControlPushButton"
