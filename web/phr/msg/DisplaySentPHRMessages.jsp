				...
				<table cellspacing=3>
					<tr>
						...
						<table class=messButtonsA cellspacing=0 cellpadding=3>
							<tr>
								<td class="messengerButtonsA"><html:link
									page="/phr/PhrMessage.do?method=viewMessages"
						...
						<table class=messButtonsA cellspacing=0 cellpadding=3>
							<tr>
								<td class="messengerButtonsA"><a
									href="javascript:window.close()" class="messengerButtons">Exit
								MyOscar Messenges</a></td>
							</tr>
						</table>
						</td>
						...
						<logic:present name="<%=PHRAuthentication.SESSION_PHR_AUTH%>">
							...
							<center><a
								href="javascript: document.forms['phrLogout'].submit()">Logout</a></center>
							</form>
							</div>
							</td>
