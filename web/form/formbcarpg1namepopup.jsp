...
<table border="0" cellspacing="0" cellpadding="0" width="100%" >
  <tr bgcolor="<%=deepcolor%>"><th><font face="Helvetica">Provider List</font></th>
  </tr><tr>
...
<TH align="center" width="50%" nowrap><a href="formbcarpg1namepopup.jsp?orderby=first_name">First Name</a></TH>
<TH align="center" width="50%"><a href="formbcarpg1namepopup.jsp?orderby=last_name">Last Name</a></TH>
</tr>
<%
  int nItems=0;
...
<%
  ...
  if(nLastPage>=0) {
%>
<a href="formbcarpg1namepopup.jsp?limit1=<%=nLastPage%>&limit2=<%=strLimit2%>"><bean:message key="report.reportnewdblist.msgLastPage"/></a> |
<%
  }
  if(nItems==Integer.parseInt(strLimit2)) {
%>
<a href="formbcarpg1namepopup.jsp?limit1=<%=nNextPage%>&limit2=<%=strLimit2%>"> <bean:message key="report.reportnewdblist.msgNextPage"/></a>
<%
}
%>
</body>
