...
<table class="Head" width="100%" class="hidePrint">
    <tr>
        <td align="left">
		  ...
		  <a href="dmdata.jsp?demographic_no=<%=demoNo%>">View Data</a> | 
		  <a href="dm2ping.jsp?demographic_no=<%=demoNo%>">Send to PING</a>
		</td>
    </tr>
</table>
...
<table border="0" cellspacing="3" cellpadding="0" width="100%">
    <tr>
        <th align=CENTER colspan="4" bgcolor="#CCCCFF">TYPE 2 DIABETES RECORD</th>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
