...
<body bgproperties="fixed" class="Type2DiabetesForm" bgcolor="#EEEEFF" onLoad="javascript:window.focus()" topmargin="0" leftmargin="0" rightmargin="0">
...
<table class="Head" class="hidePrint">
    <tr>
        <td align="left">
		  ...
		  <!--a href="diabetetrackercontact.jsp?demographic_no=<%=demoNo%>">Contact</a> | 
		  <a href="diabetetracker.jsp?demographic_no=<%=demoNo%>">Diabete Tracker</a-->
		  <a href=# onclick="popupPage(390,510,'redirectstudysite.jsp?demographic_no=<%=demoNo%>&study_no=<%=studyId%>');return false;">Diabete Tracker</a>
		</td>
    </tr>
</table>
...
<table border="1" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td><input type="text" class="Type2DiabetesTextarea" name="weight4" value="<%= props.getProperty("weight4", "") %>" /></td>
    ...
    <tr>
        ...
        <td><input type="text" class="Type2DiabetesTextarea" name="bp4" value="<%= props.getProperty("bp4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="bp5" value="<%= props.getProperty("bp5", "") %>" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="renal1"><%= props.getProperty("renal1", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="renal2"><%= props.getProperty("renal2", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="renal3"><%= props.getProperty("renal3", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="renal4"><%= props.getProperty("renal4", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="renal5"><%= props.getProperty("renal5", "") %></textarea></td>
    </tr>
    <tr>
        <td align="left">
    ...
    <tr>
        ...
        <td><textarea style="height:42px;" class="Type2DiabetesTextarea" name="eyes2"><%= props.getProperty("eyes2", "") %></textarea></td>
        <td><textarea style="height:42px;" class="Type2DiabetesTextarea" name="eyes3"><%= props.getProperty("eyes3", "") %></textarea></td>
        <td><textarea style="height:42px;" class="Type2DiabetesTextarea" name="eyes4"><%= props.getProperty("eyes4", "") %></textarea></td>
        <td><textarea style="height:42px;" class="Type2DiabetesTextarea" name="eyes5"><%= props.getProperty("eyes5", "") %></textarea></td>
    </tr>
    <tr>
        <td align="left">
        ...
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="feet1"><%= props.getProperty("feet1", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="feet2"><%= props.getProperty("feet2", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="feet3"><%= props.getProperty("feet3", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="feet4"><%= props.getProperty("feet4", "") %></textarea></td>
        <td><textarea style="height:50px;" class="Type2DiabetesTextarea" name="feet5"><%= props.getProperty("feet5", "") %></textarea></td>
    </tr>
    <tr>
        <td>
            <table width="100%">
        ...
        <td><textarea style="height:120px;" class="Type2DiabetesTextarea" name="meds1"><%= props.getProperty("meds1", "") %></textarea></td>
        <td><textarea style="height:120px;" class="Type2DiabetesTextarea" name="meds2"><%= props.getProperty("meds2", "") %></textarea></td>
        <td><textarea style="height:120px;" class="Type2DiabetesTextarea" name="meds3"><%= props.getProperty("meds3", "") %></textarea></td>
        <td><textarea style="height:120px;" class="Type2DiabetesTextarea" name="meds4"><%= props.getProperty("meds4", "") %></textarea></td>
    ...
    <tr>
        ...
        <td><input type="text" class="Type2DiabetesTextarea" name="lifestyle4" value="<%= props.getProperty("lifestyle4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="lifestyle5" value="<%= props.getProperty("lifestyle5", "") %>" /></td>
    </tr>
    <tr>
        ...
        <td><input type="text" class="Type2DiabetesTextarea" name="exercise3" value="<%= props.getProperty("exercise3", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="exercise4" value="<%= props.getProperty("exercise4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="exercise5" value="<%= props.getProperty("exercise5", "") %>" /></td>
    </tr>
    <tr>
        <td style="padding-left:60px;"  align="left">
            Alcohol
        </td>
        <td><input type="text" class="Type2DiabetesTextarea" name="alcohol1" value="<%= props.getProperty("alcohol1", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="alcohol2" value="<%= props.getProperty("alcohol2", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="alcohol3" value="<%= props.getProperty("alcohol3", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="alcohol4" value="<%= props.getProperty("alcohol4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="alcohol5" value="<%= props.getProperty("alcohol5", "") %>" /></td>
    </tr>
    <tr>
        <td style="padding-left:60px;"  align="left">
            Sexual Function
    ...
    <tr>
        ...
        <td><input type="text" class="Type2DiabetesTextarea" name="diet1" value="<%= props.getProperty("diet1", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="diet2" value="<%= props.getProperty("diet2", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="diet3" value="<%= props.getProperty("diet3", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="diet4" value="<%= props.getProperty("diet4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="diet5" value="<%= props.getProperty("diet5", "") %>" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <td rowspan="1">
            <table>
                <tr>
                    <td>Consultant:</td>
                    <td><input type="text" class="Type2DiabetesInput" name="consultant" value="<%= props.getProperty("consultant", "") %>" /></td>
                </tr>
                <tr>
                    <td>Diabetic Educator:</td>
                    <td><input type="text" class="Type2DiabetesInput" name="educator" value="<%= props.getProperty("educator", "") %>" /></td>
                </tr>
                <tr>
                    <td>Nutritionist:</td>
                    <td><input type="text" class="Type2DiabetesInput" name="nutritionist" value="<%= props.getProperty("nutritionist", "") %>" /></td>
                </tr>
            </table>
        </td>
        <td><textarea style="height:75px;" class="Type2DiabetesTextarea" name="cdn1"><%= props.getProperty("cdn1", "") %></textarea></td>
        <td><textarea style="height:75px;" class="Type2DiabetesTextarea" name="cdn2"><%= props.getProperty("cdn2", "") %></textarea></td>
        <td><textarea style="height:75px;" class="Type2DiabetesTextarea" name="cdn3"><%= props.getProperty("cdn3", "") %></textarea></td>
        <td><textarea style="height:75px;" class="Type2DiabetesTextarea" name="cdn4"><%= props.getProperty("cdn4", "") %></textarea></td>
        <td><textarea style="height:75px;" class="Type2DiabetesTextarea" name="cdn5"><%= props.getProperty("cdn5", "") %></textarea></td>
    </tr>
    <tr>
        <td>Initials</td>
        <td><input type="text" class="Type2DiabetesTextarea" name="initials1" value="<%= props.getProperty("initials1", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="initials2" value="<%= props.getProperty("initials2", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="initials3" value="<%= props.getProperty("initials3", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="initials4" value="<%= props.getProperty("initials4", "") %>" /></td>
        <td><input type="text" class="Type2DiabetesTextarea" name="initials5" value="<%= props.getProperty("initials5", "") %>" /></td>
    </tr>
    <tr class="Type2DiabetesFooter">
        ...
        <td colspan="3" align="right">
            <table class="TableWithBorder" bordercolor="#000000" width="100%">
                ...
                <tr>
                    <td>
                        <input type="checkbox" name="resource1" <%= props.getProperty("resource1", "") %> />
                        Things You Should Know About Diabetes-Type2
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="checkbox" name="resource2" <%= props.getProperty("resource2", "") %> />
