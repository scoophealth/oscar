...
<div ID="Langdiv" class="demo">
    <table bgcolor='silver' width='100%'>
        ...
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Tamil','pg1_langPref', 'Langdiv'); return false;">Tamil</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Other','pg1_langPref', 'Langdiv'); return false;">Other</a></td></tr>
    </table>
</div>
...
<div ID="Hospdiv" class="demo4">
    <table bgcolor='silver' width='100%'>
        <tr><td align='right'><a href="javascript: function myFunction() {return false; }" onclick="showHideBox('Hospdiv',0); return false;">X</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('BCWH','c_hospital', 'Hospdiv'); return false;">BCWH</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('SPH','c_hospital', 'Hospdiv'); return false;">SPH</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('LGH','c_hospital', 'Hospdiv'); return false;">LGH</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('RCH','c_hospital', 'Hospdiv'); return false;">RCH</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('RGH','c_hospital', 'Hospdiv'); return false;">RGH</a></td></tr>               
    </table>
</div>
<div ID="Contradiv" class="demo5">
    <table bgcolor='silver' width='100%'>
        <tr><td align='right'><a href="javascript: function myFunction() {return false; }" onclick="showHideBox('Contradiv',0); return false;">X</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Nothing','pg1_contrMethod', 'Contradiv'); return false;">Nothing</a></td></tr>
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Condom','pg1_contrMethod', 'Contradiv'); return false;">Condom</a></td></tr>             
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('OCP','pg1_contrMethod', 'Contradiv'); return false;">OCP</a></td></tr>             
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Diaphragm','pg1_contrMethod', 'Contradiv'); return false;">Diaphragm</a></td></tr>             
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('IUD','pg1_contrMethod', 'Contradiv'); return false;">IUD</a></td></tr>             
        <tr><td><a href="javascript: function myFunction() {return false; }" onclick="insertBox('Other','pg1_contrMethod', 'Contradiv'); return false;">Other</a></td></tr>             
    </table>
</div>
    ...
    <tr><td width="60%">
            ...
            <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    British Columbia Antenatal Record Part 1 <font size="-2">BCPHP (HLTH) 1582-1 Rev. 2007/06/05</font></th>
                </tr>
            </table>
            ...
            <table width="100%" border="1"  cellspacing="0" cellpadding="0">
                <tr>
                    <td width="30%"><b>1.</b> Hospital<br>
                        <input type="text" name="c_hospital" id="c_hospital" class="spe" onDblClick="showHideBox('Hospdiv',1);" <%=oscarVariables.getProperty("BCAR_hospital")==null? " ": ("class=\"spe\" onDblClick='showDef(\""+oscarVariables.getProperty("BCAR_hospital")+"\", this);'") %> style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("c_hospital", "") %>" @oscar.formDB />
                           </td>
                    <td width="33%"><a href="javascript: function myFunction() {return false; }" onClick="popupFixedPage(600, 300, 'formbcarpg1namepopup.jsp'); return false;">Attending Physician/Midwife</a><br>
                        <input type="text" name="pg1_priCare" style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("pg1_priCare", "") %>" @oscar.formDB />
                           </td><td colspan="2">Referring Physician/Midwife<br>
                        <input type="text" name="pg1_famPhy" style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("pg1_famPhy", "") %>" @oscar.formDB />
                           </td>
                </tr><tr>
                    <td colspan='2' valign="bottom">Mother's Name
                    ...
                    <td width="20%">Date of Birth<br>dd/mm/yyyy
                        <input type="text" name="pg1_dateOfBirth" id="pg1_dateOfBirth" style="width:100%" size="10" maxlength="10" value="<%= props.getProperty("pg1_dateOfBirth", "") %>" @oscar.formDB dbType="date" />
                           </td>
                    <td valign="bottom">Age at EDD<br>
                        <input type="text" name="pg1_ageAtEDD" id="pg1_ageAtEDD" style="width:100%" class="spe" ondblclick="calcAgeAtEDD()" size="2" maxlength="2" value="<%= props.getProperty("pg1_ageAtEDD", "") %>" @oscar.formDB  />
                           </td>
                </tr>
            </table>
            ...
            <table width="100%" border="1"  cellspacing="0" cellpadding="0">
                <tr>
                    <td>Occupation<br>
                        <input type="text" name="pg1_work" size="25" maxlength="25" value="<%= props.getProperty("pg1_work", "") %>" @oscar.formDB />
                           </td>
                    <td>Work hrs/day<br>
            ...
            <table width="100%" border="1"  cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%" valign="bottom">Partner's Name<br>
                        <input type="text" name="pg1_partnerName" style="width:100%" size="20" maxlength="60" value="<%= props.getProperty("pg1_partnerName", "") %>" @oscar.formDB  />
                           </td>
                    <td width="5%" valign="bottom">Age
                    ...
                    <td valign="bottom"><span class="small9">Ethnic Origin of<br>Newborn's Father</span>
                        <input type="text" name="pg1_faEthOrig" id="pg1_faEthOrig" class="spe" onDblClick="showHideBox('Origdiv1',1);" style="width:100%" size="20" maxlength="50" value="<%= props.getProperty("pg1_faEthOrig", "") %>" @oscar.formDB  />
                           </td>
                    <td valign="bottom">Partner's Work:<br>
                        <input type="text" name="pg1_ptWork" size="20" maxlength="40" value="<%= props.getProperty("pg1_ptWork", "") %>" @oscar.formDB />
                           </td>
                </tr>
            </table>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="bottom"> Beliefs & Practices
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td colspan="6"><b>3. Obstetrical History 
            G</b><span class="small8">ravida</span> <input type="text" name="pg1_gravida" style="width: 30px;" size="2" maxlength="4" value="<%= props.getProperty("pg1_gravida", "") %>" @oscar.formDB />
                                                           ...
                                                           <b>P</b><span class="small8">reterm</span> <input type="text" name="pg1_preterm" style="width: 30px;" size="2" maxlength="4" value="<%= props.getProperty("pg1_preterm", "") %>" @oscar.formDB /> 
                                                              <b>A</b><span class="small8">bortion</span> <input type="text" name="pg1_abortion" style="width: 30px;" size="2" maxlength="3" value="<%= props.getProperty("pg1_abortion", "") %>" @oscar.formDB />  
                                                               ( <span class="small8">Induced</span> <input type="text" name="pg1_induced" style="width: 30px;" size="2" maxlength="3" value="<%= props.getProperty("pg1_induced", "") %>" @oscar.formDB />
                                                         <span class="small8">Spontaneous</span> <input type="text" name="pg1_spontaneous" style="width: 30px;" size="2" maxlength="3" value="<%= props.getProperty("pg1_spontaneous", "") %>" @oscar.formDB /> )
        ...
        <th width="6%">Date</th>
        <th width="12%">Place of birth/<br>abortion</th>
        <th width="6%">Hrs. in<br>labour</th>
        <th width="5%">Gest.<br>age</th>
        <th width="12%">Type of<br>birth</th>
        
        <th width="33%">Perinatal Complications</th>
        <th width="3%">Sex</th>
        <th width="12%">Birth<br>weight</th>
        ...
        <td>
            <input type="text" name="pg1_deliType1" class="spe" onDblClick="showDeliBox('Delidiv',1, this, event);" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_deliType1", "") %>" @oscar.formDB />
               </td>
        ...
        <td>
            <input type="text" name="pg1_birthWeit1" id="pg1_birthWeit1" size="4" maxlength="8" value="<%= props.getProperty("pg1_birthWeit1", "") %>" @oscar.formDB />
                   <select name="pg1_birthWeitUnits1" onchange="convertWeightUnits(pg1_birthWeit1, pg1_birthWeitUnits1.value);">
                <option value="kg" <%=props.getProperty("pg1_birthWeitUnits1", "").equalsIgnoreCase("kg")?"selected":""%> >kg</option>
                <option value="lbs" <%=props.getProperty("pg1_birthWeitUnits1", "").equalsIgnoreCase("lbs")?"selected":""%> >lbs</option>
            </select>
        </td>
        <td>
            <input type="text" name="pg1_presHealth1" class="spe" onDblClick='showDef("A&W", this);' style="width:100%" size="6" maxlength="8" value="<%= props.getProperty("pg1_presHealth1", "") %>" @oscar.formDB />
               </td>
    </tr><tr>
        <td>
        ...
        <td>
            <input type="text" name="pg1_deliType2" class="spe" onDblClick="showDeliBox('Delidiv',1, this, event);" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_deliType2", "") %>" @oscar.formDB />
               </td>
        ...
        <td>
            <input type="text" name="pg1_birthWeit2" size="4" maxlength="8" value="<%= props.getProperty("pg1_birthWeit2", "") %>" @oscar.formDB />
                   <select name="pg1_birthWeitUnits2"  onchange="convertWeightUnits(pg1_birthWeit2, pg1_birthWeitUnits2.value);">
                <option value="kg" <%=props.getProperty("pg1_birthWeitUnits2", "").equalsIgnoreCase("kg")?"selected":""%> >kg</option>
                <option value="lbs" <%=props.getProperty("pg1_birthWeitUnits2", "").equalsIgnoreCase("lbs")?"selected":""%> >lbs</option>
            </select>
        </td>
        <td>
            <input type="text" name="pg1_presHealth2" class="spe" onDblClick='showDef("A&W", this);' style="width:100%" size="6" maxlength="8" value="<%= props.getProperty("pg1_presHealth2", "") %>" @oscar.formDB />
               </td>
    </tr><tr>
        <td>
        ...
        <td>
            <input type="text" name="pg1_deliType3" class="spe" onDblClick="showDeliBox('Delidiv',1, this, event);" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_deliType3", "") %>" @oscar.formDB />
               </td>
        ...
        <td>
            <input type="text" name="pg1_birthWeit3" size="4" maxlength="8" value="<%= props.getProperty("pg1_birthWeit3", "") %>" @oscar.formDB />
                   <select name="pg1_birthWeitUnits3" onchange="convertWeightUnits(pg1_birthWeit3, pg1_birthWeitUnits3.value);">
                <option value="kg" <%=props.getProperty("pg1_birthWeitUnits3", "").equalsIgnoreCase("kg")?"selected":""%> >kg</option>
                <option value="lbs" <%=props.getProperty("pg1_birthWeitUnits3", "").equalsIgnoreCase("lbs")?"selected":""%> >lbs</option>
            </select>
        </td>
        <td>
            <input type="text" name="pg1_presHealth3" class="spe" onDblClick='showDef("A&W", this);' style="width:100%" size="6" maxlength="8" value="<%= props.getProperty("pg1_presHealth3", "") %>" @oscar.formDB />
               </td>
    </tr><tr>
        <td>
        ...
        <td>
            <input type="text" name="pg1_deliType4" class="spe" onDblClick="showDeliBox('Delidiv',1, this, event);" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_deliType4", "") %>" @oscar.formDB />
               </td>
        ...
        <td>
            <input type="text" name="pg1_birthWeit4" size="4" maxlength="8" value="<%= props.getProperty("pg1_birthWeit4", "") %>" @oscar.formDB />
                   <select name="pg1_birthWeitUnits4" onchange="convertWeightUnits(pg1_birthWeit4, pg1_birthWeitUnits4.value);">
                <option value="kg" <%=props.getProperty("pg1_birthWeitUnits4", "").equalsIgnoreCase("kg")?"selected":""%> >kg</option>
                <option value="lbs" <%=props.getProperty("pg1_birthWeitUnits4", "").equalsIgnoreCase("lbs")?"selected":""%> >lbs</option>
            </select>
        </td>
        <td>
            <input type="text" name="pg1_presHealth4" class="spe" onDblClick='showDef("A&W", this);' style="width:100%" size="6" maxlength="8" value="<%= props.getProperty("pg1_presHealth4", "") %>" @oscar.formDB />
               </td>
    </tr><tr>
        <td>
        ...
        <td>
            <input type="text" name="pg1_deliType5" class="spe" onDblClick="showDeliBox('Delidiv',1, this, event);" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_deliType5", "") %>" @oscar.formDB />
               </td>
        ...
        <td>
            <input type="text" name="pg1_birthWeit5" size="4" maxlength="8" value="<%= props.getProperty("pg1_birthWeit5", "") %>" @oscar.formDB />
                   <select name="pg1_birthWeitUnits5" onchange="convertWeightUnits(pg1_birthWeit5, pg1_birthWeitUnits5.value);">
                <option value="kg" <%=props.getProperty("pg1_birthWeitUnits5", "").equalsIgnoreCase("kg")?"selected":""%> >kg</option>
                <option value="lbs" <%=props.getProperty("pg1_birthWeitUnits5", "").equalsIgnoreCase("lbs")?"selected":""%> >lbs</option>
            </select>
        </td>
        <td>
            <input type="text" name="pg1_presHealth5" class="spe" onDblClick='showDef("A&W", this);' style="width:100%" size="6" maxlength="8" value="<%= props.getProperty("pg1_presHealth5", "") %>" @oscar.formDB />
               </td>
    </tr>
</table>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td ><b>4.</b> LMP <img src="../images/cal.gif" id="pg1_lmp_cal"><br> dd/mm/yyyy<br>
        ...
        <td>
            <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                <tr><td width="30%" valign="bottom">Contraception Method: <br>
                        <input type="text" name="pg1_contrMethod" id="pg1_contrMethod" class="spe" onDblClick="showHideBox('Contradiv',1);" style="width:100%" size="12" maxlength="15" value="<%= props.getProperty("pg1_contrMethod", "") %>" @oscar.formDB />
                           </td><td width="30%">When Stopped:<br>
        ...
        <td>Confirmed EDD <img src="../images/cal.gif" id="pg1_eddByUs_cal"><br> dd/mm/yyyy<br>
            <input type="text" name="pg1_eddByUs" id="pg1_eddByUs" size="10" maxlength="10" value="<%= props.getProperty("pg1_eddByUs", "") %>" @oscar.formDB dbType="date"/
            <input type="checkbox" name="pg1_eddByUsPerf" <%= props.getProperty("pg1_eddByUsPerf", "") %>  @oscar.formDB dbType="tinyint(1)"/>US performed
            <input type="text" name="pg1_eddByUsGestWks" style="width:20px;" maxlength="2" value="<%= props.getProperty("pg1_eddByUsGestWks", "") %>" @oscar.formDB />Gest wks.
            <input type="text" name="pg1_eddByUsGestDays" style="width:20px;" maxlength="2" value="<%= props.getProperty("pg1_eddByUsGestDays", "") %>" @oscar.formDB />days
        </td>
    </tr>
</table>
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
                    ...
                    <td>
                        ...
                        <table class="shrinkMe"  width="100%" border="0"  cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1%">
                                    <input type="checkbox" name="pg1_IVFpregnancy" <%= props.getProperty("pg1_IVFpregnancy", "") %>  @oscar.formDB dbType="tinyint(1)"/>
                                       </td>
                                <td width="30%"><span class="small9">IVF Pregnancy</span></td>
                                <td>
                                    <input type="text" name="pg1_IVFpregnancySpec" style="width:100%" size="30" maxlength="30" value="<%= props.getProperty("pg1_IVFpregnancySpec", "") %>" @oscar.formDB />
                                       </td>
                            </tr><tr>
                                <td>
        ...
        <td width="33%" valign="top">
            ...
            <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <textarea name="pg1_operationSpec" style="width:100%" cols="60" rows="1" @oscar.formDB  dbType="varchar(255)" ><%= props.getProperty("pg1_operationSpec", "") %></textarea>
                    </td>
                </tr><tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                    <input type="checkbox" name="pg1_uterineCxProc" <%= props.getProperty("pg1_uterineCxProc", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                    <td><span class="small8">Uterine/Cx procedure</span></td>
                    <td>
                        <input type="text" name="pg1_uterineCxProcSpec" style="width:100%" size="40" maxlength="40" value="<%= props.getProperty("pg1_uterineCxProcSpec", "") %>" @oscar.formDB />
                           </td>
                </tr><tr>
                    <td valign="top">
                    ...
                    <td>
                        <input type="text" name="pg1_cvOrRespSpec" style="width:100%" size="40" maxlength="40" value="<%= props.getProperty("pg1_cvOrRespSpec", "") %>" @oscar.formDB />
                           </td>
                    </td>
                </tr><tr>
                    <td valign="top">
                    ...
                    <td>
                        <textarea name="pg1_deprPsySpec" style="width:100%" cols="60" rows="1" @oscar.formDB  dbType="varchar(255)" ><%= props.getProperty("pg1_deprPsySpec", "") %></textarea>
                </tr><tr>
                    <td></td>
                    ...
                    <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                        <tr>
                            <td valign="top" width="1%">
                                <input type="checkbox" name="pg1_hxAnxiety" <%= props.getProperty("pg1_hxAnxiety", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">Anxiety</span>
                            </td>
                            <td valign="top" width="1%">
                                <input type="checkbox" name="pg1_hxDepr" <%= props.getProperty("pg1_hxDepr", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">Depression</span>
                            </td>
                            <td valign="top" width="1%">
                                <input type="checkbox" name="pg1_hxBipolar" <%= props.getProperty("pg1_hxBipolar", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">Bipolar</span>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <input type="checkbox" name="pg1_hxPPDepr" <%= props.getProperty("pg1_hxPPDepr", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">PP depression</span>
                            </td>
                            <td valign="top" >
                                <input type="checkbox" name="pg1_hxUnknown" <%= props.getProperty("pg1_hxUnknown", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">Unknown</span>
                            </td>
                            <td valign="top">
                                <input type="checkbox" name="pg1_hxOther" <%= props.getProperty("pg1_hxOther", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </td>
                            <td>
                                <span class="small8">Other</span>
                            </td>
                        </tr>
                    </table>
                    </td>
                    ...
                    <td>
                        ...
                        <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><input type="text" name="pg1_nutritionSpec" style="width:100%" size="32" maxlength="40" value="<%= props.getProperty("pg1_nutritionSpec", "") %>" @oscar.formDB />
                                       </td>
                                <td width="1%" align="right"><input type="checkbox" name="pg1_nutritionRef" <%= props.getProperty("pg1_nutritionRef", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </tr><tr>
                                ...
                                <td><input type="text" name="pg1_foliAcidSpec" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_foliAcidSpec", "") %>" @oscar.formDB /></td>
                                <td align="right"><input type="checkbox" name="pg1_foliAcidRef" <%= props.getProperty("pg1_foliAcidRef", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </tr><tr>
                                <td><input type="checkbox" name="pg1_stpWrkDate" <%= props.getProperty("pg1_stpWrkDate", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                                <td><span class="small8">Physical activity /<br>rest / stop work date</span></td>
                                <td><input type="text" name="pg1_stpWrkDateSpec" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("pg1_stpWrkDateSpec", "") %>" @oscar.formDB /></td>
                                <td align="right"><input type="checkbox" name="pg1_stpWrkDateRef" <%= props.getProperty("pg1_stpWrkDateRef", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </tr><tr>
                                ...
                                <td><input type="text" name="pg1_drugSpec" style="width:100%" size="22" maxlength="28" value="<%= props.getProperty("pg1_drugSpec", "") %>" @oscar.formDB /></td>
                                <td align="right"><input type="checkbox" name="pg1_drugRef" <%= props.getProperty("pg1_drugRef", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                            </tr><tr>
                                <td colspan="3">
                                    <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td colspan="3"></td>
                                            <td><span class="small8">dd/mm/yyyy</span><img src="../images/cal.gif" id="pg1_alcoQuitDate_cal"></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="pg1_alco" <%= props.getProperty("pg1_alco", "") %>  @oscar.formDB dbType="tinyint(1)"/><span class="small8">Alcohol</span></td>
                                            <td><input type="checkbox" name="pg1_alcoNever" <%= props.getProperty("pg1_alcoNever", "") %>  @oscar.formDB dbType="tinyint(1)"/><span class="small8">never</span></td>
                                            <td><input type="checkbox" name="pg1_alcoQuit" <%= props.getProperty("pg1_alcoQuit", "") %>  @oscar.formDB dbType="tinyint(1)"/><span class="small8">quit</span></td>
                                            <td><input type="text" name="pg1_alcoQuitDate" id="pg1_alcoQuitDate" style="width:100%" size="10" maxlength="10" value="<%= props.getProperty("pg1_alcoQuitDate", "") %>" @oscar.formDB dbType="date" /></td>
                                        </tr>
                                    </table>
                                </td>
                                <td></td>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="3"><span class="small8">Drinks/wk: before pregnancy</span>
                                    <input type="text" name="pg1_alcoBef" size="2" maxlength="5" value="<%= props.getProperty("pg1_alcoBef", "") %>" @oscar.formDB />
                                    <span class="small8">current</span><input type="text" name="pg1_alcoCurr" size="2" maxlength="5" value="<%= props.getProperty("pg1_alcoCurr", "") %>" @oscar.formDB />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="3"><span class="small8">Binge drinking</span>
                                    <input type="checkbox" name="pg1_alcoBingeNo" <%= props.getProperty("pg1_alcoBingeNo", "") %>  @oscar.formDB dbType="tinyint(1)"/><span class="small8">no</span>
                                    <input type="checkbox" name="pg1_alcoBingeYes" <%= props.getProperty("pg1_alcoBingeYes", "") %>  @oscar.formDB dbType="tinyint(1)"/><span class="small8">yes</span>
                                </td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="pg1_tweak" <%= props.getProperty("pg1_tweak", "") %>  @oscar.formDB dbType="tinyint(1)"/></td>
                                <td><span class="small8">TWEAK score</span></td>
                                <td><input type="text" name="pg1_tweakScore" style="width:100%" size="15" maxlength="15" value="<%= props.getProperty("pg1_tweakScore", "") %>" @oscar.formDB /></td>
                                <td></td>
                            </tr><tr>
                                ...
                                <td>
                                    <input type="checkbox" name="pg1_subUseNo" <%= props.getProperty("pg1_subUseNo", "") %><span class="small8">no</span>
                                    <input type="checkbox" name="pg1_subUseYes" <%= props.getProperty("pg1_subUseYes", "") %><span class="small8">yes</span>
                                </td>
                                <td></td>
                            </tr><tr>
                                <td></td>
...
<table class="Head" class="hidePrint">
    <tr>
        ...
        <td align="right"><b>View:</b> 
            <a href="javascript: popupPage('formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2 <font size=-2>(pg.1)</font></a> |
            <a href="javascript: popupPage('formbcar2007pg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2 <font size=-2>(pg.2)</font></a>
            &nbsp;
        </td>
        <td align="right"><b>Edit:</b>AR1 |
            <a href="formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2 <font size=-2>(pg.1)</font></a> |
