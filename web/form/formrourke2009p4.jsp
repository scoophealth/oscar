		...
		<tr align="center">
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_bottle18mNo"
						name="p4_bottle18mNo" onclick="onCheck(this,'p4_bottle18m')"
						<%= props.getProperty("p4_bottle18mNo", "") %>></td>
					<td><bean:message
					...
					<td class="edcol" colspan="3" valign="top"><input
						...
						onclick="del('p4_breastFeeding18mOk,p4_breastFeeding18mNo,p4_homoMilk15mOk,p4_homoMilk15mNo,p4_bottle18mOk,p4_bottle18mNo');" /></td>
                                </tr>
			</table>
			</td>
			<td colspan="3" valign="top">
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_lowerfatdiet24mNo"
						name="p4_lowerfatdiet24mNo" onclick="onCheck(this,'p4_lowerfatdiet24m')"
						<%= props.getProperty("p4_lowerfatdiet24mNo", "") %>></td>
				...
				<tr>
					...
					<td class="edcol" colspan="3" valign="top"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_homo2percent24mOk,p4_homo2percent24mNo,p4_lowerfatdiet24mOk,p4_lowerfatdiet24mNo,p4_foodguide24mOk,p4_foodguide24mNo');" /></td>
                                </tr>
			</table>
			</td>
			...
			<table cellpadding="0" cellspacing="0" width="100%" height="100%">
				...
				<tr>
					...
					<td class="edcol" colspan="3" valign="top"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_2pMilk48mOk,p4_2pMilk48mNo,p4_foodguide48mOk,p4_foodguide48mNo');" /></td>
                                </tr>
			</table>
			</td>
		</tr>
		<tr>
			...
			<table style="font-size: 8pt;" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_weanPacifier18mNo"
						name="p4_weanPacifier18mNo" onclick="onCheck(this,'p4_weanPacifier18m')"
						<%= props.getProperty("p4_weanPacifier18mNo", "") %>></td>
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_encourageReading18mNo"
						name="p4_encourageReading18mNo" onclick="onCheck(this,'p4_encourageReading18m')"
						<%= props.getProperty("p4_encourageReading18mNo", "") %>></td>
					<td valign="top"><b><i><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote2" />')"
						onMouseOut="hideLayer()"><bean:message
				...
				<tr>
					<td class="edcol" colspan="3" valign="top"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_socializing18mOk,p4_socializing18mNo,p4_weanPacifier18mOk,p4_weanPacifier18mNo,p4_dentalCareOk,p4_dentalCareNo,p4_toiletLearning18mOk,p4_toiletLearning18mNo,p4_encourageReading18mOk,p4_encourageReading18mNo');" /></td>
				</tr>
			</table>
			</td>
			...
			<table style="font-size: 8pt;" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_noPacifier24mNo"
						name="p4_noPacifier24mNo"
						onclick="onCheck(this,'p4_noPacifier24m')"
						<%= props.getProperty("p4_noPacifier24mNo", "") %>></td>
					<td valign="top"><i><a
						href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
				...
				<tr>
					...
					<td valign="top"><input type="radio"
						id="p4_noCough24mNo" name="p4_noCough24mNo"
						onclick="onCheck(this,'p4_noCough24m')"
						<%= props.getProperty("p4_noCough24mNo", "") %>></td>
					<td valign="top"><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
				...
				<tr>
					...
					<td class="edcol" colspan="3" valign="top"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_readingOk,p4_readingNo,p4_noCough24mOk,p4_noCough24mNo,p4_noPacifier24mOk,p4_noPacifier24mNo');" /></td>
				</tr>
				<tr>
					<td colspan="9">&nbsp;</td>
				</tr>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_otherChildrenNo"
						name="p4_otherChildrenNo" onclick="onCheck(this,'p4_otherChildren')"
						<%= props.getProperty("p4_otherChildrenNo", "") %>></td>
					<td valign="top"><bean:message
				...
				<tr>
					<td valign="top" class="edcol" colspan="2"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_manageableOk,p4_manageableNo,p4_otherChildrenOk,p4_otherChildrenNo,p4_soothabilityOk,p4_soothabilityNo,p4_comfortOk,p4_comfortNo');" /></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_points2bodyNo"
						name="p4_pointsNo" onclick="onCheck(this,'p4_points2body')"
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_points2wantNo"
						name="p4_points2wantNo" onclick="onCheck(this,'p4_points2want')"
						<%= props.getProperty("p4_points2wantNo", "") %>></td>
					<td valign="top"><bean:message
					...
					<td valign="top"><input type="radio" id="p4_looks4toyNo"
						name="p4_looks4toyNo" onclick="onCheck(this,'p4_looks4toy')"
						<%= props.getProperty("p4_looks4toyNo", "") %>></td>
					<td valign="top"><bean:message
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_says20wordsNo"
						name="p4_says20wordsNo" onclick="onCheck(this,'p4_says20words')"
						<%= props.getProperty("p4_says20wordsNo", "") %>></td>
					<td valign="top"><bean:message
				...
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_4consonantsNo"
						name="p4_4consonantsNo" onclick="onCheck(this,'p4_4consonants')"
						<%= props.getProperty("p4_4consonantsNo", "") %>></td>
					<td valign="top"><bean:message
				...
				<tr>
					<td valign="top" class="edcol" colspan="2"><input
						class="delete" type="button" value="Del"
						onclick="del('p4_pointsOk,p4_pointsNo,p4_getAttnOk,p4_getAttnNo,p4_looks4toyOk,p4_looks4toyNo,p4_recsNameOk,p4_recsNameNo,p4_says20wordsOk,p4_says20wordsNo,p4_initSpeechOk,p4_initSpeechNo,p4_4consonantsOk,p4_4consonantsNo,p4_points2wantOk,p4_points2wantNo');" /></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_one2stepdirectionsNo"
								name="p4_one2stepdirectionsNo" onclick="onCheck(this,'p4_one2stepdirections')"
								<%= props.getProperty("p4_one2stepdirectionsNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_walksbackwardNo"
								name="p4_walksbackwardNo" onclick="onCheck(this,'p4_walksbackward')"
								<%= props.getProperty("p4_walksbackwardNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_pretendsPlayNo"
								name="p4_pretendsPlayNo"
								onclick="onCheck(this,'p4_pretendsPlay')"
								<%= props.getProperty("p4_pretendsPlayNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							<td valign="top" class="edcol" colspan="2"><input
								class="delete" type="button" value="Del"
								onclick="del('p4_2wSentenceOk,p4_2wSentenceNo,p4_walksbackwardOk,p4_walksbackwardNo,p4_one2stepdirectionsOk,p4_one2stepdirectionsNo,p4_runsOk,p4_runsNo,p4_smallContainerOk,p4_smallContainerNo,p4_pretendsPlayOk,p4_pretendsPlayNo,p4_newSkillsOk,p4_newSkillsNo,p4_noParentsConcerns24mOk,p4_noParentsConcerns24mNo');" /></td>
							<td>&nbsp;</td>
						</tr>
					</table>
					</td>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_upDownStairsNo"
								name="p4_upDownStairsNo" onclick="onCheck(this,'p4_upDownStairs')"
								<%= props.getProperty("p4_upDownStairsNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_undoesZippersNo"
								name="p4_undoesZippersNo"
								onclick="onCheck(this,'p4_undoesZippers')"
								<%= props.getProperty("p4_undoesZippersNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							<td valign="top" class="edcol" colspan="2"><input
								class="delete" type="button" value="Del"
								onclick="del('p4_3directionsOk,p4_3directionsNo,p4_asksQuestionsOk,p4_asksQuestionsNo,p4_upDownStairsOk,p4_upDownStairsNo,p4_upDownStairsOk,p4_upDownStairsNo,p4_undoesZippersOk,p4_undoesZippersNo,p4_tries2comfortOk,p4_tries2comfortNo,p4_noParentsConcerns48mOk,p4_noParentsConcerns48mNo');" /></td>
							<td>&nbsp;</td>
						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_5ormoreWordsNo"
								name="p4_5ormoreWordsNo" onclick="onCheck(this,'p4_5ormoreWords')"
								<%= props.getProperty("p4_5ormoreWordsNo", "") %>></td>
							<td valign="top"><bean:message
							...
							<td valign="top"><input type="radio" id="p4_walksUpStairsNo"
								name="p4_walksUpStairsNo" onclick="onCheck(this,'p4_walksUpStairs')"
								<%= props.getProperty("p4_walksUpStairsNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio"
								id="p4_playMakeBelieveNo" name="p4_playMakeBelieveNo"
								onclick="onCheck(this,'p4_playMakeBelieve')"
								<%= props.getProperty("p4_playMakeBelieveNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							<td valign="top" class="edcol" colspan="2"><input
								class="delete" type="button" value="Del"
								onclick="del('p4_2directionsOk,p4_2directionsNo,p4_5ormoreWordsOk,p4_5ormoreWordsNo,p4_walksUpStairsOk,p4_walksUpStairsNo,p4_twistslidsOk,p4_twistslidsNo,p4_turnsPagesOk,p4_turnsPagesNo,p4_sharesSometimeOk,p4_sharesSometimeNo,p4_playMakeBelieveOk,p4_playMakeBelieveNo,p4_listenMusikOk,p4_listenMusikNo,p4_noParentsConcerns36mOk,p4_noParentsConcerns36mNo');" /></td>
							<td>&nbsp;</td>
						</tr>
					</table>
					</td>
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_countsOutloudNo"
								name="p4_countsOutloudNo" onclick="onCheck(this,'p4_countsOutloud')"
								<%= props.getProperty("p4_countsOutloudNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio"
								id="p4_dressesUndressesNo" name="p4_dressesUndressesNo"
								onclick="onCheck(this,'p4_dressesUndresses')"
								<%= props.getProperty("p4_dressesUndressesNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							...
							<td valign="top"><input type="radio" id="p4_obeysAdultNo"
								name="p4_obeysAdultNo" onclick="onCheck(this,'p4_obeysAdult')"
								<%= props.getProperty("p4_obeysAdultNo", "") %>></td>
							<td valign="top"><bean:message
							...
							<td valign="top"><input type="radio" id="p4_retellsStoryNo"
								name="p4_retellsStoryNo" onclick="onCheck(this,'p4_retellsStory')"
								<%= props.getProperty("p4_retellsStoryNo", "") %>></td>
							<td valign="top"><bean:message
						...
						<tr>
							<td valign="top" class="edcol" colspan="2"><input
								class="delete" type="button" value="Del"
								onclick="del('p4_countsOutloudOk,p4_countsOutloudNo,p4_speaksClearlyOk,p4_speaksClearlyNo,p4_throwsCatchesOk,p4_throwsCatchesNo,p4_hops1footOk,p4_hops1footNo,p4_dressesUndressesOk,p4_dressesUndressesNo,p4_obeysAdultOk,p4_obeysAdultNo,p4_retellsStoryOk,p4_retellsStoryNo,p4_separatesOk,p4_separatesNo,p4_noParentsConcerns60mOk,p4_noParentsConcerns60mNo');" /></td>
							<td>&nbsp;</td>
						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<td>&nbsp;</td>
                                ...
                                <tr>
                                        ...
                                        <td valign="top"><input type="radio"
                                                id="p4_fontanellesClosedNo" name="p4_fontanellesClosedNo"
                                                onclick="onCheck(this,'p4_fontanellesClosed')"
                                                <%= props.getProperty("p4_fontanellesClosedNo", "") %>></td>
                                        <td valign="top"><bean:message
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_fontanellesClosedOk,p4_fontanellesClosedNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_eyes18mNo"
						name="p4_eyes18mNo" onclick="onCheck(this,'p4_eyes18m')"
						<%= props.getProperty("p4_eyes18mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formEyes" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_eyes18mOk,p4_eyes18mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_corneal18mNo"
						name="p4_corneal18mNo" onclick="onCheck(this,'p4_corneal18m')"
						<%= props.getProperty("p4_corneal18mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formCorneal" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_corneal18mOk,p4_corneal18mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_hearing18mNo"
						name="p4_hearing18mNo" onclick="onCheck(this,'p4_hearing18m')"
						<%= props.getProperty("p4_hearing18mNo", "") %>></td>
					<td valign="top"><bean:message
						key="oscarEncounter.formRourke2006_4.formHearingInquiry" /></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_hearing18mOk,p4_hearing18mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_tonsil18mNo"
						name="p4_tonsil18mNo" onclick="onCheck(this,'p4_tonsil18m')"
						<%= props.getProperty("p4_tonsil18mNo", "") %>></td>
					<td valign="top"><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2006_3.formTonsilSize" />*</a></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_tonsil18mOk,p4_tonsil18mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
			</table>
			</td>
				...
				<tr>
					...
					<td>&nbsp;</td>
                                ...
                                <tr>
                                        ...
                                        <td valign="top"><input type="radio"
                                                id="p4_bloodpressure24mNo" name="p4_bloodpressure24mNo"
                                                onclick="onCheck(this,'p4_bloodpressure24m')"
                                                <%= props.getProperty("p4_bloodpressure24mNo", "") %>></td>
                                        <td valign="top"><bean:message
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_bloodpressure24mOk,p4_bloodpressure24mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_eyes24mNo"
						name="p4_eyes24mNo" onclick="onCheck(this,'p4_eyes24m')"
						<%= props.getProperty("p4_eyes24mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formEyes" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_eyes24mOk,p4_eyes24mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_corneal24mNo"
						name="p4_corneal24mNo" onclick="onCheck(this,'p4_corneal24m')"
						<%= props.getProperty("p4_corneal24mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formCorneal" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_corneal24mOk,p4_corneal24mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_hearing24mNo"
						name="p4_hearing24mNo" onclick="onCheck(this,'p4_hearing24m')"
						<%= props.getProperty("p4_hearing24mNo", "") %>></td>
					<td valign="top"><bean:message
						key="oscarEncounter.formRourke2006_4.formHearingInquiry" /></td>
				</tr>
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_hearing24mOk,p4_hearing24mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_tonsil24mNo"
						name="p4_tonsil24mNo" onclick="onCheck(this,'p4_tonsil24m')"
						<%= props.getProperty("p4_tonsil24mNo", "") %>></td>
					<td valign="top"><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2006_3.formTonsilSize" />*</a></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_tonsil24mOk,p4_tonsil24mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
			</table>
			</td>
				...
				<tr>
					...
					<td>&nbsp;</td>
                                ...
                                <tr>
                                        ...
                                        <td valign="top"><input type="radio"
                                                id="p4_bloodpressure48mNo" name="p4_bloodpressure48mNo"
                                                onclick="onCheck(this,'p4_bloodpressure48m')"
                                                <%= props.getProperty("p4_bloodpressure48mNo", "") %>></td>
                                        <td valign="top"><bean:message
                                                key="oscarEncounter.formRourke2006_4.formBloodPressure" /></td>
                                </tr>
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_bloodpressure48mOk,p4_bloodpressure48mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_eyes48mNo"
						name="p4_eyes48mNo" onclick="onCheck(this,'p4_eyes48m')"
						<%= props.getProperty("p4_eyes48mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formEyes" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_eyes48mOk,p4_eyes48mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_corneal48mNo"
						name="p4_corneal48mNo" onclick="onCheck(this,'p4_corneal48m')"
						<%= props.getProperty("p4_corneal48mNo", "") %>></td>
					<td valign="top"><b><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2009_4.formCorneal" />*</a></b></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_corneal48mOk,p4_corneal48mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr>
					...
					<td valign="top"><input type="radio" id="p4_hearing48mNo"
						name="p4_hearing48mNo" onclick="onCheck(this,'p4_hearing48m')"
						<%= props.getProperty("p4_hearing48mNo", "") %>></td>
					<td valign="top"><bean:message
						key="oscarEncounter.formRourke2006_4.formHearingInquiry" /></td>
				</tr>
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_hearing48mOk,p4_hearing48mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
				<tr>
					...
					<td valign="top"><input type="radio" id="p4_tonsil48mNo"
						name="p4_tonsil48mNo" onclick="onCheck(this,'p4_tonsil48m')"
						<%= props.getProperty("p4_tonsil48mNo", "") %>></td>
					<td valign="top"><a href="javascript:showNotes()"
						onMouseOver="popLayer('<bean:message key="oscarEncounter.formRourke2006.footnote1" />')"
						onMouseOut="hideLayer()"><bean:message
						key="oscarEncounter.formRourke2006_3.formTonsilSize" />*</a></td>
                                ...
                                <tr>
                                        <td valign="top" class="edcol" colspan="2"><input
                                                class="delete" type="button" value="Del"
                                                onclick="del('p4_tonsil48mOk,p4_tonsil48mNo');" /></td>
                                        <td>&nbsp;</td>
                                </tr>
			</table>
			</td>
