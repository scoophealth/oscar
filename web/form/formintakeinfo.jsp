...
<table border="0" cellspacing="0" cellpadding="0" height="660px" width="740px" id="page1">    
    <tr>        
        <td colspan="2">
            <table width="740px" height="80px" border="0"  cellspacing="0" cellpadding="0" >
                <tr class="title" >
                    <th colspan="4">A. Personal Information</th>
                </tr>
                <tr>
                    <th class="question">Sex: </th>
                    <td><input type="text" name="sex" readonly="true" value="<%=props.getProperty("sex","")%>"/> </td>
                    <th class="question">Date of Birth: </th>
                    <td><input type="text" name="dob" readonly="true" value="<%=props.getProperty("dob","")%>"/> </td>
                </tr>
                <tr>
                    <th class="question">Phone Number: </th>
                    <td><input type="text" name="phone" readonly="true" value="<%=props.getProperty("phone","")%>"/> </td>
                    <th class="question">Contact Number: </th>
                    <td><input type="text" name="contact" value="<%=props.getProperty("contact","")%>"/> </td>
                </tr>
                <tr>
                    <th colspan="3" class="question">What ethno-cultural group do you most identify with:</th>
                    <td><input type="text" name="ethnoCulturalGr" value="<%=props.getProperty("ethnoCulturalGr","")%>"</td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>        
        <td  valign="top" colspan="2">
            <table width="740px" height="550px" border="0"  cellspacing="0" cellpadding="0" >
                ...
                <tr>                    
                    <th colspan="4" class="question">What type of accommodations do you live in?</th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="accommodationHouse" <%= props.getProperty("accommodationHouse", "") %>/>
                    </td>
                    <td width="45%">House</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="accommodationApt" <%= props.getProperty("accommodationApt", "") %>/>
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="accommodationLTC" <%= props.getProperty("accommodationLTC", "") %>/>
                    </td>
                ...
                <tr>                    
                    <th colspan="4" class="question">What is your present marital status?</th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStMarried" <%= props.getProperty("maritalStMarried", "") %>/>
                    </td>
                    <td>Married (once)</td>
                    <td width="5%" align="right">
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStLivingTogether" <%= props.getProperty("maritalStLivingTogether", "") %>/>
                    </td>
                    <td width="45%">Living together/common-law</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStRemarried" <%= props.getProperty("maritalStRemarried", "") %>/>
                    </td>
                    <td width="45%">Remarried (2 or more marriages)</td>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStSeparated" <%= props.getProperty("maritalStSeparated", "") %>/>
                    </td>
                    <td width="45%">Seperated</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStNeverMarried" <%= props.getProperty("maritalStNeverMarried", "") %>/>
                    </td>
                    <td width="45%">Never married</td>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="maritalStDivorced" <%= props.getProperty("maritalStDivorced", "") %>/>
                    </td>
                ...
                <tr>
                    <th colspan="2" class="question">How many people live in your household? </th>
                    <td colspan="2"><input type="text" name="nbpplInHousehold" style="background-color:#FFFFFF" value="<%=props.getProperty("nbpplInHousehold", "")%>"/></td>
                </tr>                
                <tr>                    
                    <th colspan="4" class="question">Is there someone who lives with you who can help out?</th>
                </tr>                
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpY" <%= props.getProperty("helpY", "") %>/>
                    </td>
                    <td>Yes</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpNoNeed" <%= props.getProperty("helpNoNeed", "") %>/>
                    </td>
                    <td>I do not need help</td>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpN" <%= props.getProperty("helpN", "") %>/>
                    </td>
                    <td width="45%">No</td>
                ...
                <tr>                    
                    <th colspan="4" class="question">If <font style="text-decoration:underline">Yes</font>, what is your relationship with this individual?</th>
                </tr>                
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpRelationshipSpouse" <%= props.getProperty("helpRelationshipSpouse", "") %>/>
                    </td>
                    <td>Spouse</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpRelationshipChildren" <%= props.getProperty("helpRelationshipChildren", "") %>/>
                    </td>
                    <td>Children</td>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpRelationshipSibling" <%= props.getProperty("helpRelationshipSibling", "") %>/>
                    </td>
                    <td>Sibling</td>
                    <td width="5%" align="right">
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="helpRelationshipFriend" <%= props.getProperty("helpRelationshipFriend", "") %>/>
                    </td>
                    <td>Friend</td>
                    <td width="5%" align="right">                        
                    </td>
                ...
                <tr>                    
                    <th colspan="4" class="question">Do you have others (not living in your home) that you can call on for support?</th>
                </tr>                
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="otherSupportFriends" <%= props.getProperty("otherSupportFriends", "") %>/>
                    </td>
                    <td>Friends</td>
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="otherSupportChildren" <%= props.getProperty("otherSupportChildren", "") %>/>
                    </td>
                    <td>Children</td>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="otherSupportSiblings" <%= props.getProperty("otherSupportSiblings", "") %>/>
                    </td>
                    <td>Siblings</td>
                    <td width="5%" align="right">
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="otherSupportNeighbour" <%= props.getProperty("otherSupportNeighbour", "") %>/>
                    </td>
                    <td>Neighbour</td>
                    <td width="5%" align="right">                        
                    </td>
    ...
    <tr>        
        <td  valign="top" colspan="2">
            <table width="740px" height="630px" border="0"  cellspacing="0" cellpadding="0" >
                ...
                <tr bgcolor="white">
                    <td colspan="4">
                        <input type="text" name="anyHealthPb" size="100" value="<%= props.getProperty("anyHealthPb", "") %>"/>
                    </td>
                </tr>
                <tr>                    
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="smkY" <%= props.getProperty("smkY", "") %>/><br>
                        <input type="checkbox"  class="checkbox" name="smkN" <%= props.getProperty("smkN", "") %>/>
                    </td>
                    <td width="15%">
                        Yes<br>
                        No
                ...
                <tr>                    
                    <th colspan="4" class="question">In the past 6 months, have you had a drink of beer, wine, liquor or other alcoholic beverage?</th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="alcoholY" <%= props.getProperty("alcoholY", "") %>/>
                    </td>
                    <td>Yes</td>
                    <td></td>
                    <td></td>                                            
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="alcoholN" <%= props.getProperty("alcoholN", "") %>/>
                    </td>
                    <td>No</td>
                    <td></td>
                    <td></td>                                    
                ...
                <tr>                    
                    <th colspan="4" class="question">Have you had more than 12 drinks per week in the last 6 months?</th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="more12DrinksY" <%= props.getProperty("more12DrinksY", "") %>/>
                    </td>
                    <td>Yes</td>
                    <td></td>
                    <td></td>                                            
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox"  class="checkbox" name="more12DrinksN" <%= props.getProperty("more12DrinksN", "") %>/>
                    </td>
                    <td>No</td>
                    <td></td>
                    <td></td>                                    
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox" name="heartAttackY" <%= props.getProperty("heartAttackY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartAttackRefused" <%= props.getProperty("heartAttackRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                     <td width="5%" align="right">
                        <input type="checkbox" class="checkbox" name="heartAttackN" <%= props.getProperty("heartAttackN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartAttackDoNotKnow" <%= props.getProperty("heartAttackDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="anginaY" <%= props.getProperty("anginaY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="anginaRefused" <%= props.getProperty("anginaRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white"> 
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="anginaN" <%= props.getProperty("anginaN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                  
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="anginaDoNotKnow" <%= props.getProperty("anginaDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartFailureY" <%= props.getProperty("heartFailureY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartFailureRefused" <%= props.getProperty("heartFailureRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartFailureN" <%= props.getProperty("heartFailureN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="heartFailureDoNotKnow" <%= props.getProperty("heartFailureDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
    ...
    <tr> 
        <td  valign="top" colspan='2'>
            <table width="740px" height="630px" border="0"  cellspacing="0" cellpadding="0" >
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="highBPY" <%= props.getProperty("highBPY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="highBPRefused" <%= props.getProperty("highBPRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="highBPN" <%= props.getProperty("highBPN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                  
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="highBPDoNotKnow" <%= props.getProperty("highBPDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr>                    
                    <th>5. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) any other heart disease?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="otherHeartDiseaseY" <%= props.getProperty("otherHeartDiseaseY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="otherHeartDiseaseRefused" <%= props.getProperty("otherHeartDiseaseRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="otherHeartDiseaseN" <%= props.getProperty("otherHeartDiseaseN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                   
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="otherHeartDiseaseDoNotKnow" <%= props.getProperty("otherHeartDiseaseDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    ...
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="diabetesRefused" <%= props.getProperty("diabetesRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td>
                ...
                <tr bgcolor="white">
                    ...
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="diabetesDoNotKnow" <%= props.getProperty("diabetesDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="arthritisY" <%= props.getProperty("arthritisY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="arthritisRefused" <%= props.getProperty("arthritisRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">  
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="arthritisN" <%= props.getProperty("arthritisN", "") %>/>
                    </td>               
                    <td>
                        No
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="arthritisDoNotKnow" <%= props.getProperty("arthritisDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="strokeY" <%= props.getProperty("strokeY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="strokeRefused" <%= props.getProperty("strokeRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="strokeN" <%= props.getProperty("strokeN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                   
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="strokeDoNotKnow" <%= props.getProperty("strokeDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="cancerY" <%= props.getProperty("cancerY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="cancerRefused" <%= props.getProperty("cancerRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="cancerN" <%= props.getProperty("cancerN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                   
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="cancerDoNotKnow" <%= props.getProperty("cancerDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr>                    
                    <th>10. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) a broken or fractured hip?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="brokenHipY" <%= props.getProperty("brokenHipY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="brokenHipRefused" <%= props.getProperty("brokenHipRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td>
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="brokenHipN" <%= props.getProperty("brokenHipN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="brokenHipDoNotKnow" <%= props.getProperty("brokenHipDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr>                    
                    <th>11. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) Parkinson's disease?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="parkinsonY" <%= props.getProperty("parkinsonY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="parkinsonRefused" <%= props.getProperty("parkinsonRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">      
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="parkinsonN" <%= props.getProperty("parkinsonN", "") %>/>
                    </td>              
                    <td>
                        No
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="parkinsonDoNotKnow" <%= props.getProperty("parkinsonDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr>                    
                    <th valign="top">12. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) lung disease, such as emphysema or chronic bronchitis?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="lungDiseaseY" <%= props.getProperty("lungDiseaseY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="lungDiseaseRefused" <%= props.getProperty("lungDiseaseRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td>
                ...
                <tr bgcolor="white"> 
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="lungDiseaseN" <%= props.getProperty("lungDiseaseN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="lungDiseaseDoNotKnow" <%= props.getProperty("lungDiseaseDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
    ...
    <tr>        
        ...
        <table width="740px" height="630px" border="0"  cellspacing="0" cellpadding="0" >
                ...
                <tr>                    
                    <th>13. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) hearing problems?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="hearingPbY" <%= props.getProperty("hearingPbY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>                    
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="hearingPbRefused" <%= props.getProperty("hearingPbRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="hearingPbN" <%= props.getProperty("hearingPbN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="hearingPbDoNotKnow" <%= props.getProperty("hearingPbDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
                ...
                <tr>                    
                    <th>14. </th>
                    <th colspan="7" class="question">
                        (Has a doctor ever told you that you had...) vision problems?
                    </th>
                </tr>
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="visionPbY" <%= props.getProperty("visionPbY", "") %>/>
                    </td>
                    <td>
                        Yes
                    </td>
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="visionPbRefused" <%= props.getProperty("visionPbRefused", "") %>/>
                    </td>
                    <td>
                        Refused
                    </td> 
                ...
                <tr bgcolor="white">
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="visionPbN" <%= props.getProperty("visionPbN", "") %>/>
                    </td>
                    <td>
                        No
                    </td>                                   
                    <td width="5%" align="right">
                        <input type="checkbox" class="checkbox"  name="visionPbDoNotKnow" <%= props.getProperty("visionPbDoNotKnow", "") %>/>
                    </td>
                    <td>
                        Don't Know
                    </td>
