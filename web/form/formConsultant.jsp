...
<html:form action="/form/formname">
	...
	<input type="hidden" name="billingreferral_no"
		value="<%=props.getProperty("billingreferral_no", "")%>" />
	<input type="hidden" name="doc_name"
		value="<%=props.getProperty("doc_name", "")%>" />
	<input type="hidden" name="cl_name"
		value="<%=props.getProperty("cl_name","")%>" />
	<input type="hidden" name="cl_address1"
		value="<%=props.getProperty("cl_address1","")%>" />
	<input type="hidden" name="cl_address2"
		value="<%=props.getProperty("cl_address2","")%>" />
	<input type="hidden" name="cl_phone"
		value="<%=props.getProperty("cl_phone","")%>" />
	<input type="hidden" name="cl_fax"
		value="<%=props.getProperty("cl_fax","")%>" />
	<input type="hidden" name="project_home" value="<%=project_home%>" />
	<div
		style="font-size: 24px; font-family: arial, helvetica, sans-serif;">
	<center><b><%=props.getProperty("doc_name", "")%></b></center>
	</div>
	<div
		style="font-size: 19px; font-family: arial, helvetica, sans-serif;">
	<center><b><i><%=props.getProperty("cl_name","")%></i></b></center>
	</div>
	...
	<TABLE WIDTH="100%" cols="2" style="font-size: 13px;">
		...
		<TABLE align="center" width="100%" style="border: 1px solid;">
			<TR>
				...
				<TD align="left"><INPUT name="consultTime" id="consultTime"
					...
					id="hlSDate"><small>Select Date</small></a></span></TD>
			</TR>
			<TR>
				<TD align="left">To:</TD>
				<TD align="left"><INPUT name="t_name"
					style="border: none; font-size: 13px; text-decoration: underline; width: 80%;"
					type="text" value="<%=props.getProperty("t_name", "")%>">&nbsp;</INPUT><span
					id="searching"><a
					href="javascript:search('billingreferral_no', 't_name', 't_address1', 't_address2', 't_phone', 't_fax')"><small>Search
				#</small></a></span></TD>
			</TR>
			<TR>
				<TD align="left">Address:</TD>
				<TD align="left"><INPUT
					value="<%=props.getProperty("t_address1", "")%>" id="t_address1"
					name="t_address1"
			...
			<TR>
				<TD align="left">&nbsp;</TD>
				<TD align="left"><INPUT
					value="<%=props.getProperty("t_address2", "")%>" id="t_address2"
					name="t_address2"
					style="border: none; font-size: 13px; text-decoration: underline; width: 90%;"
					TYPE="text">&nbsp;</INPUT></TD>
			</TR>
			<TR>
				...
				<TD align="left"><INPUT
					value="<%=props.getProperty("t_phone", "")%>" id="t_phone"
					name="t_phone"
					style="border: none; font-size: 13px; text-decoration: underline; width: 90%;"
					TYPE="text">&nbsp;</INPUT></TD>
			</TR>
			<TR>
				...
				<TD align="left"><INPUT
					value="<%=props.getProperty("t_fax", "")%>" id="t_fax" name="t_fax"
					style="border: none; font-size: 13px; text-decoration: underline; width: 90%;"
					TYPE="text">&nbsp;</INPUT></TD>
			</TR>
		</TABLE>
		...
		<TABLE WIDTH="100%" align="center" style="border: 1px solid;">
			<TR>
				...
				<TD align="left"><INPUT NAME="p_name"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
					TYPE="text" value="<%=props.getProperty("p_name","")%>"> </INPUT></TD>
			</TR>
			<TR>
				<TD align="left">Address:</TD>
				<TD align="left"><INPUT NAME="p_address1"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
			...
			<TR>
				<TD align="left">&nbsp;</TD>
				<TD align="left"><INPUT NAME="p_address2"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
			...
			<TR>
				<TD align="left">Phone:</TD>
				<TD align="left"><INPUT NAME="p_phone"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
					TYPE="text" value="<%=props.getProperty("p_phone","")%>"> </INPUT>

				</TD>
			</TR>
			<TR>
				<TD align="left">Birthdate:</TD>
				<TD align="left"><INPUT NAME="p_birthdate"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
			...
			<TR>
				...
				<TD align="left"><INPUT NAME="p_healthcard"
					style="border: none; font-size: 13px; text-decoration: underline; width: 100%;"
	...
	<div id="textareaDiv" style="position: relative;"><textarea
		id="comments" name="comments" class="ta1" rows="60">
<%= props.getProperty("comments", "")%>
    </textarea></div>
	<div id="buttons"><input id="savebut" type="submit" value="Save"
		onclick="javascript: return onSave();" /> <input id="saveexitbut"
		type="submit" value="Save and Exit"
		onclick="javascript: return onSaveExit();" /> <input id="exitbut"
		type="submit" value="Exit" onclick="javascript: return onExit();" />
	<input id="printbut" type="submit" value="Print"
		onclick="javascript: return onPrint();" /></div>
</body>
