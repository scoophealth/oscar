...
<link rel="stylesheet" type="text/css" href="formreceptionassessment.css">
...
<table width="95%" border="1">
  <tr>
    <td class="style76">
		...
		<input type="text" name="assessDate" value="<%=props.getProperty("assessDate", "")%>">
	</td>
  ...
  <tr>
    <td class="style76">
		Date client entered Seaton House (YYYY/MM/DD)<br>
		<input type="text" name="enterSeatonDate" value="<%=props.getProperty("enterSeatonDate", "")%>">
	</td>
    <td class="style76">
		<input type="checkbox" name="cbox_newClient" value="Y" <%=(props.getProperty("cbox_newClient", "")).equalsIgnoreCase("Y")?"checked":""%>>
	 	<span onClick="javascript:clickCheckBox(document.forms[0].cbox_newClient);" >New Client</span>
	 </td>
    <td class="style76">
 		<input type="checkbox" name="cbox_dateOfReadmission" value="Y" <%=(props.getProperty("cbox_dateOfReadmission", "")).equalsIgnoreCase("Y")?"checked":""%>>
		...
		<input type="text" name="dateOfReadmission" value="<%=props.getProperty("dateOfReadmission", "")%>">
...
<table width="95%" border="1">
  <tr>
	...
	to ensure that you are getting the health care that you need and want while at Seaton House. 
	Any answers you give us will be kept private in your Seaton House file. We will collect numbers from the answers 
	that we get from everyone on a regular basis to try and make the system better at Seaton House and in the City 
	but in this case we would not use your name. You don't have to answer these questions. Your stay at Seaton House will not 
...
<table width="95%" border="1">
  <tr>
    ...
    <td  align="left" class="style76">
		...
		<input type="text" name="speakOther" value="<%=props.getProperty("speakOther", "")%>">
...
<table width="95%" border="1">
  ...
  <tr>
    <td  align="left" class="style76">What is your reason for coming to Seaton House? (state briefly in client's own words if possible)</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<textArea name="reasonToSeaton"  cols="75"><%=props.getProperty("reasonToSeaton", "")%></textArea>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		Have you ever stayed at Seaton House before? (give dates)
		<input type="text" name="datesAtSeaton" size="55" value="<%=props.getProperty("datesAtSeaton", "")%>">
	</td>
  </tr>		
</table>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  align="left" class="style76">Do you require assistance with any of the following (state briefly in clients own words if possible)</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInHealth" value="Y" <%=(props.getProperty("cbox_assistInHealth", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInIdentification" value="Y" <%=(props.getProperty("cbox_assistInIdentification", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInIdentification);" >Obtaining Identification</span>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInAddictions" value="Y" <%=(props.getProperty("cbox_assistInAddictions", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInAddictions);" >Addictions</span>	
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInHousing" value="Y" <%=(props.getProperty("cbox_assistInHousing", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInHousing);" >Housing issues</span>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInEducation" value="Y" <%=(props.getProperty("cbox_assistInEducation", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInEducation);" >Education Issues</span>	
	</td>
  </tr>	
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInEmployment" value="Y" <%=(props.getProperty("cbox_assistInEmployment", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInFinance" value="Y" <%=(props.getProperty("cbox_assistInFinance", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInFinance);" >Financial issues</span>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInLegal" value="Y" <%=(props.getProperty("cbox_assistInLegal", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_assistInLegal);" >Legal issues</span>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_assistInImmigration" value="Y" <%=(props.getProperty("cbox_assistInImmigration", "")).equalsIgnoreCase("Y")?"checked":""%>>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td  colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_noID" value="Y" <%=(props.getProperty("cbox_noID", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_sinCard" value="Y" <%=(props.getProperty("cbox_sinCard", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_sinCard);" >SIN Card:</span>
	</td>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_healthCard" value="Y" <%=(props.getProperty("cbox_healthCard", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_healthCard);" >Ontario Health Card#</span>  <br>
		<input type="text" name="healthCardNum" value="<%=props.getProperty("healthCardNum", "")%>">
	</td>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_birthCertificate" value="Y" <%=(props.getProperty("cbox_birthCertificate", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_birthCertificate);" >Birth Certificate</span>
	</td>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_citzenshipCard" value="Y" <%=(props.getProperty("cbox_citzenshipCard", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_citzenshipCard);" >Citizenship Card</span>
	</td>
	
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_immigrant" value="Y" <%=(props.getProperty("cbox_immigrant", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_immigrant);" >Landed Immigrant</span>
	</td>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_refugee" value="Y" <%=(props.getProperty("cbox_refugee", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_refugee);" >Convention Refugee</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_otherID" value="Y" <%=(props.getProperty("cbox_otherID", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_otherID);" >Other (specify)</span>
		<input type="text" name="otherIdentification" size="35" value="<%=props.getProperty("otherIdentification", "")%>">
  ...
  <tr>
    ...
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_idFiled" value="Y" <%=(props.getProperty("cbox_idFiled", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_idFiled);" >ID copied and filed</span>
	</td>
    <td  align="left" class="style76">
		<input type="checkbox" name="cbox_idNone" value="Y" <%=(props.getProperty("cbox_idNone", "")).equalsIgnoreCase("Y")?"checked":""%>>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="1" width="10%"  align="left" class="style76">
		<input type="checkbox" name="cbox_OW" value="Y" <%=(props.getProperty("cbox_OW", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_OW);" >OW</span>
	</td>
    <td  colspan="1"  width="12%"  align="left" class="style76">
		<input type="checkbox" name="cbox_ODSP" value="Y" <%=(props.getProperty("cbox_ODSP", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_ODSP);" >ODSP</span>
	</td>
    <td  colspan="1" width="12%"  align="left" class="style76">
		<input type="checkbox" name="cbox_WSIB" value="Y" <%=(props.getProperty("cbox_WSIB", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_WSIB);" >WSIB</span>
	</td>
    <td  colspan="2" width="15%"  align="left" class="style76">
		<input type="checkbox" name="cbox_Employment" value="Y" <%=(props.getProperty("cbox_Employment", "")).equalsIgnoreCase("Y")?"checked":""%>>
    ...
    <td  colspan="1" width="11%"  align="left" class="style76">
		<input type="checkbox" name="cbox_EI" value="Y" <%=(props.getProperty("cbox_EI", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_EI);" >EI</span>
	</td>
    <td  colspan="1" width="11%"  align="left" class="style76">
		<input type="checkbox" name="cbox_OAS" value="Y" <%=(props.getProperty("cbox_OAS", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_OAS);" >OAS</span>
	</td>
    <td  colspan="1" width="10%"  align="left" class="style76">
		<input type="checkbox" name="cbox_CPP" value="Y" <%=(props.getProperty("cbox_CPP", "")).equalsIgnoreCase("Y")?"checked":""%>>
	    <span onClick="javascript:clickCheckBox(document.forms[0].cbox_CPP);" >CPP</span>
	</td>
    <td width="19%"  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_OtherIncome" value="Y" <%=(props.getProperty("cbox_OtherIncome", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_onlineCheck" value="yes"  <%=(props.getProperty("radio_onlineCheck", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_onlineCheck[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_onlineCheck" value="no"  <%=(props.getProperty("radio_onlineCheck", "")).equalsIgnoreCase("no")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_onlineCheck[1]);" >No</span>
	</td>
  </tr>		
  <tr>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_active" value="active"  <%=(props.getProperty("radio_active", "")).equalsIgnoreCase("active")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_active[0]);" >Active</span>
	</td>
    <td  colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_active" value="inactive"  <%=(props.getProperty("radio_active", "")).equalsIgnoreCase("inactive")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_active[1]);" >Inactive</span>
	</td>
    <td  colspan="5" align="left" class="style76">
		<input type="checkbox" name="cbox_noRecord" value="Y" <%=(props.getProperty("cbox_noRecord", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		...
		<input type="text" name="lastIssueDate" value="<%=props.getProperty("lastIssueDate", "")%>">
	</td>
    <td  colspan="3"  align="left" class="style76">
		Office:
		<input type="text" name="office" value="<%=props.getProperty("office", "")%>">
	</td>
    <td  colspan="2" align="left" class="style76">
		Worker#:
		<input type="text" name="workerNum" value="<%=props.getProperty("workerNum", "")%>">
	</td>
    <td  colspan="2" align="left" class="style76">
		Amount Received: <br>$
		<input type="text" name="amtReceived"  maxlength="9" value="<%=props.getProperty("amtReceived", "")%>" size="10">
	</td>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="11%"  colspan="1"   align="left" class="style76">
		<input type="radio" name="radio_hasDoctor" value="yes"  <%=(props.getProperty("radio_hasDoctor", "")).equalsIgnoreCase("yes")?"checked":""%>>
	    <span onClick="javascript:clickRadio(document.forms[0].radio_hasDoctor[0]);" >Yes</span>
	</td>
    <td  colspan="1"   align="left" class="style76">
		<input type="radio" name="radio_hasDoctor" value="no"  <%=(props.getProperty("radio_hasDoctor", "")).equalsIgnoreCase("no")?"checked":""%>>
	    <span onClick="javascript:clickRadio(document.forms[0].radio_hasDoctor[1]);" >No</span>
	</td>
    <td  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasDoctor" value="dontKnow"  <%=(props.getProperty("radio_hasDoctor", "")).equalsIgnoreCase("dontKnow")?"checked":""%>>
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		Name:
		<input type="text" name="doctorName" value="<%=props.getProperty("doctorName", "")%>">
		
	</td>
    <td colspan="5"  align="left" class="style76">
		Phone #:
		<input type="text" name="doctorPhone" value="<%=props.getProperty("doctorPhone", "")%>">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Ext.
		<input type="text" name="doctorPhoneExt" value="<%=props.getProperty("doctorPhoneExt", "")%>">
	</td>
  </tr>		
  <tr>
    <td  colspan="9" align="left" class="style76">
		Address:	
		<input type="text" name="doctorAddress" size="70"  maxlength="150" value="<%=props.getProperty("doctorAddress", "")%>">
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td width="8%"  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_seeDoctor" value="yes"  <%=(props.getProperty("radio_seeDoctor", "")).equalsIgnoreCase("yes")?"checked":""%>>
    ...
    <td width="15%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_seeDoctor" value="no"  <%=(props.getProperty("radio_seeDoctor", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_healthIssue" value="yes"  <%=(props.getProperty("radio_healthIssue", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_healthIssue[0]);" >Yes</span>		
	</td>
    <td  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_healthIssue" value="no"  <%=(props.getProperty("radio_healthIssue", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		<input type="checkbox" name="cbox_hasDiabetes" value="Y" <%=(props.getProperty("cbox_hasDiabetes", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_hasDiabetes);" >Diabetes. If yes --></span>	
	</td>
    <td  colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_insulin" value="Y" <%=(props.getProperty("cbox_insulin", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_insulin);" >Insulin dependent?</span>		
	</td>
    <td  colspan="1"  align="left" class="style76">
		<input type="checkbox" name="cbox_epilepsy" value="Y" <%=(props.getProperty("cbox_epilepsy", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_epilepsy);" >Epilepsy</span>		
	</td>
    <td  colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_bleeding" value="Y" <%=(props.getProperty("cbox_bleeding", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_hearingImpair"  value="Y" <%=(props.getProperty("cbox_hearingImpair", "")).equalsIgnoreCase("Y")?"checked":""%>>
    ...
    <td width="19%"  colspan="1"  align="left" class="style76">
		<input type="checkbox" name="cbox_visualImpair"  value="Y" <%=(props.getProperty("cbox_visualImpair", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_visualImpair);" >Visual Impairment</span>		
	</td>
    <td  colspan="6"  align="left" class="style76">
		<input type="checkbox" name="cbox_mobilityImpair"  value="Y" <%=(props.getProperty("cbox_mobilityImpair", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_mobilityImpair);" >Mobility impairment. Give details: </span>		
		<input type="text" name="mobilityImpair" size="35" value="<%=props.getProperty("mobilityImpair", "")%>">
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_otherHealthConcern" value="yes"  <%=(props.getProperty("radio_otherHealthConcern", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_otherHealthConcern[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_otherHealthConcern" value="no"  <%=(props.getProperty("radio_otherHealthConcern", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_takeMedication" value="yes"  <%=(props.getProperty("radio_takeMedication", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_takeMedication[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_takeMedication" value="no"  <%=(props.getProperty("radio_takeMedication", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    <td  colspan="9" align="left" class="style76">
		...
		<input type="text" name="namesOfMedication"  size="70"  value="<%=props.getProperty("namesOfMedication", "")%>">
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_helpObtainMedication" value="yes"  <%=(props.getProperty("radio_helpObtainMedication", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_helpObtainMedication[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_helpObtainMedication" value="no"  <%=(props.getProperty("radio_helpObtainMedication", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_allergicToMedication" value="yes"  <%=(props.getProperty("radio_allergicToMedication", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_allergicToMedication[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_allergicToMedication" value="no"  <%=(props.getProperty("radio_allergicToMedication", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    <td  colspan="9" align="left" class="style76">
		...
		<input type="text" name="allergicToMedicationName"  size="75"  value="<%=props.getProperty("allergicToMedicationName", "")%>"> <br><br>
		If yes, give reaction (hives, rash, anaphylaxis=breathing problems, shortness of breath, itching swelling of mouth and throat)
		<textArea name="reactionToMedication"  cols="75"><%=props.getProperty("reactionToMedication", "")%></textArea>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_mentalHealthConcerns" value="yes"  <%=(props.getProperty("radio_mentalHealthConcerns", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_mentalHealthConcerns[0]);" >Yes</span>
	</td>
    <td  colspan="2" align="left" class="style76">
		<input type="radio" name="radio_mentalHealthConcerns" value="no"  <%=(props.getProperty("radio_mentalHealthConcerns", "")).equalsIgnoreCase("no")?"checked":""%>>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="6"  align="left" class="style76">
		Please read the following statement to the client:"To better provide care at Seaton House, 
  ...
  <tr>
    <td  colspan="6"  align="left" class="style76">
		...
		<input type="text" name="frequencyOfSeeingDoctor" value="<%=props.getProperty("frequencyOfSeeingDoctor", "")%>">
	</td>
  </tr>	
  <tr>	
  	<td colspan="6"  align="left" class="style76">
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_visitWalkInClinic" value="Y" <%=(props.getProperty("cbox_visitWalkInClinic", "")).equalsIgnoreCase("Y")?"checked":""%>>
 		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_visitWalkInClinic);" >Walk-in clinic</span> <br>
		<input type="checkbox" name="cbox_visitHealthCenter" value="Y" <%=(props.getProperty("cbox_visitHealthCenter", "")).equalsIgnoreCase("Y")?"checked":""%>>
 		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_visitHealthCenter);" >Community health centre</span>
	</td>
    <td colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_visitEmergencyRoom" value="Y" <%=(props.getProperty("cbox_visitEmergencyRoom", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_visitEmergencyRoom);" >Hospital emergency room</span><br>
		<input type="checkbox" name="cbox_visitOthers" value="Y" <%=(props.getProperty("cbox_visitOthers", "")).equalsIgnoreCase("Y")?"checked":""%>>
    ...
    <td   colspan="2"  align="left" valign="top" class="style76">
		<input type="checkbox" name="cbox_visitHealthOffice" value="Y" <%=(props.getProperty("cbox_visitHealthOffice", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_seeSameDoctor" value="yes"  <%=(props.getProperty("radio_seeSameDoctor", "")).equalsIgnoreCase("yes")?"checked":""%>>
    ...
    <td width="23%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_seeSameDoctor" value="no"  <%=(props.getProperty("radio_seeSameDoctor", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    <td  colspan="6"  align="left" class="style76">
		...
		<input type="text" name="frequencyOfSeeingEmergencyRoomDoctor"  size="15" value="<%=props.getProperty("frequencyOfSeeingEmergencyRoomDoctor", "")%>">
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_didNotReceiveHealthCare" value="yes"  <%=(props.getProperty("radio_didNotReceiveHealthCare", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_didNotReceiveHealthCare[0]);" >Yes </span><br>
		
		<input type="radio" name="radio_didNotReceiveHealthCare" value="dontKnow"  <%=(props.getProperty("radio_didNotReceiveHealthCare", "")).equalsIgnoreCase("dontKnow")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_didNotReceiveHealthCare[1]);" >Don't know</span>		
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_didNotReceiveHealthCare" value="no"  <%=(props.getProperty("radio_didNotReceiveHealthCare", "")).equalsIgnoreCase("no")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_didNotReceiveHealthCare[2]);" >No </span><br>
		<input type="radio" name="radio_didNotReceiveHealthCare" value="refuse"  <%=(props.getProperty("radio_didNotReceiveHealthCare", "")).equalsIgnoreCase("refuse")?"checked":""%>>
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_treatPhysicalHealth" value="Y" <%=(props.getProperty("cbox_treatPhysicalHealth", "")).equalsIgnoreCase("Y")?"checked":""%>>
        <span onClick="javascript:clickCheckBox(document.forms[0].cbox_treatPhysicalHealth);" >Treatment of a physical </span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;health problem <br>
		<input type="checkbox" name="cbox_treatMentalHealth" value="Y" <%=(props.getProperty("cbox_treatMentalHealth", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_treatMentalHealth);" >Treatment of an emotional or </span><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mental health problem		
	</td>
    <td colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_regularCheckup" value="Y" <%=(props.getProperty("cbox_regularCheckup", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_regularCheckup);" >A regular check-up</span><br>
		<input type="checkbox" name="cbox_treatOtherReasons" value="Y" <%=(props.getProperty("cbox_treatOtherReasons", "")).equalsIgnoreCase("Y")?"checked":""%>>
		<span onClick="javascript:clickCheckBox(document.forms[0].cbox_treatOtherReasons);" >Any other reason (specify)</span><br>
		<input type="text" name="treatOtherReasons" size="35" value="<%=props.getProperty("treatOtherReasons", "")%>">
		
	</td>
    <td   colspan="2"  align="left" valign="top" class="style76">
		<input type="checkbox" name="cbox_treatInjury" value="Y" <%=(props.getProperty("cbox_treatInjury", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<input type="checkbox" name="cbox_goToWalkInClinic" value="Y" <%=(props.getProperty("cbox_goToWalkInClinic", "")).equalsIgnoreCase("Y")?"checked":""%>>
           <span onClick="javascript:clickCheckBox(document.forms[0].cbox_goToWalkInClinic);" >Walk-in clinic</span><br>
		<input type="checkbox" name="cbox_goToHealthCenter" value="Y" <%=(props.getProperty("cbox_goToHealthCenter", "")).equalsIgnoreCase("Y")?"checked":""%>>
		   <span onClick="javascript:clickCheckBox(document.forms[0].cbox_goToHealthCenter);" >Community health centre</span>
	</td>
    <td colspan="2"  align="left" class="style76">
		<input type="checkbox" name="cbox_goToEmergencyRoom" value="Y" <%=(props.getProperty("cbox_goToEmergencyRoom", "")).equalsIgnoreCase("Y")?"checked":""%>>
            <span onClick="javascript:clickCheckBox(document.forms[0].cbox_goToEmergencyRoom);" >Hospital emergency room</span><br>
		<input type="checkbox" name="cbox_goToOthers" value="Y" <%=(props.getProperty("cbox_goToOthers", "")).equalsIgnoreCase("Y")?"checked":""%>>
			<span onClick="javascript:clickCheckBox(document.forms[0].cbox_goToOthers);" >Other (specify)</span><br>
		<input type="text" name="goToOthers" size="35" value="<%=props.getProperty("goToOthers", "")%>">
		
	</td>
    <td   colspan="2"  align="left" valign="top" class="style76">
		<input type="checkbox" name="cbox_HealthOffice" value="Y" <%=(props.getProperty("cbox_HealthOffice", "")).equalsIgnoreCase("Y")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_appmtSeeDoctorIn3Mths" value="yes"  <%=(props.getProperty("radio_appmtSeeDoctorIn3Mths", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_appmtSeeDoctorIn3Mths[0]);" >Yes</span>
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_appmtSeeDoctorIn3Mths" value="no"  <%=(props.getProperty("radio_appmtSeeDoctorIn3Mths", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_needRegularDoctor" value="yes"  <%=(props.getProperty("radio_needRegularDoctor", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_needRegularDoctor[0]);" >(B)Yes</span>
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_needRegularDoctor" value="no"  <%=(props.getProperty("radio_needRegularDoctor", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_objectToRegularDoctorIn4Wks" value="yes"  <%=(props.getProperty("radio_objectToRegularDoctorIn4Wks", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_objectToRegularDoctorIn4Wks[0]);" >Yes</span>
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<input type="radio" name="radio_objectToRegularDoctorIn4Wks" value="no"  <%=(props.getProperty("radio_objectToRegularDoctorIn4Wks", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="19%"  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_rateOverallHealth" value="poor"  <%=(props.getProperty("radio_rateOverallHealth", "")).equalsIgnoreCase("poor")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_rateOverallHealth[0]);" >Poor</span>
	</td>
    <td width="19%"   colspan="1" align="left" class="style76">
		<input type="radio" name="radio_rateOverallHealth" value="fair"  <%=(props.getProperty("radio_rateOverallHealth", "")).equalsIgnoreCase("fair")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_rateOverallHealth[1]);" >Fair</span>
	</td>
    <td  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_rateOverallHealth" value="good"  <%=(props.getProperty("radio_rateOverallHealth", "")).equalsIgnoreCase("good")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_rateOverallHealth[2]);" >Good</span>
	</td>
    <td  colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_rateOverallHealth" value="excellent"  <%=(props.getProperty("radio_rateOverallHealth", "")).equalsIgnoreCase("excellent")?"checked":""%>>
  ...
  <tr> 
    <td   colspan="2"  align="left" class="style76">
		<input type="radio" name="radio_speakToResearcher" value="yes"  <%=(props.getProperty("radio_speakToResearcher", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_speakToResearcher[0]);" >Yes</span>
	</td>
    <td    colspan="4" align="left" class="style76">
		<input type="radio" name="radio_speakToResearcher" value="no"  <%=(props.getProperty("radio_speakToResearcher", "")).equalsIgnoreCase("no")?"checked":""%>>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="2"  align="left" class="style76">
		Name:
		<input type="text" name="contactName" value="<%=props.getProperty("contactName", "")%>">
	</td>
    <td  colspan="2"  width="50%"  align="left" class="style76">
	    Phone #:
		<input type="text" name="contactPhone" value="<%=props.getProperty("contactPhone", "")%>">
	</td>
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		Address:
		<input type="text" name="contactAddress" value="<%=props.getProperty("contactAddress", "")%>">
	</td>
  </tr>		
  <tr>
    <td  colspan="4" align="left" class="style76">
		What relationship is this person to you? (friend, sister, next-of-kin, etc.)	
		<input type="text" name="contactRelationship" value="<%=props.getProperty("contactRelationship", "")%>">
	</td>
  </tr>	
</table>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasMentalIllness" value="yes"  <%=(props.getProperty("radio_hasMentalIllness", "")).equalsIgnoreCase("yes")?"checked":""%>>
    ...
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasMentalIllness" value="uncertain"  <%=(props.getProperty("radio_hasMentalIllness", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
    ...
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasMentalIllness" value="no"  <%=(props.getProperty("radio_hasMentalIllness", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasDrinkingProblem" value="yes"  <%=(props.getProperty("radio_hasDrinkingProblem", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasDrinkingProblem[0]);" >Yes</span>
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasDrinkingProblem" value="uncertain"  <%=(props.getProperty("radio_hasDrinkingProblem", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasDrinkingProblem[1]);" >Uncertain</span>
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasDrinkingProblem" value="no"  <%=(props.getProperty("radio_hasDrinkingProblem", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasDrugProblem" value="yes"  <%=(props.getProperty("radio_hasDrugProblem", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasDrugProblem[0]);" >Yes</span>
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasDrugProblem" value="uncertain"  <%=(props.getProperty("radio_hasDrugProblem", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasDrugProblem[1]);" >Uncertain</span>
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasDrugProblem" value="no"  <%=(props.getProperty("radio_hasDrugProblem", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasHealthProblem" value="yes"  <%=(props.getProperty("radio_hasHealthProblem", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasHealthProblem[0]);" >Yes</span>
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasHealthProblem" value="uncertain"  <%=(props.getProperty("radio_hasHealthProblem", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasHealthProblem[1]);" >Uncertain</span>
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasHealthProblem" value="no"  <%=(props.getProperty("radio_hasHealthProblem", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_hasBehaviorProblem" value="yes"  <%=(props.getProperty("radio_hasBehaviorProblem", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasBehaviorProblem[0]);" >Yes</span>
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasBehaviorProblem" value="uncertain"  <%=(props.getProperty("radio_hasBehaviorProblem", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_hasBehaviorProblem[1]);" >Uncertain</span>
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_hasBehaviorProblem" value="no"  <%=(props.getProperty("radio_hasBehaviorProblem", "")).equalsIgnoreCase("no")?"checked":""%>>
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_needSeatonService" value="yes"  <%=(props.getProperty("radio_needSeatonService", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_needSeatonService[0]);" >Yes</span>
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_needSeatonService" value="uncertain"  <%=(props.getProperty("radio_needSeatonService", "")).equalsIgnoreCase("uncertain")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_needSeatonService[1]);" >Uncertain</span>
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_needSeatonService" value="no"  <%=(props.getProperty("radio_needSeatonService", "")).equalsIgnoreCase("no")?"checked":""%>>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="10%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_seatonTour" value="yes"  <%=(props.getProperty("radio_seatonTour", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_seatonTour[0]);" >Yes</span>
		
	</td>
    <td    colspan="4"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_seatonTour" value="no"  <%=(props.getProperty("radio_seatonTour", "")).equalsIgnoreCase("no")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_seatonTour[1]);" >No (If no, give reason)</span>
		<input type="text" name="seatonNotToured" size="55" value="<%=props.getProperty("seatonNotToured", "")%>">
	</td>
  </tr>	
  <tr>
    <td  colspan="1" width="25%" align="left" class="style76">
    ...
    <td width="10%" colspan="1"  align="left" class="style76">
		<input type="radio" name="radio_pamphletIssued" value="yes"  <%=(props.getProperty("radio_pamphletIssued", "")).equalsIgnoreCase("yes")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_pamphletIssued[0]);" >Yes</span>
		
	</td>
    <td    colspan="4"  align="left" valign="top" class="style76">
		<input type="radio" name="radio_pamphletIssued" value="no"  <%=(props.getProperty("radio_pamphletIssued", "")).equalsIgnoreCase("no")?"checked":""%>>
		<span onClick="javascript:clickRadio(document.forms[0].radio_pamphletIssued[1]);" >No (If no, give reason)</span>
		<input type="text" name="pamphletNotIssued" size="55" value="<%=props.getProperty("pamphletNotIssued", "")%>">
	</td>
  </tr>	
...
<table width="95%" border="1">
  ...
  <tr>	
  	<td colspan="6" align="center" class="style76">
		<textArea name="summary"  cols="95" rows="7"><%=props.getProperty("summary", "")%></textArea>
	</td>
  </tr>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="4"  align="left" class="style76">
		...
		<input type="text" name="completedBy" size="45" value="<%=props.getProperty("completedBy", "")%>">
	</td>
    ...
    <td width="22%"  colspan="1"  align="left" valign="middle"  STYLE="text-align:right"  class="style76">
		<input type="text" name="assessCompleteTime" size="15" value="<%=props.getProperty("assessCompleteTime", "")%>">
		am/pm
	</td>
  </tr>	
...
<table width="95%" border="1">
  <tr>	
  	<td colspan="3" align="center" class="style51">
		11. TRIAGE- REFERRAL TO A SEATON HOUSE PROGRAM	
	</td>
  </tr>
  <tr>	
  	<td colspan="3" align="left" class="style76">
