...
%>
        ...
        <td align="right"><b>View:</b> 
            <a href="javascript: popupPage('formonarpg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2 <font size=-2>(pg.1)</font></a> |
            <a href="javascript: popupPage('formonarpg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2 <font size=-2>(pg.2)</font></a>
            &nbsp;
        </td>
...
<table width="50%" border="1"  cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td width="25%">Apt/Suite/Unit<br>
            <input type="text" name="c_apt" style="width:100%" size="20" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("c_apt", "")) %>"/>
        </td>
    </tr>
</table>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td valign="top" width="8%">Province<br>
            <input type="text" name="c_province" style="width:100%" size="60" maxlength="80" value="<%= UtilMisc.htmlEscape(props.getProperty("c_province", "")) %>"/>
        </td>
        <td width="12%">Postal Code<br>
            <input type="text" name="c_postal" style="width:100%" size="7" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("c_postal", "")) %>"/>
        </td>
        <td colspan="2" width="25%">Partner's Last Name<br>
            <input type="text" name="c_partnerLastName" style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("c_partnerLastName", "") %>"/>
        </td>
        <td colspan="2" width="25%">Partner's First Name<br>
            <input type="text" name="c_partnerFirstName" style="width:100%" size="30" maxlength="60" value="<%= props.getProperty("c_partnerFirstName", "") %>"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="2">Partner's Education level <br>
            <input type="text" name="pg1_partnerEduLevel" size="15" style="width:100%" maxlength="25" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_partnerEduLevel", "")) %>"/>
        </td>
        <td width="8%">Age<br>
            <input type="text" name="pg1_partnerAge" style="width:100%" size="5" maxlength="5" value="<%= props.getProperty("pg1_partnerAge", "") %>"/>
        </td>
    </tr>
</table>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top" width="12%">Date of birth<br>
            <input type="text" name="pg1_dateOfBirth" style="width:100%" size="10" maxlength="10" value="<%= props.getProperty("pg1_dateOfBirth", "") %>" readonly="true"/>
        </td>
        <td width="8%">Age<br>
            <input type="text" name="pg1_age" style="width:100%" size="10" maxlength="10" value="<%= props.getProperty("pg1_age", "") %>"/>
        </td>
        ...
        <td colspan="3" width="50%">Ethnic or Racial backgrounds: Mother / Father <br>
            <input type="text" name="pg1_ethnicBg" size="100" style="width:100%" maxlength="200" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_ethnicBg", "")) %>"/>
        </td>
    </tr>
    <tr>
	    ...
	    <td width="15%" nowrap>Marital status <br>
            <input type="checkbox" name="pg1_msMarried" <%= props.getProperty("pg1_msMarried", "") %>/>M
            <input type="checkbox" name="pg1_msCommonLaw" <%= props.getProperty("pg1_msCommonLaw", "") %>/>CL
        ...
        <td width="17%"><font size="-1">Birth attendants<br>
            ...
            <input type="checkbox" name="pg1_baMidwife" <%= props.getProperty("pg1_baMidwife", "") %>/>Midwife<br></font>
        ...
        <td width="17%"><font size="-1">Newborn care<br>
            <input type="checkbox" name="pg1_ncPed" <%= props.getProperty("pg1_ncPed", "") %>/>Ped.
            <input type="checkbox" name="pg1_ncFP"  <%= props.getProperty("pg1_ncFP", "") %>/>FP
            <input type="checkbox" name="pg1_ncMidwife" <%= props.getProperty("pg1_ncMidwife", "") %>/>Midwife<br></font>
            <input type="text" name="c_nc" size="10" style="width:100%" maxlength="25" value="<%= props.getProperty("c_nc", "") %>"/>
	    </td>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
        <td width="50%">Allergies or Sensitivities (describe reaction details)<br>
            <div align="center"><textarea name="c_allergies" style="width:100%" cols="30" rows="2"><%= props.getProperty("c_allergies", "") %></textarea></div>
        </td>
        <td width="50%" >Medications/Herbals<br>
            <div align="center"><textarea name="c_meds" style="width:100%" cols="30" rows="2"><%= props.getProperty("c_meds", "") %></textarea></div>
        </td>
    </tr>
</table>
...
<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    <tr>
		...
		<table width="100%" border="1"  cellspacing="0" cellpadding="0">
    	<tr>
            <td valign="top" nowrap>LMP 
            <input type="text" name="pg1_menLMP" id="pg1_menLMP" size="10" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_menLMP", "")) %>"/>
            <img src="../images/cal.gif" id="pg1_menLMP_cal">
            </td><td>
            Certain
            </td><td>
            Yes <input type="checkbox" name="pg1_psCertY" <%= props.getProperty("pg1_psCertY", "") %>/>
            No <input type="checkbox" name="pg1_psCertN" <%= props.getProperty("pg1_psCertN", "") %>/>
            </td>
        </tr><tr>
        	<td>
        	Cycle q__
            ...
            Yes <input type="checkbox" name="pg1_menReg" <%= props.getProperty("pg1_menReg", "") %>/>
            No <input type="checkbox" name="pg1_menRegN" <%= props.getProperty("pg1_menRegN", "") %>/>
            </td>
        </tr><tr>
        	<td>
 			Contraceptive type
            <input type="text" name="pg1_contracep" size="15" maxlength="25" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_contracep", "")) %>"/>
            ...
            <input type="text" name="pg1_lastUsed" id="pg1_lastUsed" size="10" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_lastUsed", "")) %>"/>
            <img src="../images/cal.gif" id="pg1_lastUsed_cal">
        	</td>
        </tr>
        </table>
 			...
 			EDB (by dates)</br>
            <input type="text" name="pg1_menEDB" id="pg1_menEDB" class="spe" onDblClick="calByLMP(this);" size="10" maxlength="10" value="<%= props.getProperty("pg1_menEDB", "") %>"/>
			<img src="../images/cal.gif" id="pg1_menEDB_cal">
        </td>
    	...
    	<tr><td valign="top" align="center">
         <font size="+1"><b>Final EDB</font></b></font><br>
            <input type="text" name="c_finalEDB" id="c_finalEDB" size="10" maxlength="10" value="<%= props.getProperty("c_finalEDB", "") %>"/>
            <img src="../images/cal.gif" id="c_finalEDB_cal">
        </td>
        <td width="40%">
        	<u>Dating Method</u></br>
            <input type="checkbox" name="pg1_edbByDate" <%= props.getProperty("pg1_edbByDate", "") %>/>Dates<br>
            <input type="checkbox" name="pg1_edbByT1" <%= props.getProperty("pg1_edbByT1", "") %>/>T1US<br>
            <input type="checkbox" name="pg1_edbByT2" <%= props.getProperty("pg1_edbByT2", "") %>/>T2US<br>
            <input type="checkbox" name="pg1_edbByART" <%= props.getProperty("pg1_edbByART", "") %>/>ART (e.g. IVF)
        </td>
        </tr>
        </table>
    ...
    <tr>
		...
		<table width="100%" border="1"  cellspacing="0" cellpadding="0">
			<tr>
		        <td>Gravida
		            <input type="text" name="c_gravida" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("c_gravida", "")) %>"/>
			    </td>
		        <td>Term
		            <input type="text" name="c_term" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("c_term", "")) %>"/>
			    </td>
		        <td>Premature
		            <input type="text" name="c_prem" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("c_prem", "")) %>"/>
			    </td>
		        <td valign="top" nowrap>Abortuses
		            <input type="text" name="c_abort" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("c_abort", "")) %>"/>
		        ...
		        <td>Living
		            <input type="text" name="c_living" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("c_living", "")) %>"/>
			    </td>
        ...
        <td   valign="top">
            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                <tr align="center">
                    ...
                    <td width="60">Gest. age<br>(weeks) </td>
                    <td width="60">Birth<br>weight </td>
                    <td width="60">Length<br>of labour</td>
                    <td width="80">Place<br>of birth</td>
                    <td width="90">Type of delivery<br><font size="-1">SVB CS Ass'd</font></td>
...
<table class="shrinkMe"  width="100%" border="0" cellspacing="0" cellpadding="0" >
	    ...
	    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="center" width="12%"><div align="right">Yes</div></td>
                    <td align="center" nowrap width="12%"><div align="right">No</div></td>
                </tr>
		        <tr>
                    <td width="6%">1.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c1p1");return false;'>Bleeding</a></td>
                    <td><input type="checkbox" name="pg1_cp1" <%= props.getProperty("pg1_cp1", "") %> /></td>
                    <td><input type="checkbox" name="pg1_cp1N" <%= props.getProperty("pg1_cp1N", "") %> /></td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c2p1");return false;'>Nausea, vomiting</a></td>
                    <td><input type="checkbox" name="pg1_cp2" <%= props.getProperty("pg1_cp2", "") %>/></td>
                    <td><input type="checkbox" name="pg1_cp2N" <%= props.getProperty("pg1_cp2N", "") %>/></td>
                </tr>
                <tr>
                    <td>3.</td>
                    <td nowrap><a href=# onClick='popupPage("<%=resource%>c3p1");return false;'>Smoking</a>
                        <font size=1>
                        <input type="text" name="pg1_box3" size="1" maxlength="3" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_box3", "")) %>">cig/day</font>
                    </td>
                    <td><input type="checkbox" name="pg1_cp3" <%= props.getProperty("pg1_cp3", "") %>></td>
                    <td><input type="checkbox" name="pg1_cp3N" <%= props.getProperty("pg1_cp3N", "") %>></td>
                </tr>
                <tr>
                    <td>4.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c4p1");return false;'>Alcohol, street drugs</a></td>
                    <td><input type="checkbox" name="pg1_cp4" <%= props.getProperty("pg1_cp4", "") %>/></td>
                    <td><input type="checkbox" name="pg1_cp4N" <%= props.getProperty("pg1_cp4N", "") %>/></td>
                </tr>
                <!--  tr>
                    <td valign="top">5.</td>
                ...
                <tr>
                    <td valign="top">5.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c8p1");return false;'>Occup/Environ. risks</a></td>
                    <td><input type="checkbox" name="pg1_cp8" <%= props.getProperty("pg1_cp8", "") %>/></td>
                    <td><input type="checkbox" name="pg1_cp8N" <%= props.getProperty("pg1_cp8", "") %>/></td>
                </tr>
                <tr>
                    <td valign="top">6.</td>
                    <td >Dietary restrictions</td>
                    <td><input type="checkbox" name="pg1_naDietRes" <%= props.getProperty("pg1_naDietRes", "") %>></td>
                    <td><input type="checkbox" name="pg1_naDietBal" <%= props.getProperty("pg1_naDietBal", "") %>></td>
                </tr>
                <tr>
                    <td valign="top">7.</td>
                    <td >Calcium adequate</td>
                    <td><input type="checkbox" name="pg1_naMilk" <%= props.getProperty("pg1_naMilk", "") %>></td>
                    <td><input type="checkbox" name="pg1_naMilkN" <%= props.getProperty("pg1_naMilkN", "") %>></td>
                </tr>
                <tr>
                    <td valign="top">8.</td>
                    <td >Preconceptual folate</td>
                    <td><input type="checkbox" name="pg1_naFolic" <%= props.getProperty("pg1_naFolic", "") %>></td>
                    <td><input type="checkbox" name="pg1_naFolicN" <%= props.getProperty("pg1_naFolicN", "") %>></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_yes9" <%= props.getProperty("pg1_yes9", "") %>></td>
                    <td><input type="checkbox" name="pg1_no9" <%= props.getProperty("pg1_no9", "") %>></td>
                </tr>
                <tr>
                    <td>10.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c10p1");return false;'>Endocrine</a></td>
                    <td><input type="checkbox" name="pg1_yes10" <%= props.getProperty("pg1_yes10", "") %>></td>
                    <td><input type="checkbox" name="pg1_no10" <%= props.getProperty("pg1_no10", "") %>></td>
                </tr>
                <!--  tr>
                    <td>11.</td>
                ...
                <tr>
                    <td>11.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c12p1");return false;'>Urinary tract</a></td>
                    <td><input type="checkbox" name="pg1_yes12" <%= props.getProperty("pg1_yes12", "") %>></td>
                    <td><input type="checkbox" name="pg1_no12" <%= props.getProperty("pg1_no12", "") %>></td>
                </tr>
                <tr>
                    <td>12.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c13p1");return false;'>Cardiac/Pulmonary</a></td>
                    <td><input type="checkbox" name="pg1_yes13" <%= props.getProperty("pg1_yes13", "") %>></td>
                    <td><input type="checkbox" name="pg1_no13" <%= props.getProperty("pg1_no13", "") %>></td>
                </tr>
                <tr>
                    <td>13.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c14p1");return false;'>Liver, hepatitis, GI</a></td>
                    <td><input type="checkbox" name="pg1_yes14" <%= props.getProperty("pg1_yes14", "") %>></td>
                    <td><input type="checkbox" name="pg1_no14" <%= props.getProperty("pg1_no14", "") %>></td>
                </tr>
                <tr>
                    <td>14.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c17p1");return false;'>Gynaecology/Breast</a></td>
                    <td><input type="checkbox" name="pg1_yes17" <%= props.getProperty("pg1_yes17", "") %>></td>
                    <td><input type="checkbox" name="pg1_no17" <%= props.getProperty("pg1_no17", "") %>></td>
                </tr>
                <tr>
                    <td>15.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c22p1");return false;'>Hem./Immunology</a></td>
                    <td><input type="checkbox" name="pg1_yes22" <%= props.getProperty("pg1_yes22", "") %>></td>
                    <td><input type="checkbox" name="pg1_no22" <%= props.getProperty("pg1_no22", "") %>></td>
                </tr>
                <tr>
                    <td>16.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c20p1");return false;'>Surgeries</a></td>
                    <td><input type="checkbox" name="pg1_yes20" <%= props.getProperty("pg1_yes20", "") %>></td>
                    <td><input type="checkbox" name="pg1_no20" <%= props.getProperty("pg1_no20", "") %>></td>
                </tr>
                <tr>
                    <td>17.</td>
                    <td>Blood transfusion</td>
                    <td><input type="checkbox" name="pg1_bloodTranY" <%= props.getProperty("pg1_bloodTranY", "") %>></td>
                    <td><input type="checkbox" name="pg1_bloodTranN" <%= props.getProperty("pg1_bloodTranN", "") %>></td>
                </tr>
                <tr>
                    <td>18.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c21p1");return false;'>Anesthetics compl.</a></td>
                    <td><input type="checkbox" name="pg1_yes21" <%= props.getProperty("pg1_yes21", "") %>></td>
                    <td><input type="checkbox" name="pg1_no21" <%= props.getProperty("pg1_no21", "") %>></td>
                </tr>
                <tr>
                    <td>19.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c24p1");return false;'>Psychiatric</a></td>
                    <td><input type="checkbox" name="pg1_yes24" <%= props.getProperty("pg1_yes24", "") %>></td>
                    <td><input type="checkbox" name="pg1_no24" <%= props.getProperty("pg1_no24", "") %>></td>
                </tr>
                <tr>
                    <td>20.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c15p1");return false;'>Epilepsy/Neurological</a></td>
                    <td><input type="checkbox" name="pg1_yes15" <%= props.getProperty("pg1_yes15", "") %>></td>
                    <td><input type="checkbox" name="pg1_no15" <%= props.getProperty("pg1_no15", "") %>></td>
                </tr>
                <tr>
                    <td>21.</td>
                    <td>Other
                    <input type="text" name="pg1_box25" size="8" maxlength="25" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_box25", "")) %>">
                    </td>
                    <td><input type="checkbox" name="pg1_yes25" <%= props.getProperty("pg1_yes25", "") %>></td>
                    <td><input type="checkbox" name="pg1_no25" <%= props.getProperty("pg1_no25", "") %>></td>
                </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>22.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c27p1");return false;'>At risk population</a></td>
                    <td align="center" valign="top"><input type="checkbox" name="pg1_yes27" <%= props.getProperty("pg1_yes27", "") %>></td>
                    <td align="center" valign="top"><input type="checkbox" name="pg1_no27" <%= props.getProperty("pg1_no27", "") %>></td>
                </tr>
                <tr>
                    <td colspan="4">
                        <span class="small">(e.g.:Ashkenazi, consanguinity, CF, sickle cell,Tay Sachs,thalassemia)</span>
					</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>23.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c31p1");return false;'>Developmental delay</a></td>
                    <td align="center"><input type="checkbox" name="pg1_yes31" <%= props.getProperty("pg1_yes31", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no31" <%= props.getProperty("pg1_no31", "") %>></td>
                </tr>
                <tr>
                    <td>24.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c32p1");return false;'>Congenital anomalies</a></td>
                    <td align="center"><input type="checkbox" name="pg1_yes32" <%= props.getProperty("pg1_yes32", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no32" <%= props.getProperty("pg1_no32", "") %>></td>
                </tr>
                <!--  tr>
                    <td>33.</td>
                ...
                <tr>
                    <td>25.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c34p1");return false;'>Chromosomal disorders</a></td>
                    <td align="center"><input type="checkbox" name="pg1_yes34" <%= props.getProperty("pg1_yes34", "") %>></td>
                    <td align="center"><input type="checkbox" name="pg1_no34" <%= props.getProperty("pg1_no34", "") %>></td>
                </tr>
                <tr>
                    <td>26.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c35p1");return false;'>Genetic disorders</a></td>
                    <td align="center" valign="top"><input type="checkbox" name="pg1_yes35" <%= props.getProperty("pg1_yes35", "") %>></td>
                    <td align="center" valign="top"><input type="checkbox" name="pg1_no35" <%= props.getProperty("pg1_no35", "") %>></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td>27.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c40p1");return false;'>Varicella susceptible</a></td>
                    <td><input type="checkbox" name="pg1_idt40" <%= props.getProperty("pg1_idt40", "") %>></td>
                    <td><input type="checkbox" name="pg1_idt40N" <%= props.getProperty("pg1_idt40N", "") %>></td>
                </tr>
                <tr>
                    <td>28.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c38p1");return false;'>STDs/HSV/BV</a></td>
                    <td><input type="checkbox" name="pg1_idt38" <%= props.getProperty("pg1_idt38", "") %>></td>
                    <td><input type="checkbox" name="pg1_idt38N" <%= props.getProperty("pg1_idt38N", "") %>></td>
                </tr>
                <tr>
                    <td>29.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c42p1");return false;'>Tuberculosis risk</a></td>
                    ...
                    <td><input type="checkbox" name="pg1_idt42N" <%= props.getProperty("pg1_idt42N", "") %>></td>
                </tr>
                <tr>
                    <td>30.</td>
                    <td>Other
                        <input type="text" name="pg1_infectDisOther" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_infectDisOther", "")) %>"></td>
                    <td><input type="checkbox" name="pg1_infectDisOtherY" <%= props.getProperty("pg1_infectDisOtherY", "") %>></td>
                    <td><input type="checkbox" name="pg1_infectDisOtherN" <%= props.getProperty("pg1_infectDisOtherN", "") %>></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td>31.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c43p1");return false;'>Poor social support</a></td>
                    <td><input type="checkbox" name="pg1_pdt43" <%= props.getProperty("pg1_pdt43", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt43N" <%= props.getProperty("pg1_pdt43N", "") %>></td>
                </tr>
                <tr>
                    <td>32.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c44p1");return false;'>Relationship problems</a></td>
                    <td><input type="checkbox" name="pg1_pdt44" <%= props.getProperty("pg1_pdt44", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt44N" <%= props.getProperty("pg1_pdt44N", "") %>></td>
                </tr>
                <tr>
                    <td>33.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c45p1");return false;'>Emotional/Depression</a></td>
                    <td><input type="checkbox" name="pg1_pdt45" <%= props.getProperty("pg1_pdt45", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt45N" <%= props.getProperty("pg1_pdt45N", "") %>></td>
                </tr>
                <tr>
                    <td>34.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c46p1");return false;'>Substance abuse</a></td>
                    <td><input type="checkbox" name="pg1_pdt46" <%= props.getProperty("pg1_pdt46", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt46N" <%= props.getProperty("pg1_pdt46N", "") %>></td>
                </tr>
                <tr>
                    <td>35.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c47p1");return false;'>Family violence</a></td>
                    <td><input type="checkbox" name="pg1_pdt47" <%= props.getProperty("pg1_pdt47", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt47N" <%= props.getProperty("pg1_pdt47N", "") %>></td>
                </tr>
                <tr>
                    <td>36.</td>
                    <td><a href=# onClick='popupPage("<%=resource%>c48p1");return false;'>Parenting concerns</a></td>
                    <td><input type="checkbox" name="pg1_pdt48" <%= props.getProperty("pg1_pdt48", "") %>></td>
                    <td><input type="checkbox" name="pg1_pdt48N" <%= props.getProperty("pg1_pdt48N", "") %>></td>
                </tr>
                <tr>
                    <td>37.</td>
                    <td>Relig./Cultural issues</td>
                    <td><input type="checkbox" name="pg1_reliCultY" <%= props.getProperty("pg1_reliCultY", "") %>></td>
                    <td><input type="checkbox" name="pg1_reliCultN" <%= props.getProperty("pg1_reliCultN", "") %>></td>
                </tr>
            </table>    
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                 ...
                 <tr>
                    ...
                    <td><input type="checkbox" name="pg1_fhRiskY" <%= props.getProperty("pg1_fhRiskY", "") %>></td>
                    <td><input type="checkbox" name="pg1_fhRiskN" <%= props.getProperty("pg1_fhRiskN", "") %>></td>
                </tr>
                <tr>
                    <td colspan="4">
                    (e.g.: DM, DVT/PE, PIH/HT,</br>postpartum depression, thyroid)
					</td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4">
                        Ht.<input type="text" name="pg1_ht" onDblClick="htEnglish2Metric(this);" size="5" maxlength="6"  value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_ht", "")) %>" />
                        Wt.<input type="text" name="pg1_wt" onDblClick="wtEnglish2Metric(this);" size="5" maxlength="6"  value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_wt", "")) %>" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4">
                        BMI<input type="text" name="c_bmi" class="spe" onDblClick="calcBMIMetric(this);" size="6" maxlength="6" value="<%= UtilMisc.htmlEscape(props.getProperty("c_bmi", "")) %>">
                        BP<input type="text" name="pg1_BP" size="6" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_BP", "")) %>">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;</td>
                ...
                <tr>
                    <td>39.</td>
                    <td>Thyroid</td>
                    <td><input type="checkbox" name="pg1_thyroid" <%= props.getProperty("pg1_thyroid", "") %>></td>
                    <td><input type="checkbox" name="pg1_thyroidA" <%= props.getProperty("pg1_thyroidA", "") %>></td>
                </tr>
                <tr>
                    <td>40.</td>
                    <td>Chest</td>
                    <td><input type="checkbox" name="pg1_chest" <%= props.getProperty("pg1_chest", "") %>></td>
                    <td><input type="checkbox" name="pg1_chestA" <%= props.getProperty("pg1_chestA", "") %>></td>
                </tr>
                <tr>
                    <td>41.</td>
                    <td>Breasts</td>
                    <td><input type="checkbox" name="pg1_breasts" <%= props.getProperty("pg1_breasts", "") %>></td>
                    <td><input type="checkbox" name="pg1_breastsA" <%= props.getProperty("pg1_breastsA", "") %>></td>
                </tr>
                <tr>
                    <td>42.</td>
                    <td>Cardiovascular</td>
                    <td><input type="checkbox" name="pg1_cardio" <%= props.getProperty("pg1_cardio", "") %>></td>
                    <td><input type="checkbox" name="pg1_cardioA" <%= props.getProperty("pg1_cardioA", "") %>></td>
                </tr>
                <tr>
                    <td>43.</td>
                    <td>Abdomen</td>
                    <td><input type="checkbox" name="pg1_abdomen" <%= props.getProperty("pg1_abdomen", "") %>></td>
                    <td><input type="checkbox" name="pg1_abdomenA" <%= props.getProperty("pg1_abdomenA", "") %>></td>
                </tr>
                <tr>
                    <td>44.</td>
                    <td>Varicosities / Extrm.</td>
                    <td><input type="checkbox" name="pg1_vari" <%= props.getProperty("pg1_vari", "") %>></td>
                    <td><input type="checkbox" name="pg1_variA" <%= props.getProperty("pg1_variA", "") %>></td>
                </tr>
                <!-- tr>
                    <td>Neurological</td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="pg1_extGen" <%= props.getProperty("pg1_extGen", "") %>></td>
                    <td><input type="checkbox" name="pg1_extGenA" <%= props.getProperty("pg1_extGenA", "") %>></td>
                </tr>
                <tr>
                    <td>46.</td>
                    <td>Cervix, vagina</td>
                    <td><input type="checkbox" name="pg1_cervix" <%= props.getProperty("pg1_cervix", "") %>></td>
                    <td><input type="checkbox" name="pg1_cervixA" <%= props.getProperty("pg1_cervixA", "") %>></td>
                </tr>
                <tr>
                    <td>47.</td>
                    <td>Uterus
                    </td>
                    <td><input type="checkbox" name="pg1_uterus" <%= props.getProperty("pg1_uterus", "") %>></td>
                    <td><input type="checkbox" name="pg1_uterusA" <%= props.getProperty("pg1_uterusA", "") %>></td>
                </tr>
                <tr>
                    <td>48.</td>
                    <td>Size:
                ...
                <tr>
                    <td>49.</td>
                    <td>Adnexa</td>
                    <td><input type="checkbox" name="pg1_adnexa" <%= props.getProperty("pg1_adnexa", "") %>></td>
                    <td><input type="checkbox" name="pg1_adnexaA" <%= props.getProperty("pg1_adnexaA", "") %>></td>
                </tr>
                <tr>
                    <td>50.</td>
                    <td>Other
                        <input type="text" name="pg1_pExOther" size="6" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_pExOther", "")) %>"></td>
                    <td><input type="checkbox" name="pg1_pExOtherN" <%= props.getProperty("pg1_pExOtherN", "") %>></td>
                    <td><input type="checkbox" name="pg1_pExOtherA" <%= props.getProperty("pg1_pExOtherA", "") %>></td>
                </tr>
            </table>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0" >
	    <tr>
	        <td colspan="4" align="center" bgcolor="#CCCCCC" ><b><font face="Verdana, Arial, Helvetica, sans-serif">
	            Initial Laboratory Investigations</font></b></td>
	    </tr>
	    <tr>
	    	<td width="30%">Test</td><td width="20%">Result</td><td width="30%">Test</td><td>Result</td>
	    </tr>
	    <tr>
	    	<td>Hb</td>
	    	<td>
			<input type="text" name="pg1_labHb" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labHb", "")) %>"></td>
			</td>
			<td>HIV</td>
			<td>
			<input type="text" name="pg1_labHIV" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labHIV", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	    	<td>MCV</td>
	    	<td>
			<input type="text" name="pg1_labMCV" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labMCV", "")) %>"></td>
			</td>
			<td colspan="2">
            <input type="checkbox" name="pg1_labHIVCounsel" <%= props.getProperty("pg1_labHIVCounsel", "") %>>
	    ...
	    <tr>
	    	<td>ABO</td>
	    	<td>
			<input type="text" name="pg1_labABO" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labABO", "")) %>"></td>
			</td>
			<td valign="top" rowspan="2">Last Pap
			<img src="../images/cal.gif" id="pg1_labLastPapDate_cal"> </br>
			<input type="text" name="pg1_labLastPapDate" id="pg1_labLastPapDate" size="10" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labLastPapDate", "")) %>"></td>
			</td>
			<td valign="top" rowspan="2">
			<input type="text" name="pg1_labLastPap" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labLastPap", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	    	<td>Rh</td>
	    	<td>
			<input type="text" name="pg1_labRh" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labRh", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	    	<td>Antibody Screen</td>
	    	<td>
			<input type="text" name="pg1_labAntiScr" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labAntiScr", "")) %>"></td>
			</td>
			<td>GC/Chlamydia</td>
			<td>
			<input type="text" name="pg1_labGC" size="10" maxlength="10" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labGC", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	    	<td>Rubella immune</td>
	    	<td>
			<input type="text" name="pg1_labRubella" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labRubella", "")) %>"></td>
			</td>
			<td>Urine C&S</td>
			<td>
			<input type="text" name="pg1_labUrine" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labUrine", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	    	<td>HBsAg</td>
	    	<td>
			<input type="text" name="pg1_labHBsAg" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labHBsAg", "")) %>"></td>
			</td>
			<td></td><td></td>
	    </tr>
	    <tr>
	    	<td>VDRL</td>
	    	<td>
			<input type="text" name="pg1_labVDRL" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labVDRL", "")) %>"></td>
			</td>
			<td></td><td></td>
	    </tr>
	    <tr>
	    	<td>Sickle Cell</td>
	    	<td>
			<input type="text" name="pg1_labSickle" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_labSickle", "")) %>"></td>
			</td>
			<td></td><td></td>
	    </tr>
	</table>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0" >
	    <tr>
	        <th><u>Prenatal Genetic Investigations</u></th><th>Result</th>
	    </tr>
	    <tr>
	        <td>a) All ages-<a href=# onClick='popupPage("<%=resource%>c37p1");return false;'>MSS</a>, IPS, FTS</td>
	        <td>
			<input type="text" name="pg1_geneticA" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_geneticA", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	        <td><a href=# onClick='popupPage("<%=resource%>c26p1");return false;'>b) Age &gt;= 35 at EDB-CVS/amnio</a></td>
	        <td>
			<input type="text" name="pg1_geneticB" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_geneticB", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	        <td>c) If a or b declined, or twins, then MSAFP</td>
	        <td>
			<input type="text" name="pg1_geneticC" size="10" maxlength="20" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_geneticC", "")) %>"></td>
			</td>
	    </tr>
	    <tr>
	        <td>d) Counseled and test declined, or too late</td>
	        <td align="center">
            <input type="checkbox" name="pg1_geneticD" <%= props.getProperty("pg1_geneticD", "") %>>
			</td>
	    </tr>
	</table>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
        <td colspan="4">
            <textarea name="pg1_commentsAR1" style="width:100%" cols="80" rows="5" ><%= props.getProperty("pg1_commentsAR1", "") %></textarea>
        </td>
    </tr>
    <tr>
        ...
        <td width="20%">Date (yyyy/mm/dd)<br>
            <input type="text" name="pg1_formDate" class="spe" onDblClick="calToday(this)" size="10" maxlength="10" style="width:80%" value="<%= props.getProperty("pg1_formDate", "") %>">
	    </td>
        <td width="30%">Signature<br>
            <input type="text" name="pg1_signature2" size="30" maxlength="50" style="width:80%" value="<%= UtilMisc.htmlEscape(props.getProperty("pg1_signature2", "")) %>">
	    </td>
        <td width="20%">Date (yyyy/mm/dd)<br>
