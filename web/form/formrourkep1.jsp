...
<table cellpadding="0" cellspacing="0"   class="Header" class="hidePrint">
    <tr>
        <td nowrap="true">
            ...
            <input type="button" value="<bean:message key="oscarEncounter.formRourke1.btnPrint"/>" onclick="javascript:return onPrint();" />
        </td>
        ...
        <td nowrap="true">
            <a ><bean:message key="oscarEncounter.formRourke1.msgPage1"/></a>&nbsp;|&nbsp;
            <a href="formrourkep2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><bean:message key="oscarEncounter.formRourke1.btnPage2"/></a>&nbsp;|&nbsp;
            <a href="formrourkep3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>"><bean:message key="oscarEncounter.formRourke1.btnPage3"/></a>
        </td>
    </tr>
</table>
    ...
    <tr valign="top">
        ...
        <td width="65%" nowrap align="center">
            <p>
                ...
                &nbsp;&nbsp;
                <bean:message key="oscarEncounter.formRourke1.msgBirthDate"/> (yyyy/mm/dd): <input type="text" name="c_birthDate" size="10" maxlength="10" value="<%= props.getProperty("c_birthDate", "") %>" readonly="true">
                &nbsp;&nbsp;
            ...
            <p>
                <bean:message key="oscarEncounter.formRourke1.msgLenght"/>: <input type="text" name="c_length" size="6" maxlength="6" value="<%= props.getProperty("c_length", "") %>"/> <bean:message key="oscarEncounter.formRourke1.msgLenghtUnit"/>
                &nbsp;&nbsp;
                <bean:message key="oscarEncounter.formRourke1.msgHeadCirc"/>: <input type="text" name="c_headCirc" size="6" maxlength="6" value="<%= props.getProperty("c_headCirc", "") %>"/> <bean:message key="oscarEncounter.formRourke1.msgHeadCircUnit"/>
                &nbsp;&nbsp;
                <bean:message key="oscarEncounter.formRourke1.msgBirthWt"/>: <input type="text" name="c_birthWeight" size="6" maxlength="7" value="<%= props.getProperty("c_birthWeight", "") %>"/> <bean:message key="oscarEncounter.formRourke1.msgBirthWtUnit"/>
                &nbsp;&nbsp;
                <bean:message key="oscarEncounter.formRourke1.msgDischargeWt"/>: <input type="text" name="c_dischargeWeight" size="6" maxlength="7"  value="<%= props.getProperty("c_dischargeWeight", "") %>"> <bean:message key="oscarEncounter.formRourke1.msgDischargeWtUnit"/>
            </p>
        </td>
    </tr>
</table>
<table cellpadding="0" cellspacing="0"   width="100%" border="1"  >
    <tr align="center">
        ...
        <td colspan="3" class="row"><a><bean:message key="oscarEncounter.formRourke1.btn2Months"/></a></td>
    </tr>
    <tr align="center">
        <td class="column"><a><bean:message key="oscarEncounter.formRourke1.msgDate"/></a></td>
        <td colspan="3"><bean:message key="oscarEncounter.formRourke1.formDate"/> <input type="text" name="p1_date1w" size="10" value="<%=props.getProperty("p1_date1w", "")%>" /></td>
        <td colspan="3"><bean:message key="oscarEncounter.formRourke1.formDate"/> <input type="text" name="p1_date2w" size="10" value="<%=props.getProperty("p1_date2w", "")%>" /></td>
        <td colspan="3"><bean:message key="oscarEncounter.formRourke1.formDate"/> <input type="text" name="p1_date1m" size="10" value="<%=props.getProperty("p1_date1m", "")%>" /></td>
        <td colspan="3"><bean:message key="oscarEncounter.formRourke1.formDate"/> <input type="text" name="p1_date2m" size="10" value="<%=props.getProperty("p1_date2m", "")%>" /></td>
    </tr>
    <tr align="center">
        <td class="column" rowspan="2"><a><bean:message key="oscarEncounter.formRourke1.btnGrowth"/></a></td>
    ...
    <tr align="center">
        <td><input type="text" class="wide" name="p1_ht1w" size="4" maxlength="5" value="<%= props.getProperty("p1_ht1w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_wt1w" size="4" maxlength="5" value="<%= props.getProperty("p1_wt1w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_hc1w" size="4" maxlength="5" value="<%= props.getProperty("p1_hc1w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_ht2w" size="4" maxlength="5" value="<%= props.getProperty("p1_ht2w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_wt2w" size="4" maxlength="5" value="<%= props.getProperty("p1_wt2w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_hc2w" size="4" maxlength="5" value="<%= props.getProperty("p1_hc2w", "") %>"></td>
        <td><input type="text" class="wide" name="p1_ht1m" size="4" maxlength="5" value="<%= props.getProperty("p1_ht1m", "") %>"></td>
        <td><input type="text" class="wide" name="p1_wt1m" size="4" maxlength="5" value="<%= props.getProperty("p1_wt1m", "") %>"></td>
        <td><input type="text" class="wide" name="p1_hc1m" size="4" maxlength="5" value="<%= props.getProperty("p1_hc1m", "") %>"></td>
        <td><input type="text" class="wide" name="p1_ht2m" size="4" maxlength="5" value="<%= props.getProperty("p1_ht2m", "") %>"></td>
        <td><input type="text" class="wide" name="p1_wt2m" size="4" maxlength="5" value="<%= props.getProperty("p1_wt2m", "") %>"></td>
        <td><input type="text" class="wide" name="p1_hc2m" size="4" maxlength="5" value="<%= props.getProperty("p1_hc2m", "") %>"></td>
    </tr>
    <tr align="center">
        <td class="column"><a><bean:message key="oscarEncounter.formRourke1.formParentalConcerns"/></a></td>
        <td colspan="3">
            <textarea name="p1_pConcern1w" style="width:100%" cols="10" rows="2"><%= props.getProperty("p1_pConcern1w", "") %></textarea>
        </td>
        <td colspan="3">
            <textarea name="p1_pConcern2w" style="width:100%" cols="10" rows="2"><%= props.getProperty("p1_pConcern2w", "") %></textarea>
        </td>
        <td colspan="3">
            <textarea name="p1_pConcern1m" style="width:100%" cols="10" rows="2"><%= props.getProperty("p1_pConcern1m", "") %></textarea>
        </td>
        <td colspan="3">
            <textarea name="p1_pConcern2m" style="width:100%" cols="10" rows="2"><%= props.getProperty("p1_pConcern2m", "") %></textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>n_breastFeeding');return false;"><bean:message key="oscarEncounter.formRourke1.btnBreastFeeding"/></a><bean:message key="oscarEncounter.formRourke1.msgBreastFeedingDescr"/></b></td>
                </tr>
                <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td nowrap="true"><b><a href="#" onclick="popup('<%=resource%>n_breastFeeding');return false;"><bean:message key="oscarEncounter.formRourke1.btnBreastFeeding"/></a><bean:message key="oscarEncounter.formRourke1.msgBreastFeedingDescr"/></b></td>
                </tr>
                <tr>
    ...
    <tr>
        <td class="column">
            <table cellpadding="0" cellspacing="0"   width="100%" class="column">
                ...
                <tr>
                    <td align="right"><bean:message key="oscarEncounter.formRourke1.msgSafety"/></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td align="right"><bean:message key="oscarEncounter.formRourke1.msgBehaviour"/></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td align="right"><bean:message key="oscarEncounter.formRourke1.msgFamily"/></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                ...
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td align="right"><bean:message key="oscarEncounter.formRourke1.msgOther"/></td>
                </tr>
            </table>
        </td>
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>s_motorVehicleAccidents');return false;"><bean:message key="oscarEncounter.formRourke1.formCarSeat"/></a>*</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>hri_homeVisits');return false;"><bean:message key="oscarEncounter.formRourke1.btnHomeVisit"/></a>*</b></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"  name="p1_sleepPos1w" <%= props.getProperty("p1_sleepPos1w", "") %>></td>
                    <td><b><a href="#" onclick="popup('<%=resource%>o_sleepPosition');return false;"><bean:message key="oscarEncounter.formRourke1.btnSleepPosition"/></a>*</b><td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>o_secondHandSmoke');return false;"><bean:message key="oscarEncounter.formRourke1.formSecondHandSmoke"/></a>*</b></td>
                </tr>
          </table>
        </td>
        <td colspan="3" valign="top">
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td>Carbon monoxide/ <i><a href="#" onclick="popup('<%=resource%>s_burns');return false;">Smoke detectors</a>*</i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"  name="p1_sleepwear1m" <%= props.getProperty("p1_sleepwear1m", "") %>></td>
                    <td><i><a href="#" onclick="popup('<%=resource%>s_burns');return false;"><bean:message key="oscarEncounter.formRourke1.formSleepwear"/></a></i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"  name="p1_hotWater1m" <%= props.getProperty("p1_hotWater1m", "") %>></td>
                    <td><i><a href="#" onclick="popup('<%=resource%>s_burns');return false;"><bean:message key="oscarEncounter.formRourke1.btnHotWater"/></a>*</i></td>
                </tr>
                <tr>
                    <td valign="top"><input type="checkbox" class="chk"  name="p1_toys1m" <%= props.getProperty("p1_toys1m", "") %>></td>
                    <td><a href="#" onclick="popup('<%=resource%>s_choking');return false;"><bean:message key="oscarEncounter.formRourke1.btnSafeToys"/></a>*</td>
                </tr>
                <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td><i><a href="#" onclick="popup('<%=resource%>s_falls');return false;"><bean:message key="oscarEncounter.formRourke1.btnFalls"/></a>*</i></td>
                </tr>
                <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>pe_cover');return false;"><bean:message key="oscarEncounter.formRourke1.btnCoverTest"/></a>*</b></td>
                </tr>
                <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td></i><b><a href="#" onclick="popup('<%=resource%>pe_cover');return false;"><bean:message key="oscarEncounter.formRourke1.btnCoverTest"/></a>*</b></td>
                </tr>
                <tr>
        ...
        <td colspan="3" valign="top">
            <table cellpadding="0" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td><b><a href="#" onclick="popup('<%=resource%>pp_hemoglobinopathyScreening');return false;"><bean:message key="oscarEncounter.formRourke1.formHemoglobinopathy"/></a> (if at risk)*</b></td>
                </tr>
          </table>
        </td>
        <td colspan="3" valign="top">
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" class="wide" style="width:100%" name="p1_signature2w" value="<%= props.getProperty("p1_signature2w", "") %>" />
        </td>
        <td colspan="3">
            <input type="text" class="wide" style="width:100%" name="p1_signature1m" value="<%= props.getProperty("p1_signature1m", "") %>" />
        </td>
        <td colspan="3">
            <input type="text" class="wide" style="width:100%" name="p1_signature2m" value="<%= props.getProperty("p1_signature2m", "") %>" />
        </td>
    </tr>
