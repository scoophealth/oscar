...
<table border="0" cellpadding="0" cellspacing="5" width="98%">
    <tr><td>
            ...
            <html:errors/>
              ...
              <tr><td align='right' nowrap><b><bean:message key="eform.uploadhtml.formSubject"/> </b></td><td><input type="text" name="subject" size="50"></td></tr>
              ...
              <tr><td></td><td><input type="submit" name="subm" value="<bean:message key="eform.uploadhtml.btnUpload"/>"></td></tr>
            </html:form>
            </table>
            </center>
    </td>
    <td style="border-left: 2px solid grey">
        <table border="0" cellspacing="2" cellpadding="2" style="margin-left: 10px" width="100%" >
          ...
          <tr><td align='left'><a href="../eform/efmformmanagerdeleted.jsp" class="current"><bean:message key="eform.uploadhtml.btnDeleted"/> </a></td></tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="98%">
  <tr><td><bean:message key="eform.calldeletedformdata.title"/> </td></tr>
</table>

   <table class="elements" width="98%">
      <tr bgcolor="#CCCCFF" >
      <th><a href="efmformmanagerdeleted.jsp?orderby=form_name"><bean:message key="eform.uploadhtml.btnFormName"/></a></th>
      <th><a href="efmformmanagerdeleted.jsp?orderby=form_subject"><bean:message key="eform.uploadhtml.btnSubject"/></a></th>
      <th><a href="efmformmanagerdeleted.jsp?orderby=file_name"><bean:message key="eform.uploadhtml.btnFile"/></a></th>
      <th><a href="efmformmanagerdeleted.jsp?"><bean:message key="eform.uploadhtml.btnDate"/></a></th>
      <th><bean:message key="eform.uploadhtml.btnTime"/></th> 
      <th><bean:message key="eform.uploadhtml.msgAction"/></th> 
      </tr> 
<%
  ArrayList eForms = EFormUtil.listEForms(orderBy, EFormUtil.DELETED);
...
%>
      <tr style="background-color: <%= ((i%2) == 1)?"#F2F2F2":"white"%>;">
        ...
        <a href="#" onclick="newWindow('efmshowform_data.jsp?fid=<%=curForm.get("fid")%>', '<%="FormD"+i%>'); return false;"><%=curForm.get("formName")%></a></td>
		...
		<td nowrap align='center'><a href="#" onclick="javascript: confirmNRestore('../eform/restoreEForm.do?fid=<%=curForm.get("fid")%>');"><bean:message key="eform.calldeletedformdata.btnRestore"/></a></td>
      </tr>
<% } %>
   </table>
</center>
