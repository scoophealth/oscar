...
<table border="0" cellpadding="0" cellspacing="5" width="98%">
    <tr><td>
            ...
            <table cellspacing="2" cellpadding="2" width="80%" border="0" BGCOLOR="<%=weakColor%>">
                <html:form action="/eform/imageUpload" enctype="multipart/form-data" method="post">
                  <tr><td align='right' nowrap><b><bean:message key="eform.uploadimages.msgFileName"/> </b></td>
                      <td><input type="file" name="image" size="70"></td></tr>
                  <tr><td></td><td><input type="button" name="subm" value="<bean:message key="eform.uploadimages.btnUpload"/>" onclick="javascript:checkFormAndDisable();"></td></tr>
                </html:form>
            </table>
            </center>
    </td>
    <td style="border-left: 2px solid #A6A6A6">
        <table border="0" cellspacing="2" cellpadding="2" style="margin-left: 10px" width="100%" >
          ...
          <tr><td align='left'><a href="../eform/efmimagemanager.jsp" class="current"><bean:message key="admin.admin.btnUploadImage"/> </a></td></tr>
    ...
    <tr><td>
         <center>
           <table class="elements" width="78%">
              <tr><td style="border: none;"><bean:message key="eform.uploadhtml.msgLibrary"/> </td></tr>
              <tr bgcolor="#CCCCFF" >
        ...
        %>
              <tr style="background-color: <%= ((i%2) == 1)?"#F2F2F2":"white"%>;">
                ...
                <a href="#" onclick="showImage('<%=fileURL%>', '<%="image" + i%>'); return false;"><%=curimage%></a></td>
                    <td nowrap align='center'><a href="#" onclick="javascript: deleteImg('<%= curimage%>'); return false;"><bean:message key="eform.uploadimages.btnDelete"/></a></td>
              </tr>
        <% } %>
           </table>
         </center>
