...
%>
<%@ page language="java" %>
<%@ page import="java.util.*,oscar.util.*, org.apache.struts.action.*, oscar.oscarWaitingList.bean.*" %>
...
<head><title>Change Waiting List Name</title></head>
...
%>
    ...
    <html:form action="/oscarWaitingList/WLEditWaitingListNameAction.do?edit=Y">    
	<html:hidden property="actionChosen" />
        <table border="0" width="100%">
          <tr bgcolor="#EEEEFF"> 
            <td width="25%" align="right"  class="data4"> 
            	Please select a Waiting List name to be changed:
            </td>
            <td align="right"> 
            ...
            <td align="left"> 
              <html:text property="wlChangedName" size="45"   maxlength="255"  />
            </td>
            <td width="30%" align="left"> 
            	<input type="submit" value="Change Name" onclick="resetFields('change');document.forms[0].actionChosen.value='change'">
            </td>
          </tr>
          <tr  bgcolor="#EEEEFF"> 
            ...
            <td align="left"> 
              <html:text property="wlNewName" size="45"   maxlength="255"  />
            </td>
		    <td width="30%" align="left"> 
	        	<input type="submit" value="Create Name" onclick="resetFields('create');document.forms[0].actionChosen.value='create'">
	        </td>
          </tr>
          <tr bgcolor="#EEEEFF"> 
            <td width="25%" align="right" class="data4"> 
            	Please select a Waiting List name to be removed:
            </td>
            <td align="right"> 
                    <html:select property="selectedWL2">
                         <option value=""> </option>
                         <%
                             for(int i=0; i<allWaitingListName.size(); i++){
            ...
            <td colspan="2" align="left"> 
            	<input type="submit" value="Remove Name" onclick="resetFields('remove');document.forms[0].actionChosen.value='remove'" >
            </td>
          </tr>
		...
		<table width="100%">
		  <tr bgcolor="#CCCCFF">
		    <td align="center">
		      <input type="reset"  value='Close' onClick="window.close();"></td>
		  </tr>
		</table>
	...
	<table width="100%">
	  <tr>
	    <td align="center">
			<span style="color:red; font-weight:bold; font-size:14;">
<%-- 								
