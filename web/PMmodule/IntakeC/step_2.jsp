...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxHousingIssue" onclick="document.intakeCForm.elements['intake.cboxNoneListedIssue'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
	 	Housing
</td>
...
<td width="5%">
	<html:checkbox  property="intake.cboxOtherIssue"  styleId="14_PARENT"  
		onclick="unCheckOtherIssues(document.intakeCForm);document.intakeCForm.elements['intake.cboxNoneListedIssue'].checked=false"  />
</td>
<td colspan="3"   class="style76">
	 Other 
</td>
...
<td width="5%">
	<html:checkbox  property="intake.cboxHealthCareIssueOther"    styleId="14_0_CHILD"  
	                onclick="document.intakeCForm.elements['intake.cboxOtherIssue'].checked=true;document.intakeCForm.elements['intake.cboxNoneListedIssue'].checked=false" />  
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByHospital" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
	  	   	General Hospital
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByPsychiatricHospital" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByOtherInstitution" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
	  	   	Other Institution
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByMentalOrg" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
...
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByOtherAgency" 
	  styleId="24a_PARENT"   
	   onclick="unCheckReferralAgency(document.intakeCForm);document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"  />  
</td>
<td colspan="3"   class="style76">
...
<td width="4%">
	<html:checkbox  property="intake.cboxReferralByStreetNurseOther"   styleId="24a_0_CHILD"  
	                onclick="document.intakeCForm.elements['intake.cboxReferralByOtherAgency'].checked=true;document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false" />    
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByPhysician" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
	     	 	Family Physicians
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByPsychiatrists" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
	     	 	Psychiatrists
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralByMentalHealthWorker" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3"   class="style76">
...
<td width="5%"> 
	<html:checkbox  property="intake.cboxReferralByCriminalJusticeSystem"
	   styleId="24b_PARENT"   
	     onclick="unCheckReferralCriminal(document.intakeCForm);document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"  />  
</td>
<td colspan="3"   class="style76">
...
<td width="4%"> 
	<html:checkbox  property="intake.cboxReferralByPolice"   styleId="24b_0_CHILD"    
	                onclick="document.intakeCForm.elements['intake.cboxReferralByCriminalJusticeSystem'].checked=true;document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false" />   
</td>
<td colspan="2" class="style76">
 	 	Police
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxReferralBySelf" onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=false;document.intakeCForm.elements['intake.cboxReferralByPublic'].checked=false"/>  
</td>
<td colspan="3" class="style76">
...
<td width="4%">
	<html:checkbox  property="intake.cboxReferralByPublic"   styleId="24c_0_CHILD"     
	                onclick="document.intakeCForm.elements['intake.cboxReferralByOtherPeople'].checked=true" />     
</td>
<td colspan="2" class="style76">
	    	  	General Public
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCompleteWithoutReferral" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td width="95%" colspan="3" class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCompleteWithReferral" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td colspan="3" class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxSuicideExit" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td colspan="3" class="style76">
	   	 	Suicide
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxDeathExit" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td colspan="3" class="style76">
	  	  	Death
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxRelocationExit" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td colspan="3" class="style76">
	 	  	Relocation
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxWithdrawalExit" onclick="document.intakeCForm.elements['intake.cboxNAExit'].checked=false;"/>  
</td>
<td colspan="3" class="style76">
