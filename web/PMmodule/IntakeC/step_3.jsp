...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxBaseHasCertificate" onclick="document.intakeCForm.elements['intake.cboxBaseHasUnknown'].checked=false;"/>  
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxBaseHasSIn" onclick="document.intakeCForm.elements['intake.cboxBaseHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxBaseHasHealthCard" onclick="document.intakeCForm.elements['intake.cboxBaseHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
	  	Has Health Card
</td>
...
<tr>
    <td width="5%"> 
	<html:checkbox  property="intake.cboxBaseHasNativeCard" onclick="document.intakeCForm.elements['intake.cboxBaseHasUnknown'].checked=false;"/>  
    </td>
<td colspan="3"   class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxBaseHasNonStatus" onclick="document.intakeCForm.elements['intake.cboxBaseHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCurrHasCertificate" onclick="document.intakeCForm.elements['intake.cboxCurrHasUnknown'].checked=false;"/>  
</td>
<td width="95%" colspan="3"   class="style76">
	  	Has Birth Certificate/Record of Landing/Citizenship Card
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCurrHasSIn" onclick="document.intakeCForm.elements['intake.cboxCurrHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
	  	Has Social Insurance Number
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCurrHasHealthCard" onclick="document.intakeCForm.elements['intake.cboxCurrHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
	  	Has Health Card
</td>
...
<tr>
    <td width="5%"> 
	<html:checkbox  property="intake.cboxCurrHasNativeCard" onclick="document.intakeCForm.elements['intake.cboxCurrHasUnknown'].checked=false;"/>  
   </td>
<td colspan="3"   class="style76">
	  	Has Native Status Card
</td>
...
<tr>
<td width="5%">
	<html:checkbox  property="intake.cboxCurrHasNonStatus" onclick="document.intakeCForm.elements['intake.cboxCurrHasUnknown'].checked=false;"/>  
</td>
<td colspan="3"   class="style76">
	 	Has less than full immigration status (i.e. is non-status) 
</td>
