...
<display:table class="simple" cellspacing="2" cellpadding="3"
	...
	<display:column sortable="false" title="">
		<a href="javascript:void(0);"
			onclick="removeFromQueue('<c:out value="${queue_entry.id}"/>')">
		Remove </a>
	</display:column>
	<display:column property="clientFormattedName" sortable="true"
		title="Client Name" />
...
<c:if test="${remoteQueue!=null}">
	...
	<display:table class="simple" cellspacing="2" cellpadding="3"
		...
		<display:column sortable="false" title="">
			<a href="javascript:void(0);"
				onclick="removeFromRemoteQueue('<c:out value="${queue_entry.remoteReferral.remoteReferralId}"/>')">
			Remove </a>
		</display:column>
		<display:column property="clientName" sortable="true"
			title="Client Name" />
		<display:column property="remoteReferral.referralDate" sortable="true"
			title="Referral Date" />
		<display:column property="providerName" sortable="true"
			title="Referring Provider" />
		<display:column property="remoteReferral.reasonForReferral"
			sortable="true" title="Notes" />
	</display:table>
</c:if>