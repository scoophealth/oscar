	...
	<html:form action="/PMmodule/Admin/DefaultRoleAccess">
		...
		<table width="100%" border="1" cellspacing="2" cellpadding="3" class="b">
			<tr class="b">
				<td width="20%">Role:</td>
				<td>
					<html:select property="form.roleId">
			...
			<tr class="b">
				...
				<td>
					<html:select property="form.accessTypeId">
						<html:options collection="access_types" property="id" labelProperty="name"/>
					</html:select>
				</td>
			</tr>	
			...
			<tr>
				<td colspan="2">
		                ...
		                <input type="button" value="Cancel" onclick="location.href='<html:rewrite action="/PMmodule/Admin/DefaultRoleAccess"/>'"/>
				</td>
			</tr>
		</table>
	</html:form>
