...
<%
	...
	OcanClientForm ocanClientForm=OcanForm.getOcanClientForm(currentDemographicId);		
	...
	<table style="margin-left:auto;margin-right:auto;background-color:#f0f0f0;border-collapse:collapse">
		...
		<tr>
			...
			<td class="genericTableData" class="{validate: {required:true}}">
				<%=OcanForm.renderAsDate(ocanClientForm.getId(), "date_of_birth",true,true)%>				
			</td>
		</tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="1_1" id="1_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "1_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			...
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"1_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="2_1" id="2_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "2_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"2_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="3_1" id="3_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "3_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"3_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="4_1" id="4_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "4_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"4_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="5_1" id="5_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "5_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"5_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="6_1" id="6_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "6_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"6_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="7_1"  id="7_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "7_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"7_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="8_1" id="8_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "8_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"8_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="9_1"  id="9_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "9_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"9_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="10_1" id="10_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "10_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"10_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="11_1" id="11_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "11_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"11_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="12_1" id="12_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "12_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"12_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="13_1" id="13_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "13_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"13_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="14_1" id="14_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "14_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"14_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="15_1" id="15_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "15_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"15_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="16_1" id="16_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "16_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"16_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="17_1" id="17_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "17_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"17_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="18_1" id="18_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "18_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"18_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="19_1" id="19_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "19_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"19_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="20_1" id="20_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "20_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"20_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="21_1" id="21_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "21_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"21_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="22_1" id="22_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "22_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"22_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="23_1" id="23_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "23_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"23_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="24_1" id="24_1" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanClientForm.getId(), "24_1", OcanForm.getOcanFormOptions("Camberwell Need"),true)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Comments</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"24_comments",5,30,true)%>
			</td>
		</tr>			
		...
		<tr>
			...
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"hopes_future",5,30,true)%>
			</td>
		</tr>
		<tr>
			<td class="genericTableHeader">What do you think you need in order to get there?</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"hope_future_need",5,30,true)%>
			</td>
		</tr>
		<tr>
			<td class="genericTableHeader">How do you view your mental health?</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"view_mental_health",5,30,true)%>
			</td>
		</tr>
		<tr>
			<td class="genericTableHeader">Is spirituality an important part of your life?</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"sprituality",5,30,true)%>
			</td>
		</tr>
		<tr>
			<td class="genericTableHeader">Is culture (heritage) an important part of your life?</td>
			<td class="genericTableData">
						<%=OcanForm.renderAsTextArea(ocanClientForm.getId(),"culture_heritage",5,30,true)%>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="genericTableData">
					<%=OcanForm.renderAsDate(ocanClientForm.getId(), "completion_date",true,true)%>			
			</td>
		</tr>
