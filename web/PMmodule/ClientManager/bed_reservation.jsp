	...
	<c:otherwise>
		<table class="simple" cellspacing="2" cellpadding="3">
			...
			<tr>
				...
				<td>
					<input type="text" name="bedDemographic.strReservationEnd" id="strReservationEnd_field" readonly="readonly" value="${clientManagerForm.map.bedDemographic.strReservationEnd}" />
