...
<table width="95%" border="1">
  <tr>
    <td class="style76">
		...
		<html:text property="intake.assessDate"/>
	</td>
    <td class="style76">Assessment start time:
      <br>
		<input type="text" name="assessStartTime" value="">
	    am / pm</br></td>
    <td class="style76">
	</td>
  </tr>
  <tr>
    <td class="style76">
		...
		<input type="text" name="enterSeatonDate" value="">
	</td>
    <td class="style76">
		<html:checkbox property="intake.cboxNewclient" value="Y"/>New Client
	 </td>
    <td class="style76">
 		<html:checkbox property="intake.cboxDateofreadmission" value="Y" />Re-admission. Give date of last admission (YYYY/MM/DD).
		<html:text property="intake.dateOfReadmission"/>
	 </td>
  </tr>
</table>		
...
<table width="95%" border="1">
  <tr>
	...
	Reception Staff:&nbsp;&nbsp;
	<html:checkbox property="intake.cboxIsstatementread" value="Y"/>
	<br>
...
<table width="95%" border="1">
  <tr>
    ...
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxSpeakenglish" value="Y"/>English
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxSpeakfrench" value="Y"/>French
	</td>
    <td  align="left" class="style76" colspan="2">
		<html:checkbox property="intake.cboxSpeakother" value="Y"/>Other:
		<html:text property="intake.speakOther" />
	</td>
  </tr>
 ...
 <tr>
    ...
    <td  align="left" class="style76">
		<html:radio property="intake.radioSex" value="male"/>Male
	</td>
    <td  align="left" class="style76">
		<html:radio property="intake.radioSex" value="female"/>Female
	</td>
    <td  align="left" class="style76">
		<html:radio property="intake.radioSex" value="transgendered"/>Transgendered
	</td>
	<td  align="left" class="style76">
		<html:radio property="intake.radioSex" value="declined"/>Declined
	</td>
  </tr>
</table>
<table width="95%" border="1">
  ...
  <tr>
    <td  align="left" class="style76">
		<html:textarea property="intake.reasonToSeaton"  cols="75"></html:textarea>
	</td>
  </tr>		
  <tr>
    <td  align="left" class="style76">
		Have you ever stayed at this agency before? (give dates)
		<html:text property="intake.datesAtSeaton" size="55"/>
	</td>
  </tr>		
</table>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinhealth" value="Y"/>
	</td>		
	<td  align="left" class="style76">
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinidentification" value="Y" />
	</td>		
	<td  align="left" class="style76">
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinaddictions" value="Y"/>
	</td>		
	<td  align="left" class="style76">
		Addictions
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinhousing" value="Y"/>
	</td>		
	<td  align="left" class="style76">
		Housing issues
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistineducation" value="Y"/>
	</td>		
	<td  align="left" class="style76">
		Education Issues
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinemployment" value="Y" />
	</td>		
	<td  align="left" class="style76">
		Employment issues
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinfinance" value="Y" />
	</td>		
	<td  align="left" class="style76">
		Financial issues
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinlegal" value="Y" />
	</td>		
	<td  align="left" class="style76">
		Legal issues
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxAssistinimmigration" value="Y" />
	</td>		
	<td  align="left" class="style76">
		Immigration issues
	</td>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td  colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxNoid" value="Y" />No ID
	</td>
	
  </tr>		
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxSincard" value="Y" />SIN Card:<br>
		<html:text property="intake.sinNum" maxlength="18" />
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxHealthcard" value="Y" />Ontario Health Card# (ver)  <br>
		<html:text property="intake.healthCardNum"  maxlength="18" />
		<html:text property="intake.healthCardVer"  maxlength="2"  size="2"  />
		<br/>
		Eff. Date<html:text property="intake.effDate" size="10"  maxlength="10" value="2099-01-01"/>&nbsp;(yyyy-mm-dd)
		
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxBirthcertificate" value="Y" />Birth Certificate<br>
		<html:text property="intake.birthCertificateNum"  maxlength="18" />
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxCitzenshipcard" value="Y" />Citizenship Card<br>
		<html:text property="intake.citzenshipCardNum"  maxlength="18" />
	</td>
  ...
  <tr>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxImmigrant" value="Y" />Landed Immigrant<br>
		<html:text property="intake.immigrantNum"  maxlength="18" />
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxRefugee" value="Y" />Convention Refugee<br>
		<html:text property="intake.refugeeNum"  maxlength="18" />
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxOtherid" value="Y" />Other (specify)
		<html:text property="intake.otherIdentification"  maxlength="18" size="35" />
	</td>
  ...
  <tr>
    ...
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxIdfiled" value="Y" />ID copied and filed
	</td>
    <td  align="left" class="style76">
		<html:checkbox property="intake.cboxIdnone" value="Y" />ID not available
	</td>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td  colspan="1" width="12%"  align="left" class="style76">
		<html:checkbox property="intake.cboxWsib" value="Y" />WSIB
	</td>
    <td  colspan="2" width="15%"  align="left" class="style76">
		<html:checkbox property="intake.cboxEmployment" value="Y" />Employment
	</td>
    <td  colspan="1" width="11%"  align="left" class="style76">
		<html:checkbox property="intake.cboxEi" value="Y" />EI
	</td>
    <td  colspan="1" width="11%"  align="left" class="style76">
		<html:checkbox property="intake.cboxOas" value="Y" />OAS
	</td>
    <td  colspan="1" width="10%"  align="left" class="style76">
		<html:checkbox property="intake.cboxCpp" value="Y"/>CPP
	</td>
    <td width="19%"  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxOtherincome" value="Y" />Other
	</td>
  </tr>		
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioOnlinecheck" value="yes"  />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioOnlinecheck" value="no"  />No
	</td>
  </tr>		
  <tr>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioActive" value="active"  />Active
	</td>
    <td  colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioActive" value="inactive"  />Inactive
	</td>
    <td  colspan="5" align="left" class="style76">
		<html:checkbox property="intake.cboxNorecord" value="Y" />No Record
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		...
		<html:text property="intake.lastIssueDate" />
	</td>
    <td  colspan="3"  align="left" class="style76">
		Office:
		<html:text property="intake.office" />
	</td>
    <td  colspan="2" align="left" class="style76">
		Worker#:
		<html:text property="intake.workerNum" />
	</td>
    <td  colspan="2" align="left" class="style76">
		Amount Received: <br>$
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="11%"  colspan="1"   align="left" class="style76">
		<html:radio property="intake.radioHasdoctor" value="yes" />Yes
	</td>
    <td  colspan="1"   align="left" class="style76">
		<html:radio property="intake.radioHasdoctor" value="no" />No
	</td>
    <td  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHasdoctor" value="dontKnow" />Don't Know
	</td>
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		Name:
		<html:text property="intake.doctorName" />
		
	</td>
    <td colspan="5"  align="left" class="style76">
		Phone #:
		<html:text property="intake.doctorPhone" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Ext.
		<html:text property="intake.doctorPhoneExt" />
	</td>
  </tr>		
  <tr>
    <td  colspan="9" align="left" class="style76">
		Address:	
		<html:text property="intake.doctorAddress" size="70"  maxlength="150" />
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td width="8%"  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioSeedoctor" value="yes" />Yes
	</td>
  ...
  <tr>
    ...
    <td  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHealthissue" value="yes"  />Yes
	</td>
    <td  colspan="1" align="left" class="style76">
		<html:radio property="intake.radioHealthissue" value="no"  />No
	</td>
  </tr>		
  <tr>
	<td colspan="9" class="style76">
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		<html:checkbox property="intake.cboxHasdiabetes" value="Y" />Diabetes. If yes -->
	</td>
    <td  colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxInsulin" value="Y" />Insulin dependent?		
	</td>
    <td  colspan="1"  align="left" class="style76">
		<html:checkbox property="intake.cboxEpilepsy" value="Y" />Epilepsy	
	</td>
    <td  colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxBleeding" value="Y" />Bleeding Disorder
	</td>
  </tr>

  <tr>
    <td  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxHearingimpair"  value="Y" />Hearing Impairment
	</td>
    <td width="19%"  colspan="1"  align="left" class="style76">
		<html:checkbox property="intake.cboxVisualimpair"  value="Y" />Visual Impairment
	</td>
    <td  colspan="6"  align="left" class="style76">
		<html:checkbox property="intake.cboxMobilityimpair"  value="Y" />Mobility impairment. Give details: 		
		<html:text property="intake.mobilityImpair" size="35" />
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioOtherhealthconcern" value="yes"  />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioOtherhealthconcern" value="no"  />No
...
<tr>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioTakemedication" value="yes" />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioTakemedication" value="no" />No
	</td>
  </tr>		
  ...
  <tr>
    <td  colspan="9" align="left" class="style76">
		...
		<html:text property="intake.namesOfMedication"  size="70"  />
 ...
 <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioHelpobtainmedication" value="yes" />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioHelpobtainmedication" value="no" />No
	</td>
  </tr>		
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioAllergictomedication" value="yes"  />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioAllergictomedication" value="no"  />No
	</td>
  </tr>		
  ...
  <tr>
    <td  colspan="9" align="left" class="style76">
		...
		<html:text property="intake.allergicToMedicationName"  size="75" /> <br><br>
		If yes, give reaction (hives, rash, anaphylaxis=breathing problems, shortness of breath, itching swelling of mouth and throat)
		<html:textarea property="intake.reactionToMedication"  cols="75"></html:textarea>
  ...
  <tr>
    ...
    <td colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioMentalhealthconcerns" value="yes"  />Yes
	</td>
    <td  colspan="2" align="left" class="style76">
		<html:radio property="intake.radioMentalhealthconcerns" value="no"  />No
	</td>
  </tr>		
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="6"  align="left" class="style61">
		...
		<html:checkbox property="intake.cboxIsstatement6read"  value="Y"/>
  ...
  <tr>
    <td  colspan="6"  align="left" class="style76">
		...
		<html:text property="intake.frequencyOfSeeingDoctor" />
	</td>
  </tr>	
  <tr>	
  	<td colspan="6"  align="left" class="style76">
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxVisitwalkinclinic" value="Y" />Walk-in clinic<br>
		<html:checkbox property="intake.cboxVisithealthcenter" value="Y" />Community health centre
	</td>
    <td colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxVisitemergencyroom" value="Y" />Hospital emergency room<br>
		<html:checkbox property="intake.cboxVisitothers" value="Y" />Other (specify)
		
	</td>
    <td   colspan="2"  align="left" valign="top" class="style76">
		<html:checkbox property="intake.cboxVisithealthoffice" value="Y" />Health Professionals office
  ...
  <tr>
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioSeesamedoctor" value="yes"/>Yes
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<html:radio property="intake.radioSeesamedoctor" value="no"/>No
	</td>
  </tr>	
  <tr>
    <td  colspan="6"  align="left" class="style76">
		4. In the past 12 months, how many times have you seen a physician in a hospital Emergency room?  
		<html:text property="intake.frequencyOfSeeingEmergencyRoomDoctor"  size="15" />
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioDidnotreceivehealthcare" value="yes" />Yes<br>
		
		<html:radio property="intake.radioDidnotreceivehealthcare" value="dontKnow" />Don't Know		
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<<html:radio property="intake.radioDidnotreceivehealthcare" value="no" />No<br>
		<html:radio property="intake.radioDidnotreceivehealthcare" value="refuse" />Refuse<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to answer		
	</td>
  </tr>		
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxTreatphysicalhealth" value="Y"/>Treatment of a physical<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;health problem <br>
		<html:checkbox property="intake.cboxTreatmentalhealth" value="Y" />Treatment of an emotional or<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mental health problem		
	</td>
    <td colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxRegularcheckup" value="Y" />A regular check-up<br>
		<html:checkbox property="intake.cboxTreatotherreasons" value="Y" />Any other reason (specify)<br>
		<html:text property="intake.treatOtherReasons" size="35" />
		
	</td>
    <td   colspan="2"  align="left" valign="top" class="style76">
		<html:checkbox property="intake.cboxTreatinjury" value="Y" />Care of injury
	</td>
  </tr>		
  <tr>
	<td colspan="6" align="left"  class="style76">
  ...
  <tr>
    <td  colspan="2" align="left" class="style76">
		<html:checkbox property="intake.cboxGotowalkinclinic" value="Y" />Walk-in clinic<br>
		<html:checkbox property="intake.cboxGotohealthcenter" value="Y" />Community health centre
	</td>
    <td colspan="2"  align="left" class="style76">
		<html:checkbox property="intake.cboxGotoemergencyroom" value="Y" />Hospital emergency room<br>
		<html:checkbox property="intake.cboxGotoothers" value="Y" />Other (specify)<br>
		<html:text property="intake.goToOthers" size="35" />
		
	</td>
    <td   colspan="2"  align="left" valign="top" class="style76">
		<html:checkbox property="intake.cboxHealthoffice" value="Y" />Health Professionals office
	</td>
  </tr>		
  <tr>
    <td  colspan="4" align="left" class="style76">
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioAppmtseedoctorin3mths" value="yes" />Yes
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<html:radio property="intake.radioAppmtseedoctorin3mths" value="no" />(A)No
	</td>
  </tr>	
  <tr>
    <td  colspan="4" align="left" class="style76">
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioNeedregulardoctor" value="yes" />(B)Yes
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<html:radio property="intake.radioNeedregulardoctor" value="no" />No
	</td>
  </tr>	
  <tr>
    <td  colspan="4" align="left" class="style76">
    ...
    <td width="17%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioObjecttoregulardoctorin4wks" value="yes"  />Yes
	</td>
    <td width="23%"  colspan="1" align="left" class="style76">
		<html:radio property="intake.radioObjecttoregulardoctorin4wks" value="no"  />(C)No
	</td>
  </tr>	
  <tr>
    <td  colspan="2" align="left" class="style76">
    ...
    <td width="19%"  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioRateoverallhealth" value="poor" />Poor
	</td>
    <td width="19%"   colspan="1" align="left" class="style76">
		<html:radio property="intake.radioRateoverallhealth" value="fair" />Fair
	</td>
    <td  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioRateoverallhealth" value="good" />Good
	</td>
    <td  colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioRateoverallhealth" value="excellent" />Excellent
	</td>
  </tr>	
  ...
  <tr> 
    <td   colspan="2"  align="left" class="style76">
		<html:radio property="intake.radioSpeaktoresearcher" value="yes"  />Yes
	</td>
    <td    colspan="4" align="left" class="style76">
		<html:radio property="intake.radioSpeaktoresearcher" value="no"  />No
	</td>
  </tr>	
</table>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="2"  align="left" class="style76">
		Name:
		<html:text property="intake.contactName" />
	</td>
    <td  colspan="2"  width="50%"  align="left" class="style76">
	    Phone #:
		<html:text property="intake.contactPhone" />
	</td>
  ...
  <tr>
    <td  colspan="4" align="left" class="style76">
		Address:
		<html:text property="intake.contactAddress" />
	</td>
  </tr>		
  <tr>
    <td  colspan="4" align="left" class="style76">
		What relationship is this person to you? (friend, sister, next-of-kin, etc.)	
		<html:text property="intake.contactRelationship" />
	</td>
  </tr>	
</table>
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHasmentalillness" value="yes"  />Yes
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasmentalillness" value="uncertain"  />Uncertain
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasmentalillness" value="no"  />No
	</td>
  </tr>		
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHasdrinkingproblem" value="yes" />Yes
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasdrinkingproblem" value="uncertain" />Uncertain
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasdrinkingproblem" value="no" />No
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHasdrugproblem" value="yes"  />Yes
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasdrugproblem" value="uncertain"  />Uncertain
		
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasdrugproblem" value="no"  />No
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHashealthproblem" value="yes" />Yes
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHashealthproblem" value="uncertain" />Uncertain
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHashealthproblem" value="no" />No
	</td>
  </tr>	
  <tr>	
  	<td colspan="4" align="left" class="style76">
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioHasbehaviorproblem" value="yes" />Yes
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasbehaviorproblem" value="uncertain" />Uncertain
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioHasbehaviorproblem" value="no" />No
	</td>
  </tr>	
  <tr>	
  	<td colspan="4" align="left" class="style76">
  ...
  <tr>
    ...
    <td width="26%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioNeedseatonservice" value="yes" />Yes
		
	</td>
    <td width="28%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioNeedseatonservice" value="uncertain" />Uncertain	
	</td>
    <td width="24%"   colspan="1"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioNeedseatonservice" value="no" />No	
	</td>
  </tr>	
...
<table width="95%" border="1">
  ...
  <tr>
    ...
    <td width="10%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioSeatontour" value="yes"  />Yes
		
	</td>
    <td    colspan="4"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioSeatontour" value="no"  />No (If no, give reason)
		<html:text property="intake.seatonNotToured" size="55" />
	</td>
  </tr>	
  ...
  <tr>
    ...
    <td width="10%" colspan="1"  align="left" class="style76">
		<html:radio property="intake.radioPamphletissued" value="yes"  />Yes
		
	</td>
    <td    colspan="4"  align="left" valign="top" class="style76">
		<html:radio property="intake.radioPamphletissued" value="no"  />No (If no, give reason)
		<html:text property="intake.pamphletNotIssued" size="55" />
	</td>
  </tr>	  	
</table>		
...
<table width="95%" border="1">
  ...
  <tr>	
  	<td colspan="6" align="center" class="style76">
		<html:textarea property="intake.summary"  cols="95" rows="7"></html:textarea>
	</td>
  </tr>
...
<table width="95%" border="1">
  ...
  <tr>
    <td  colspan="4"  align="left" class="style76">
		...
		<html:text property="intake.completedBy" size="45" />
	</td>
    ...
    <td width="22%"  colspan="1"  align="left" valign="middle"  STYLE="text-align:right"  class="style76">
		<html:text property="intake.assessCompleteTime" size="15" />
		am/pm
	</td>
  </tr>	
</table>
...
<table width="95%" border="1">
  <tr>	
  	<td colspan="3" align="center" class="style51">
		<!-- 11. TRIAGE- REFERRAL TO A PROGRAM	(Removed)
...
<c:if test="${intakeAForm.map.intake.demographicNo == null or not empty in_community_program}">
<table width="95%" border="1">
  <tr>	
  	<td colspan="3" align="center" class="style51">
  ...
  <tr>	
  	<td colspan="3" align="left" class="style76">
		Admit to bed program: 
		<html:select property="view2.admissionProgram">
