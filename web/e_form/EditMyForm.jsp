...
<%  
  int status = new Integer(request.getParameter("status")).intValue();
...
//************
  ...
  String formString = beanDBOperator.getFormString(beanDBOperator.getFID(fdid));
  String newFormString = beanMakeForm.EditNewForm(formString,label,date,currentproblems,currentmedications,familysocialhistory,alert,subject,namelist[0][1] ,namelist[1][1] ,namelist[2][1] ,namelist[3][1] ,namelist[4][1] ,namelist[5][1] ,namelist[6][1] ,namelist[7][1] ,namelist[8][1] ,namelist[9][1] ,namelist[10][1] ,namelist[11][1] ,namelist[12][1] ,namelist[13][1] ,namelist[14][1] ,namelist[15][1] ,namelist[16][1] ,namelist[17][1] ,namelist[18][1] ,namelist[19][1]);

// save form to database
  beanDBOperator.edit_eForms_data (fdid,demographic_no,form_name,subject,form_date,form_provider,newFormString);
