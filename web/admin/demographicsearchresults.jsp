...
%>
	<tr bgcolor="<%=bodd?"ivory":"white"%>">
		<td width="20%" align="center" height="25"><a
			href="admincontrol.jsp?demographic_no=<%=apptMainBean.getString(rs,"demographic_no")%>&displaymode=Demographic_Edit&dboperation=demographic_search_detail"><%=apptMainBean.getString(rs,"demographic_no")%></a></td>
