...
<table width="100%" border="1" cellspacing="1" cellpadding="1">
  <tr>
    <td><div align="center"><a href="" >Problem list</a></div></td>
    <td><div align="center"><a href="" >Lab Reports</a></div></td>
    <td><div align="center"><a href='admincontrol.jsp?demographic_no=<%=apptMainBean.getString(rs,"demographic_no")%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10'>Appt.History</a></div></td>
    <td><div align="center"><a href="" >Enc. Hist.</a></div></td>
  </tr>
</table>
...
<table border="0" cellpadding="1" cellspacing="0" width="100%">
	...
	<input type="hidden" name="demographic_no" value="<%=apptMainBean.getString(rs,"demographic_no")%>">
      ...
      <td align="left"> 
        <input type="text" name="last_name" value="<%=apptMainBean.getString(rs,"last_name")%>"  onBlur="upCaseCtrl(this)">
      </td>
      <td align="right"><b>First Name: </b> </td>
      <td align="left"> 
        <input type="text" name="first_name" value="<%=apptMainBean.getString(rs,"first_name")%>" onBlur="upCaseCtrl(this)">
      </td>
    </tr>
    <tr valign="top"> 
    ...
    <tr valign="top"> 
      ...
      <td  align="left"> 
        <input type="text" name="phone2" value="<%=apptMainBean.getString(rs,"phone2")%>">
      </td>
    </tr>
    <tr valign="top"> 
    ...
    <tr valign="top"> 
      ...
      <td align="left">
        <input type="text" name="family_doctor" value="<%=apptMainBean.getString(rs,"family_doctor")%>">
      </td>
    ...
    <tr bgcolor="#486ebd"> 
      <td colspan="4"> 
        <div align="center"> 
          <input type="hidden" name="dboperation" value="demographic_update_record">
          <input type="hidden" name="displaymode" value="Demographic_Update">
          <input type="submit" name="subbutton" value="Update Record">
          <a href='admincontrol.jsp?demographic_no=<%=apptMainBean.getString(rs,"demographic_no")%>&displaymode=Demographic_Delete&dboperation=demographic_delete'> 
