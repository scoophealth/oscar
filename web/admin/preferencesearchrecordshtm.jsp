...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr bgcolor="#486ebd">
		...
		<bean:message key="admin.preferencesearchrecordhtm.msgSearch" /></font></th>
	</tr>
</table>
...
<table cellspacing="0" cellpadding="2" width="100%" border="0"
	...
	<tr valign="top">
		<td rowspan="2" align="right" valign="middle"><font
			...
			key="admin.preferencesearchrecordhtm.msgCriteria" /></i></b></font></td>
		<td nowrap><font size="1" face="Verdana" color="#0000FF">
		<input type="radio" name="search_mode" value="search_preferenceno">
		<bean:message key="admin.preferencesearchrecordhtm.formPreferenceNo" />
		</font></td>

		<td nowrap><font size="1" face="Verdana" color="#0000FF">
		<input type="radio" checked name="search_mode"
			value="search_providerno"> <bean:message
			key="admin.preferencesearchrecordhtm.formProviderNo" /></font></td>
		...
		<INPUT TYPE="hidden" NAME="limit1" VALUE="0"> <INPUT
			...
			VALUE="<bean:message key="admin.preferencesearchrecordhtm.btnSearch"/>"
			SIZE="17"></td>

	</tr>
	<tr>
		<td nowrap><font size="1" face="Verdana" color="#0000FF"><bean:message
			key="admin.preferencesearchrecordhtm.msgReserved" /> </font></td>
		<td nowrap><font size="1" face="Verdana" color="#0000FF">
		</font></td>
...
<p><bean:message
	key="admin.preferencesearchrecordhtm.msgInstructionsLater" /></p>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td><a href="admin.jsp"> <img src="../images/leftarrow.gif"
			...
			key="admin.preferencesearchrecordhtm.btnBack" /></a></td>
		<td align="right"><a href="../logout.jsp"><bean:message
			key="admin.preferencesearchrecordhtm.btnLogOut" /> <img
