...
<%@ page import="java.math.*, java.util.*, oscar.util.*, oscar.oscarBilling.ca.on.administration.*, oscar.oscarBilling.ca.on.data.*"%>
        ...
        <FORM name="gstform" action="gstreport.jsp">
                ...
                <TR>
                        <TD width="15%" align="center">          
                            <a href="javascript: function myFunction() {return false; }" style="font-size: 10px;" id="hlSDate">From:</a>
                            <input type="text" name="xml_vdate" id="xml_vdate" value="<%=startDate%>" maxlength="10"  style="width:80px"/>          
                        </TD>
                        <TD width="15%" align="center">
                        <a href="javascript: function myFunction() {return false; }" style="font-size: 10px;" id="hlADate" >To:</a>
                        <input type="text" name="xml_appointment_date" id="xml_appointment_date" value="<%=endDate%>" maxlength="10" style="width:80px" /> 
                        </TD>
                    <TD height="40" align="left" width="70%" style="background-color: #FFCC99;">
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="0" border="1">
                ...
                <TR style="background-color: <%=bgColour%>;">
                    ...
                    <TD width="15%" align="center"><%=gst%></TD> <%//Perhaps show 0.00 if no gst...%>
